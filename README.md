...
```shell
gem install ./launchdarkly_api-2.0.20.gem
```
(for development, run `gem install --dev ./launchdarkly_api-2.0.20.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'launchdarkly_api', '~> 2.0.20'
...
*LaunchDarklyApi::FeatureFlagsApi* | [**get_feature_flag_status_across_environments**](docs/FeatureFlagsApi.md#get_feature_flag_status_across_environments) | **GET** /flag-status/{projectKey}/{featureFlagKey} | [BETA] Get the status for a particular feature flag across environments
...
*LaunchDarklyApi::UsageApi* | [**get_evaluations**](docs/UsageApi.md#get_evaluations) | **GET** /usage/evaluations/{envId}/{flagKey} | [BETA] Get events usage by event id and the feature flag key.
*LaunchDarklyApi::UsageApi* | [**get_event**](docs/UsageApi.md#get_event) | **GET** /usage/events/{type} | [BETA] Get events usage by event type.
*LaunchDarklyApi::UsageApi* | [**get_events**](docs/UsageApi.md#get_events) | **GET** /usage/events | [BETA] Get events usage endpoints.
*LaunchDarklyApi::UsageApi* | [**get_mau**](docs/UsageApi.md#get_mau) | **GET** /usage/mau | [BETA] Get monthly active user data.
*LaunchDarklyApi::UsageApi* | [**get_mau_by_category**](docs/UsageApi.md#get_mau_by_category) | **GET** /usage/mau/bycategory | [BETA] Get monthly active user data by category.
*LaunchDarklyApi::UsageApi* | [**get_stream**](docs/UsageApi.md#get_stream) | **GET** /usage/streams/{source} | [BETA] Get a stream endpoint and return timeseries data.
*LaunchDarklyApi::UsageApi* | [**get_stream_by_sdk**](docs/UsageApi.md#get_stream_by_sdk) | **GET** /usage/streams/{source}/bysdkversion | [BETA] Get a stream timeseries data by source show sdk version metadata.
*LaunchDarklyApi::UsageApi* | [**get_stream_sdk_version**](docs/UsageApi.md#get_stream_sdk_version) | **GET** /usage/streams/{source}/sdkversions | [BETA] Get a stream timeseries data by source and show all sdk version associated.
*LaunchDarklyApi::UsageApi* | [**get_streams**](docs/UsageApi.md#get_streams) | **GET** /usage/streams | [BETA] Returns a list of all streams.
*LaunchDarklyApi::UsageApi* | [**get_usage**](docs/UsageApi.md#get_usage) | **GET** /usage | [BETA] Returns of the usage endpoints available.
...
## Documentation for Models
 ...
 - [LaunchDarklyApi::EvaluationUsageError](docs/EvaluationUsageError.md)
 - [LaunchDarklyApi::Events](docs/Events.md)
 ...
 - [LaunchDarklyApi::FeatureFlagStatusForQueriedEnvironment](docs/FeatureFlagStatusForQueriedEnvironment.md)
 ...
 - [LaunchDarklyApi::MAU](docs/MAU.md)
 - [LaunchDarklyApi::MAUMetadata](docs/MAUMetadata.md)
 - [LaunchDarklyApi::MAUbyCategory](docs/MAUbyCategory.md)
 ...
 - [LaunchDarklyApi::Stream](docs/Stream.md)
 - [LaunchDarklyApi::StreamBySDK](docs/StreamBySDK.md)
 - [LaunchDarklyApi::StreamBySDKLinks](docs/StreamBySDKLinks.md)
 - [LaunchDarklyApi::StreamBySDKLinksMetadata](docs/StreamBySDKLinksMetadata.md)
 - [LaunchDarklyApi::StreamLinks](docs/StreamLinks.md)
 - [LaunchDarklyApi::StreamSDKVersion](docs/StreamSDKVersion.md)
 - [LaunchDarklyApi::StreamSDKVersionData](docs/StreamSDKVersionData.md)
 - [LaunchDarklyApi::StreamUsageError](docs/StreamUsageError.md)
 - [LaunchDarklyApi::StreamUsageLinks](docs/StreamUsageLinks.md)
 - [LaunchDarklyApi::StreamUsageMetadata](docs/StreamUsageMetadata.md)
 - [LaunchDarklyApi::StreamUsageSeries](docs/StreamUsageSeries.md)
 - [LaunchDarklyApi::Streams](docs/Streams.md)
 - [LaunchDarklyApi::Target](docs/Target.md)
 - [LaunchDarklyApi::Usage](docs/Usage.md)
 - [LaunchDarklyApi::UsageError](docs/UsageError.md)
 - [LaunchDarklyApi::UsageLinks](docs/UsageLinks.md)
