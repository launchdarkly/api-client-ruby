...
# Unit tests for LaunchDarklyApi::ApprovalsApi
...
describe 'ApprovalsApi' do
  ...
  describe 'test an instance of ApprovalsApi' do
    it 'should create an instance of ApprovalsApi' do
      expect(@api_instance).to be_instance_of(LaunchDarklyApi::ApprovalsApi)
    end
  end
  ...
  # unit tests for delete_approval_request_for_flag
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_approval_request_for_flag test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_approval_for_flag
  ...
  describe 'get_approval_for_flag test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for get_approvals_for_flag
  ...
  describe 'get_approvals_for_flag test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # @param create_approval_request_request 
  # @param [Hash] opts the optional parameters
  ...
  # unit tests for post_approval_request_apply
  # Apply approval request
  # Apply an approval request that has been approved.
  # @param id The feature flag approval request ID
  # @param post_approval_request_apply_request 
  # @param [Hash] opts the optional parameters
  # @return [ApprovalRequestResponse]
  describe 'post_approval_request_apply test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_approval_request_apply_for_flag
  ...
  # @param [Hash] opts the optional parameters
  # @return [FlagConfigApprovalRequestResponse]
  describe 'post_approval_request_apply_for_flag test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_approval_request_for_flag
  # Create approval request for a flag
  # Create an approval request for a feature flag.
  # @param project_key The project key
  # @param feature_flag_key The feature flag key
  # @param environment_key The environment key
  # @param create_flag_config_approval_request_request 
  # @param [Hash] opts the optional parameters
  # @return [FlagConfigApprovalRequestResponse]
  describe 'post_approval_request_for_flag test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_approval_request_review
  # Review approval request
  # Review an approval request by approving or denying changes.
  # @param id The approval request ID
  # @param post_approval_request_review_request 
  # @param [Hash] opts the optional parameters
  # @return [ApprovalRequestResponse]
  describe 'post_approval_request_review test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_approval_request_review_for_flag
  ...
  # @param [Hash] opts the optional parameters
  # @return [FlagConfigApprovalRequestResponse]
  describe 'post_approval_request_review_for_flag test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_flag_copy_config_approval_request
  # Create approval request to copy flag configurations across environments
  # Create an approval request to copy a feature flag&#39;s configuration across environments.
  # @param project_key The project key
  # @param feature_flag_key The feature flag key
  # @param environment_key The environment key for the target environment
  # @param create_copy_flag_config_approval_request_request 
  # @param [Hash] opts the optional parameters
  # @return [FlagConfigApprovalRequestResponse]
  describe 'post_flag_copy_config_approval_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
