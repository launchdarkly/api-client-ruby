...
# Unit tests for LaunchDarklyApi::AgentControlApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AgentControlApi' do
  before do
  ...
  describe 'test an instance of AgentControlApi' do
    it 'should create an instance of AgentControlApi' do
      expect(@api_instance).to be_instance_of(LaunchDarklyApi::AgentControlApi)
    end
  end
  ...
  # unit tests for delete_agent_optimization
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_agent_optimization test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_agent_optimization_run
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_agent_optimization_run test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_agent_skill
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_agent_skill test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_ai_config test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_ai_config_variation
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_ai_config_variation test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_ai_tool
  # Delete AI tool
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_ai_tool test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_model_config
  # Delete an AI model config
  # Delete an AI model config.
  # @param project_key 
  # @param model_config_key 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_model_config test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_prompt_snippet
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_prompt_snippet test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_restricted_models
  # Remove AI models from the restricted list
  # Remove AI models, by key, from the restricted list.
  # @param project_key 
  # @param restricted_models_request List of AI model keys to remove from the restricted list
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # unit tests for get_agent_optimization
  ...
  describe 'get_agent_optimization test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_agent_skill
  # Get an agent skill
  ...
  # @param [Hash] opts the optional parameters
  # @return [AgentSkill]
  describe 'get_agent_skill test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @return [AIConfig]
  describe 'get_ai_config test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_ai_config_metrics
  ...
  # @return [Metrics]
  describe 'get_ai_config_metrics test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_ai_config_metrics_by_variation
  ...
  describe 'get_ai_config_metrics_by_variation test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_ai_config_quick_stats
  ...
  # @param [Hash] opts the optional parameters
  # @return [QuickStats]
  describe 'get_ai_config_quick_stats test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_ai_config_targeting
  ...
  describe 'get_ai_config_targeting test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_ai_config_variation
  ...
  describe 'get_ai_config_variation test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_ai_configs
  # List AI Configs
  ...
  # @return [AIConfigs]
  describe 'get_ai_configs test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_ai_tool
  # Get AI tool
  ...
  # @param [Hash] opts the optional parameters
  # @return [AITool]
  describe 'get_ai_tool test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_model_config
  # Get AI model config
  ...
  # @return [ModelConfig]
  describe 'get_model_config test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_prompt_snippet
  ...
  describe 'get_prompt_snippet test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for list_agent_optimization_results
  ...
  describe 'list_agent_optimization_results test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_agent_optimization_results_by_run_id
  ...
  # @param [Hash] opts the optional parameters
  # @return [AgentOptimizationResults]
  describe 'list_agent_optimization_results_by_run_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_agent_optimizations
  ...
  describe 'list_agent_optimizations test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_agent_skill_references
  ...
  describe 'list_agent_skill_references test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_agent_skill_versions
  ...
  # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
  # @return [AgentSkills]
  describe 'list_agent_skill_versions test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_agent_skills
  # List agent skills
  ...
  # @option opts [String] :filter A filter to apply to the list.
  # @return [AgentSkills]
  describe 'list_agent_skills test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
  # @return [AITools]
  describe 'list_ai_tool_versions test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_ai_tools
  # List AI tools
  ...
  # @option opts [String] :filter A filter to apply to the list.
  # @return [AITools]
  describe 'list_ai_tools test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_all_agent_optimization_results
  ...
  # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
  # @return [AgentOptimizationResults]
  describe 'list_all_agent_optimization_results test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_model_config_versions
  ...
  # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
  # @return [ModelConfigs]
  describe 'list_model_config_versions test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_model_configs
  ...
  # unit tests for list_prompt_snippet_references
  ...
  describe 'list_prompt_snippet_references test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_prompt_snippet_versions
  ...
  describe 'list_prompt_snippet_versions test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_prompt_snippets
  ...
  # @option opts [String] :filter A filter to apply to the list.
  # @return [PromptSnippets]
  describe 'list_prompt_snippets test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for patch_agent_optimization
  # Update an agent optimization
  # Update an existing agent optimization. Creates a new version of the optimization.
  # @param project_key 
  # @param optimization_key 
  # @param agent_optimization_patch Agent optimization fields to update
  # @param [Hash] opts the optional parameters
  # @return [AgentOptimization]
  describe 'patch_agent_optimization test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_agent_optimization_result
  # Update an agent optimization result
  # Update status, activity, and AI request metadata fields on an agent optimization result.
  # @param project_key 
  # @param optimization_key 
  # @param result_id 
  # @param agent_optimization_result_patch Agent optimization result fields to update
  # @param [Hash] opts the optional parameters
  # @return [AgentOptimizationResult]
  describe 'patch_agent_optimization_result test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_agent_skill
  # Update an agent skill
  # Update an existing agent skill. Creates a new version of the skill.
  # @param project_key 
  # @param skill_key 
  # @param agent_skill_patch Agent skill fields to update
  # @param [Hash] opts the optional parameters
  # @return [AgentSkill]
  describe 'patch_agent_skill test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @return [AIConfig]
  describe 'patch_ai_config test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_ai_config_targeting
  ...
  # @return [AIConfigTargeting]
  describe 'patch_ai_config_targeting test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_ai_config_variation
  ...
  describe 'patch_ai_config_variation test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_ai_tool
  # Update AI tool
  ...
  # unit tests for patch_model_config
  # Update an AI model config
  # Update an AI model config.
  # @param project_key 
  # @param model_config_key 
  # @param model_config_patch AI model config object to update
  # @param [Hash] opts the optional parameters
  # @return [ModelConfig]
  describe 'patch_model_config test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_prompt_snippet
  # Update a prompt snippet
  # Update an existing prompt snippet. Creates a new version of the snippet.
  # @param project_key 
  # @param snippet_key 
  # @param prompt_snippet_patch Prompt snippet fields to update
  # @param [Hash] opts the optional parameters
  # @return [PromptSnippet]
  describe 'patch_prompt_snippet test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for post_agent_optimization
  # Create agent optimization
  # Create a new agent optimization within the given project.
  # @param project_key 
  # @param agent_optimization_post Agent optimization object to create
  # @param [Hash] opts the optional parameters
  # @return [AgentOptimization]
  describe 'post_agent_optimization test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_agent_optimization_result
  # Create agent optimization result
  # Create a new result for an agent optimization run.
  # @param project_key 
  # @param optimization_key 
  # @param agent_optimization_result_post Agent optimization result to create
  # @param [Hash] opts the optional parameters
  # @return [AgentOptimizationResult]
  describe 'post_agent_optimization_result test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_agent_skill
  # Create an agent skill
  # Create a new agent skill within the given project.
  # @param project_key 
  # @param agent_skill_post Agent skill object to create
  # @param [Hash] opts the optional parameters
  # @return [AgentSkill]
  describe 'post_agent_skill test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param project_key 
  # @param ai_config_post AI Config object to create
  # @param [Hash] opts the optional parameters
  # @return [AIConfig]
  describe 'post_ai_config test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_ai_config_variation
  ...
  # @param project_key 
  # @param config_key 
  # @param ai_config_variation_post AI Config variation object to create
  # @param [Hash] opts the optional parameters
  # @return [AIConfigVariation]
  describe 'post_ai_config_variation test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_ai_tool
  # Create an AI tool
  # Create an AI tool
  # @param project_key 
  # @param ai_tool_post AI tool object to create
  # @param [Hash] opts the optional parameters
  # @return [AITool]
  describe 'post_ai_tool test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_model_config
  # Create an AI model config
  # Create an AI model config. You can use this in any variation for any config in your project.
  # @param project_key 
  # @param model_config_post AI model config object to create
  # @param [Hash] opts the optional parameters
  # @return [ModelConfig]
  describe 'post_model_config test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_prompt_snippet
  # Create a prompt snippet
  # Create a new prompt snippet within the given project.
  # @param project_key 
  # @param prompt_snippet_post Prompt snippet object to create
  # @param [Hash] opts the optional parameters
  # @return [PromptSnippet]
  describe 'post_prompt_snippet test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_restricted_models
  ...
  # @param project_key 
  # @param restricted_models_request List of AI model keys to add to the restricted list.
  # @param [Hash] opts the optional parameters
  # @return [RestrictedModelsResponse]
  describe 'post_restricted_models test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
