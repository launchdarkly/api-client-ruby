...
# Unit tests for LaunchDarklyApi::ContextsBetaApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContextsBetaApi' do
  before do
  ...
  describe 'test an instance of ContextsBetaApi' do
    it 'should create an instance of ContextsBetaApi' do
      expect(@api_instance).to be_instance_of(LaunchDarklyApi::ContextsBetaApi)
    end
  end
