...
describe 'FeatureFlagsApi' do
  ...
  describe 'test an instance of FeatureFlagsApi' do
    it 'should create an instance of FeatureFlagsApi' do
      expect(@api_instance).to be_instance_of(LaunchDarklyApi::FeatureFlagsApi)
    end
  end
  ...
  # @param flag_key The feature flag key.
  # @param [Hash] opts the optional parameters
  ...
  # @param proj_key The project key
  # @param env_key Filter configurations by environment
  # @param [Hash] opts the optional parameters
