...
# Unit tests for LaunchDarklyApi::SegmentsApi
...
describe 'SegmentsApi' do
  ...
  describe 'test an instance of SegmentsApi' do
    it 'should create an instance of SegmentsApi' do
      expect(@api_instance).to be_instance_of(LaunchDarklyApi::SegmentsApi)
    end
  end
  ...
  # unit tests for get_expiring_targets_for_segment
  ...
  describe 'get_expiring_targets_for_segment test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_expiring_user_targets_for_segment
  ...
  describe 'get_expiring_user_targets_for_segment test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for get_segment_membership_for_context
  ...
  describe 'get_segment_membership_for_context test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_segment_membership_for_user
  ...
  # @param [Hash] opts the optional parameters
  # @return [BigSegmentTarget]
  describe 'get_segment_membership_for_user test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for patch_expiring_targets_for_segment
  ...
  # @param environment_key The environment key
  # @param segment_key The segment key
  # @param patch_segment_request 
  # @param [Hash] opts the optional parameters
  # @return [ExpiringTargetPatchResponse]
  describe 'patch_expiring_targets_for_segment test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'patch_expiring_user_targets_for_segment test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @return [UserSegment]
  describe 'post_segment test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_big_segment_context_targets
  # Update context targets on a Big Segment
  # Update context targets included or excluded in a Big Segment.
  # @param project_key The project key
  # @param environment_key The environment key
  # @param segment_key The segment key
  # @param segment_user_state 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'update_big_segment_context_targets test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
