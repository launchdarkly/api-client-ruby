...
# Unit tests for LaunchDarklyApi::FlagGlobalAttributesRep
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LaunchDarklyApi::FlagGlobalAttributesRep do
  let(:instance) { LaunchDarklyApi::FlagGlobalAttributesRep.new }

  describe 'test an instance of FlagGlobalAttributesRep' do
    it 'should create an instance of FlagGlobalAttributesRep' do
      expect(instance).to be_instance_of(LaunchDarklyApi::FlagGlobalAttributesRep)
    end
  end
  ...
  describe 'test attribute "kind"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["boolean", "multivariate"])
  ...
  describe 'test attribute "client_side_availability"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "maintainer_team_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "_maintainer_team"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "_purpose"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "migration_settings"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
