...
# Unit tests for SwaggerClient::UserSettingsBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserSettingsBody' do
  before do
    # run before each test
    @instance = SwaggerClient::UserSettingsBody.new
  end
  ...
  describe 'test an instance of UserSettingsBody' do
    it 'should create an instance of UserSettingsBody' do
      expect(@instance).to be_instance_of(SwaggerClient::UserSettingsBody)
    end
  end
