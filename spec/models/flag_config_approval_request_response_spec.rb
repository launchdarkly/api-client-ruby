...
# Unit tests for LaunchDarklyApi::FlagConfigApprovalRequestResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LaunchDarklyApi::FlagConfigApprovalRequestResponse do
  let(:instance) { LaunchDarklyApi::FlagConfigApprovalRequestResponse.new }

  describe 'test an instance of FlagConfigApprovalRequestResponse' do
    it 'should create an instance of FlagConfigApprovalRequestResponse' do
      expect(instance).to be_instance_of(LaunchDarklyApi::FlagConfigApprovalRequestResponse)
    end
  end
