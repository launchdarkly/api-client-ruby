...
# Unit tests for LaunchDarklyApi::MetricPost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LaunchDarklyApi::MetricPost do
  #let(:instance) { LaunchDarklyApi::MetricPost.new }

  describe 'test an instance of MetricPost' do
    it 'should create an instance of MetricPost' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LaunchDarklyApi::MetricPost)
    end
  end
  ...
  describe 'test attribute "unit_aggregation_field"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
