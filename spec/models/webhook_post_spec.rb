...
# Unit tests for SwaggerClient::WebhookPost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookPost' do
  before do
    # run before each test
    @instance = SwaggerClient::WebhookPost.new
  end
  ...
  describe 'test an instance of WebhookPost' do
    it 'should create an instance of WebhookPost' do
      expect(@instance).to be_instance_of(SwaggerClient::WebhookPost)
    end
  end
