...
# Unit tests for LaunchDarklyApi::ExpandableApprovalRequestResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LaunchDarklyApi::ExpandableApprovalRequestResponse do
  #let(:instance) { LaunchDarklyApi::ExpandableApprovalRequestResponse.new }

  describe 'test an instance of ExpandableApprovalRequestResponse' do
    it 'should create an instance of ExpandableApprovalRequestResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LaunchDarklyApi::ExpandableApprovalRequestResponse)
    end
  end
  ...
  describe 'test attribute "review_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["approved", "declined", "pending"])
  ...
  describe 'test attribute "applied_by_service_token_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "completed", "failed", "scheduled"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "operating_on_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "integration_metadata"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "approval_settings"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
