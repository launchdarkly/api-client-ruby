...
# Unit tests for LaunchDarklyApi::ApprovalRequestResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LaunchDarklyApi::ApprovalRequestResponse do
  let(:instance) { LaunchDarklyApi::ApprovalRequestResponse.new }

  describe 'test an instance of ApprovalRequestResponse' do
    it 'should create an instance of ApprovalRequestResponse' do
      expect(instance).to be_instance_of(LaunchDarklyApi::ApprovalRequestResponse)
    end
  end
