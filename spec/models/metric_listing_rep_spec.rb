...
# Unit tests for LaunchDarklyApi::MetricListingRep
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LaunchDarklyApi::MetricListingRep do
  #let(:instance) { LaunchDarklyApi::MetricListingRep.new }

  describe 'test an instance of MetricListingRep' do
    it 'should create an instance of MetricListingRep' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LaunchDarklyApi::MetricListingRep)
    end
  end
