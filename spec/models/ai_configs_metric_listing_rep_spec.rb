...
describe LaunchDarklyApi::AiConfigsMetricListingRep do
  ...
  describe 'test attribute "kind"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pageview", "click", "custom"])
  ...
  describe 'test attribute "unit_aggregation_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["average", "sum"])
      # validator.allowable_values.each do |value|
