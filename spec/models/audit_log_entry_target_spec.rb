...
# Unit tests for SwaggerClient::AuditLogEntryTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuditLogEntryTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::AuditLogEntryTarget.new
  end
  ...
  describe 'test an instance of AuditLogEntryTarget' do
    it 'should create an instance of AuditLogEntryTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::AuditLogEntryTarget)
    end
  end
