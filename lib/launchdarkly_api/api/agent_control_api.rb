...
module LaunchDarklyApi
  class AgentControlApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_agent_skill(project_key, skill_key, opts = {})
      delete_agent_skill_with_http_info(project_key, skill_key, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_agent_skill_with_http_info(project_key, skill_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AgentControlApi.delete_agent_skill ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling AgentControlApi.delete_agent_skill"
      end
      # verify the required parameter 'skill_key' is set
      if @api_client.config.client_side_validation && skill_key.nil?
        fail ArgumentError, "Missing the required parameter 'skill_key' when calling AgentControlApi.delete_agent_skill"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/ai-configs/skills/{skillKey}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'skillKey' + '}', CGI.escape(skill_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AgentControlApi.delete_agent_skill",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AgentControlApi#delete_agent_skill\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param optimization_key [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(AgentOptimization, Integer, Hash)>] AgentOptimization data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @return [AgentSkill]
    def get_agent_skill(project_key, skill_key, opts = {})
      data, _status_code, _headers = get_agent_skill_with_http_info(project_key, skill_key, opts)
      data
    end
    ...
    # @param skill_key [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(AgentSkill, Integer, Hash)>] AgentSkill data, response status code and response headers
    def get_agent_skill_with_http_info(project_key, skill_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AgentControlApi.get_agent_skill ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling AgentControlApi.get_agent_skill"
      end
      # verify the required parameter 'skill_key' is set
      if @api_client.config.client_side_validation && skill_key.nil?
        fail ArgumentError, "Missing the required parameter 'skill_key' when calling AgentControlApi.get_agent_skill"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/ai-configs/skills/{skillKey}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'skillKey' + '}', CGI.escape(skill_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AgentSkill'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"AgentControlApi.get_agent_skill",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AgentControlApi#get_agent_skill\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context_kind A context kind. Only metrics from events that include a context of this kind are included. Required if &#x60;contextKey&#x60; is provided.
    # @option opts [String] :context_key A context key. Only metrics from events whose context of the &#x60;contextKind&#x60; kind has this key are included. Requires &#x60;contextKind&#x60;.
    # @return [Metrics]
    ...
    # @param env [String] An environment key. Only metrics from this environment will be included.
    # @param [Hash] opts the optional parameters
    # @return [Array<(QuickStats, Integer, Hash)>] QuickStats data, response status code and response headers
    ...
    # @param project_key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :sort A sort to apply to the list of AgentControl configs.
    ...
    # @option opts [String] :filter A filter to apply to the list.
    # @return [AIConfigs]
    ...
    # @param model_config_key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :version Specific model config version to return. Omit to return the latest version.
    # @return [ModelConfig]
    ...
    def get_model_config_with_http_info(project_key, model_config_key, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'version'].nil? && opts[:'version'] < 0
        fail ArgumentError, 'invalid value for "opts[:"version"]" when calling AgentControlApi.get_model_config, must be greater than or equal to 0.'
      end
    ...
    # @param snippet_key [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PromptSnippet, Integer, Hash)>] PromptSnippet data, response status code and response headers
    ...
    # @option opts [Integer] :limit The number of resources to return.
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(AgentOptimizationResults, Integer, Hash)>] AgentOptimizationResults data, response status code and response headers
    ...
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @option opts [String] :filter A filter to apply to the list.
    # @return [Array<(AgentOptimizations, Integer, Hash)>] AgentOptimizations data, response status code and response headers
    ...
    def list_agent_skill_references(project_key, skill_key, opts = {})
      data, _status_code, _headers = list_agent_skill_references_with_http_info(project_key, skill_key, opts)
      data
    end
    ...
    # @option opts [Integer] :limit The number of resources to return.
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(AgentSkillReferences, Integer, Hash)>] AgentSkillReferences data, response status code and response headers
    def list_agent_skill_references_with_http_info(project_key, skill_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AgentControlApi.list_agent_skill_references ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling AgentControlApi.list_agent_skill_references"
      end
      # verify the required parameter 'skill_key' is set
      if @api_client.config.client_side_validation && skill_key.nil?
        fail ArgumentError, "Missing the required parameter 'skill_key' when calling AgentControlApi.list_agent_skill_references"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/ai-configs/skills/{skillKey}/references'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'skillKey' + '}', CGI.escape(skill_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AgentSkillReferences'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"AgentControlApi.list_agent_skill_references",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AgentControlApi#list_agent_skill_references\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [AgentSkills]
    def list_agent_skill_versions(project_key, skill_key, opts = {})
      data, _status_code, _headers = list_agent_skill_versions_with_http_info(project_key, skill_key, opts)
      data
    end
    ...
    # @option opts [Integer] :limit The number of resources to return.
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(AgentSkills, Integer, Hash)>] AgentSkills data, response status code and response headers
    def list_agent_skill_versions_with_http_info(project_key, skill_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AgentControlApi.list_agent_skill_versions ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling AgentControlApi.list_agent_skill_versions"
      end
      # verify the required parameter 'skill_key' is set
      if @api_client.config.client_side_validation && skill_key.nil?
        fail ArgumentError, "Missing the required parameter 'skill_key' when calling AgentControlApi.list_agent_skill_versions"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/ai-configs/skills/{skillKey}/versions'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'skillKey' + '}', CGI.escape(skill_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AgentSkills'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"AgentControlApi.list_agent_skill_versions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AgentControlApi#list_agent_skill_versions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :filter A filter to apply to the list.
    # @return [AgentSkills]
    def list_agent_skills(project_key, opts = {})
      data, _status_code, _headers = list_agent_skills_with_http_info(project_key, opts)
      data
    end
    ...
    # @option opts [String] :filter A filter to apply to the list.
    # @return [Array<(AgentSkills, Integer, Hash)>] AgentSkills data, response status code and response headers
    def list_agent_skills_with_http_info(project_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AgentControlApi.list_agent_skills ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling AgentControlApi.list_agent_skills"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/ai-configs/skills'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AgentControlApi.list_agent_skills",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AgentControlApi#list_agent_skills\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [ModelConfigs]
    def list_model_config_versions(project_key, model_config_key, opts = {})
      data, _status_code, _headers = list_model_config_versions_with_http_info(project_key, model_config_key, opts)
      data
    end
    ...
    # @option opts [Integer] :limit The number of resources to return.
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(ModelConfigs, Integer, Hash)>] ModelConfigs data, response status code and response headers
    def list_model_config_versions_with_http_info(project_key, model_config_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AgentControlApi.list_model_config_versions ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling AgentControlApi.list_model_config_versions"
      end
      # verify the required parameter 'model_config_key' is set
      if @api_client.config.client_side_validation && model_config_key.nil?
        fail ArgumentError, "Missing the required parameter 'model_config_key' when calling AgentControlApi.list_model_config_versions"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/ai-configs/model-configs/{modelConfigKey}/versions'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'modelConfigKey' + '}', CGI.escape(model_config_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ModelConfigs'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"AgentControlApi.list_model_config_versions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AgentControlApi#list_model_config_versions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :limit The number of resources to return.
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(SnippetReferences, Integer, Hash)>] SnippetReferences data, response status code and response headers
    ...
    # @option opts [Integer] :limit The number of resources to return.
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(PromptSnippets, Integer, Hash)>] PromptSnippets data, response status code and response headers
    ...
    # @param project_key [String] 
    # @param optimization_key [String] 
    # @param agent_optimization_patch [AgentOptimizationPatch] Agent optimization fields to update
    # @param [Hash] opts the optional parameters
    # @return [AgentOptimization]
    ...
    # @param agent_optimization_result_patch [AgentOptimizationResultPatch] Agent optimization result fields to update
    # @param [Hash] opts the optional parameters
    ...
    # @param agent_optimization_result_patch [AgentOptimizationResultPatch] Agent optimization result fields to update
    # @param [Hash] opts the optional parameters
    # @return [Array<(AgentOptimizationResult, Integer, Hash)>] AgentOptimizationResult data, response status code and response headers
    ...
    # @param project_key [String] 
    # @param skill_key [String] 
    # @param agent_skill_patch [AgentSkillPatch] Agent skill fields to update
    # @param [Hash] opts the optional parameters
    # @return [AgentSkill]
    def patch_agent_skill(project_key, skill_key, agent_skill_patch, opts = {})
      data, _status_code, _headers = patch_agent_skill_with_http_info(project_key, skill_key, agent_skill_patch, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AgentSkill, Integer, Hash)>] AgentSkill data, response status code and response headers
    def patch_agent_skill_with_http_info(project_key, skill_key, agent_skill_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AgentControlApi.patch_agent_skill ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling AgentControlApi.patch_agent_skill"
      end
      # verify the required parameter 'skill_key' is set
      if @api_client.config.client_side_validation && skill_key.nil?
        fail ArgumentError, "Missing the required parameter 'skill_key' when calling AgentControlApi.patch_agent_skill"
      end
      # verify the required parameter 'agent_skill_patch' is set
      if @api_client.config.client_side_validation && agent_skill_patch.nil?
        fail ArgumentError, "Missing the required parameter 'agent_skill_patch' when calling AgentControlApi.patch_agent_skill"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/ai-configs/skills/{skillKey}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'skillKey' + '}', CGI.escape(skill_key.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(agent_skill_patch)
      ...
      new_options = opts.merge(
        :operation => :"AgentControlApi.patch_agent_skill",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AgentControlApi#patch_agent_skill\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param project_key [String] 
    # @param model_config_key [String] 
    # @param model_config_patch [ModelConfigPatch] AI model config object to update
    # @param [Hash] opts the optional parameters
    # @return [ModelConfig]
    def patch_model_config(project_key, model_config_key, model_config_patch, opts = {})
      data, _status_code, _headers = patch_model_config_with_http_info(project_key, model_config_key, model_config_patch, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ModelConfig, Integer, Hash)>] ModelConfig data, response status code and response headers
    def patch_model_config_with_http_info(project_key, model_config_key, model_config_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AgentControlApi.patch_model_config ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling AgentControlApi.patch_model_config"
      end
      # verify the required parameter 'model_config_key' is set
      if @api_client.config.client_side_validation && model_config_key.nil?
        fail ArgumentError, "Missing the required parameter 'model_config_key' when calling AgentControlApi.patch_model_config"
      end
      # verify the required parameter 'model_config_patch' is set
      if @api_client.config.client_side_validation && model_config_patch.nil?
        fail ArgumentError, "Missing the required parameter 'model_config_patch' when calling AgentControlApi.patch_model_config"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/ai-configs/model-configs/{modelConfigKey}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'modelConfigKey' + '}', CGI.escape(model_config_key.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(model_config_patch)
      ...
      new_options = opts.merge(
        :operation => :"AgentControlApi.patch_model_config",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AgentControlApi#patch_model_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param project_key [String] 
    # @param snippet_key [String] 
    # @param prompt_snippet_patch [PromptSnippetPatch] Prompt snippet fields to update
    # @param [Hash] opts the optional parameters
    # @return [PromptSnippet]
    ...
    # @param project_key [String] 
    # @param agent_optimization_post [AgentOptimizationPost] Agent optimization object to create
    # @param [Hash] opts the optional parameters
    # @return [AgentOptimization]
    ...
    # @param project_key [String] 
    # @param optimization_key [String] 
    # @param agent_optimization_result_post [AgentOptimizationResultPost] Agent optimization result to create
    # @param [Hash] opts the optional parameters
    # @return [AgentOptimizationResult]
    ...
    # @param project_key [String] 
    # @param agent_skill_post [AgentSkillPost] Agent skill object to create
    # @param [Hash] opts the optional parameters
    # @return [AgentSkill]
    def post_agent_skill(project_key, agent_skill_post, opts = {})
      data, _status_code, _headers = post_agent_skill_with_http_info(project_key, agent_skill_post, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AgentSkill, Integer, Hash)>] AgentSkill data, response status code and response headers
    def post_agent_skill_with_http_info(project_key, agent_skill_post, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AgentControlApi.post_agent_skill ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling AgentControlApi.post_agent_skill"
      end
      # verify the required parameter 'agent_skill_post' is set
      if @api_client.config.client_side_validation && agent_skill_post.nil?
        fail ArgumentError, "Missing the required parameter 'agent_skill_post' when calling AgentControlApi.post_agent_skill"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/ai-configs/skills'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(agent_skill_post)
      ...
      new_options = opts.merge(
        :operation => :"AgentControlApi.post_agent_skill",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AgentControlApi#post_agent_skill\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param project_key [String] 
    # @param prompt_snippet_post [PromptSnippetPost] Prompt snippet object to create
    # @param [Hash] opts the optional parameters
    # @return [PromptSnippet]
