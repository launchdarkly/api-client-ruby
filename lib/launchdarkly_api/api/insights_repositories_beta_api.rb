...
module LaunchDarklyApi
  class InsightsRepositoriesBetaApi
    ...
    # Associate repositories with projects
    # @param insights_repository_project_mappings [InsightsRepositoryProjectMappings] 
    ...
    # @param insights_repository_project_mappings [InsightsRepositoryProjectMappings] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(InsightsRepositoryProjectCollection, Integer, Hash)>] InsightsRepositoryProjectCollection data, response status code and response headers
    ...
    # Remove repository project association
    # @param repository_key [String] The repository key
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :expand Expand properties in response. Options: &#x60;projects&#x60;
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :expand Expand properties in response. Options: &#x60;projects&#x60;
    # @return [Array<(InsightsRepositoryCollection, Integer, Hash)>] InsightsRepositoryCollection data, response status code and response headers
