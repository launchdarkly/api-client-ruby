...
module LaunchDarklyApi
  class ReleasePoliciesBetaApi
    ...
    # @param policy_key [String] The human-readable key of the release policy
    ...
    # @param project_key [String] The project key
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :exclude_default When true, exclude the default release policy from the response. When false or omitted, include the default policy if an environment filter is present. (default to false)
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :exclude_default When true, exclude the default release policy from the response. When false or omitted, include the default policy if an environment filter is present. (default to false)
    # @return [Array<(ReleasePoliciesResponse, Integer, Hash)>] ReleasePoliciesResponse data, response status code and response headers
    ...
    # @param ld_api_version [String] Version of the endpoint.
    # @param project_key [String] The project key
    # @param policy_key [String] The release policy key
    # @param [Hash] opts the optional parameters
    ...
    # @param policy_key [String] The release policy key
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReleasePolicy, Integer, Hash)>] ReleasePolicy data, response status code and response headers
    ...
    # @param ld_api_version [String] Version of the endpoint.
    # @param project_key [String] The project key
    # @param request_body [Array<String>] Array of release policy keys in the desired rank order (scoped policies only). These keys must include _all_ of the scoped release policies for the project.
    # @param [Hash] opts the optional parameters
    # @return [Array<ReleasePolicy>]
    ...
    # @param request_body [Array<String>] Array of release policy keys in the desired rank order (scoped policies only). These keys must include _all_ of the scoped release policies for the project.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<ReleasePolicy>, Integer, Hash)>] Array<ReleasePolicy> data, response status code and response headers
    ...
    # @param ld_api_version [String] Version of the endpoint.
    # @param project_key [String] The project key
    # @param post_release_policy_request [PostReleasePolicyRequest] Release policy to create
    # @param [Hash] opts the optional parameters
    # @return [ReleasePolicy]
    ...
    # @param project_key [String] The project key
    # @param policy_key [String] The human-readable key of the release policy
    # @param put_release_policy_request [PutReleasePolicyRequest] Release policy data to update
    # @param [Hash] opts the optional parameters
    # @return [ReleasePolicy]
