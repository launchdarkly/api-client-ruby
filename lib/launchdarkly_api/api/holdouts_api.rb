...
module LaunchDarklyApi
  class HoldoutsApi
    ...
    # @option opts [Integer] :limit The number of holdouts to return in the response. Defaults to 20
    ...
    # @option opts [Integer] :limit The number of holdouts to return in the response. Defaults to 20
    # @option opts [Integer] :offset Where to start in the list. Use this with pagination. For example, an &#x60;offset&#x60; of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(HoldoutsCollectionRep, Integer, Hash)>] HoldoutsCollectionRep data, response status code and response headers
    def get_all_holdouts_with_http_info(project_key, environment_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: HoldoutsApi.get_all_holdouts ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling HoldoutsApi.get_all_holdouts"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling HoldoutsApi.get_all_holdouts"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"HoldoutsApi.get_all_holdouts",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: HoldoutsApi#get_all_holdouts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param project_key [String] The project key
    # @param environment_key [String] The environment key
    # @param holdout_key [String] The holdout experiment key
    # @param [Hash] opts the optional parameters
    # @option opts [String] :expand A comma-separated list of properties that can reveal additional information in the response. Supported fields are explained above. Holdout experiment expansion fields have no prefix. Related experiment expansion fields have &#x60;rel-&#x60; as a prefix.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :expand A comma-separated list of properties that can reveal additional information in the response. Supported fields are explained above. Holdout experiment expansion fields have no prefix. Related experiment expansion fields have &#x60;rel-&#x60; as a prefix.
    # @return [Array<(HoldoutDetailRep, Integer, Hash)>] HoldoutDetailRep data, response status code and response headers
    def get_holdout_with_http_info(project_key, environment_key, holdout_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: HoldoutsApi.get_holdout ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling HoldoutsApi.get_holdout"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling HoldoutsApi.get_holdout"
      end
      # verify the required parameter 'holdout_key' is set
      if @api_client.config.client_side_validation && holdout_key.nil?
        fail ArgumentError, "Missing the required parameter 'holdout_key' when calling HoldoutsApi.get_holdout"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"HoldoutsApi.get_holdout",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: HoldoutsApi#get_holdout\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param project_key [String] The project key
    # @param environment_key [String] The environment key
    # @param holdout_id [String] The holdout experiment ID
    # @param [Hash] opts the optional parameters
    # @return [HoldoutRep]
    ...
    # @param holdout_id [String] The holdout experiment ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(HoldoutRep, Integer, Hash)>] HoldoutRep data, response status code and response headers
    def get_holdout_by_id_with_http_info(project_key, environment_key, holdout_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: HoldoutsApi.get_holdout_by_id ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling HoldoutsApi.get_holdout_by_id"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling HoldoutsApi.get_holdout_by_id"
      end
      # verify the required parameter 'holdout_id' is set
      if @api_client.config.client_side_validation && holdout_id.nil?
        fail ArgumentError, "Missing the required parameter 'holdout_id' when calling HoldoutsApi.get_holdout_by_id"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"HoldoutsApi.get_holdout_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: HoldoutsApi#get_holdout_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param project_key [String] The project key
    # @param environment_key [String] The environment key
    # @param holdout_key [String] The holdout key
    # @param holdout_patch_input [HoldoutPatchInput] 
    # @param [Hash] opts the optional parameters
    # @return [HoldoutRep]
    ...
    def patch_holdout_with_http_info(project_key, environment_key, holdout_key, holdout_patch_input, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: HoldoutsApi.patch_holdout ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling HoldoutsApi.patch_holdout"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling HoldoutsApi.patch_holdout"
      end
      # verify the required parameter 'holdout_key' is set
      if @api_client.config.client_side_validation && holdout_key.nil?
        fail ArgumentError, "Missing the required parameter 'holdout_key' when calling HoldoutsApi.patch_holdout"
      end
      ...
      if @api_client.config.client_side_validation && holdout_patch_input.nil?
        fail ArgumentError, "Missing the required parameter 'holdout_patch_input' when calling HoldoutsApi.patch_holdout"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s)).sub('{' + 'holdoutKey' + '}', CGI.escape(holdout_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"HoldoutsApi.patch_holdout",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: HoldoutsApi#patch_holdout\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param project_key [String] The project key
    # @param environment_key [String] The environment key
    # @param holdout_post_request [HoldoutPostRequest] 
    # @param [Hash] opts the optional parameters
    # @return [HoldoutRep]
    ...
    def post_holdout_with_http_info(project_key, environment_key, holdout_post_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: HoldoutsApi.post_holdout ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling HoldoutsApi.post_holdout"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling HoldoutsApi.post_holdout"
      end
      ...
      if @api_client.config.client_side_validation && holdout_post_request.nil?
        fail ArgumentError, "Missing the required parameter 'holdout_post_request' when calling HoldoutsApi.post_holdout"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"HoldoutsApi.post_holdout",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: HoldoutsApi#post_holdout\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
