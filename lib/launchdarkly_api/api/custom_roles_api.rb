...
module LaunchDarklyApi
  class CustomRolesApi
    ...
    # @param custom_role_key [String] The custom role key
    ...
    # @param custom_role_key [String] The custom role key or ID
    # @param [Hash] opts the optional parameters
    # @return [CustomRole]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :limit The maximum number of custom roles to return. Defaults to 20.
