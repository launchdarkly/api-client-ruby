...
module LaunchDarklyApi
  class OtherApi
    ...
    # Issue a &#x60;GET&#x60; request to the root resource to find all of the resource categories supported by the API
    # @param [Hash] opts the optional parameters
    # @return [Array<(Hash<String, Link>, Integer, Hash)>] Hash<String, Link> data, response status code and response headers
    def get_root_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Hash<String, Link>'
