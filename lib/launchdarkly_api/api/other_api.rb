...
module LaunchDarklyApi
  class OtherApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Hash<String, InlineResponse200>]
    def get_root(opts = {})
    ...
    # Issue a &#x60;GET&#x60; request to the root resource to find all of the resource categories supported by the API
    # @param [Hash] opts the optional parameters
    # @return [Array<(Hash<String, InlineResponse200>, Integer, Hash)>] Hash<String, InlineResponse200> data, response status code and response headers
