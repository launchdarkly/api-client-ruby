...
module LaunchDarklyApi
  class IPAllowlistBetaApi
    ...
    # @param create_ip_allowlist_entry_request [CreateIpAllowlistEntryRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IpAllowlistEntryResponse]
    def create_ip_allowlist_entry(create_ip_allowlist_entry_request, opts = {})
      data, _status_code, _headers = create_ip_allowlist_entry_with_http_info(create_ip_allowlist_entry_request, opts)
      data
    end
    ...
    # @param create_ip_allowlist_entry_request [CreateIpAllowlistEntryRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IpAllowlistEntryResponse, Integer, Hash)>] IpAllowlistEntryResponse data, response status code and response headers
    def create_ip_allowlist_entry_with_http_info(create_ip_allowlist_entry_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IPAllowlistBetaApi.create_ip_allowlist_entry ...'
      end
      # verify the required parameter 'create_ip_allowlist_entry_request' is set
      if @api_client.config.client_side_validation && create_ip_allowlist_entry_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_ip_allowlist_entry_request' when calling IPAllowlistBetaApi.create_ip_allowlist_entry"
      end
      # resource path
      local_var_path = '/api/v2/account/ip-allowlist'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_ip_allowlist_entry_request)

      # return_type
      return_type = opts[:debug_return_type] || 'IpAllowlistEntryResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"IPAllowlistBetaApi.create_ip_allowlist_entry",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IPAllowlistBetaApi#create_ip_allowlist_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [String] Unique identifier for the allowlist entry
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_ip_allowlist_entry(id, opts = {})
      delete_ip_allowlist_entry_with_http_info(id, opts)
      nil
    end
    ...
    def delete_ip_allowlist_entry_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IPAllowlistBetaApi.delete_ip_allowlist_entry ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IPAllowlistBetaApi.delete_ip_allowlist_entry"
      end
      # resource path
      local_var_path = '/api/v2/account/ip-allowlist/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"IPAllowlistBetaApi.delete_ip_allowlist_entry",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IPAllowlistBetaApi#delete_ip_allowlist_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :search A case-insensitive substring to filter entries by. Matches against the IP address or CIDR block and the description.
    # @option opts [Integer] :limit The number of entries to return. When omitted, all matching entries are returned. Maximum is 100.
    # @option opts [Integer] :offset The number of entries to skip. Used for pagination.
    ...
    def get_ip_allowlist_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IPAllowlistBetaApi.get_ip_allowlist ...'
      end
      # resource path
      local_var_path = '/api/v2/account/ip-allowlist'
      ...
      new_options = opts.merge(
        :operation => :"IPAllowlistBetaApi.get_ip_allowlist",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IPAllowlistBetaApi#get_ip_allowlist\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param patch_ip_allowlist_config_request [PatchIpAllowlistConfigRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IpAllowlistResponse]
    def patch_ip_allowlist_config(patch_ip_allowlist_config_request, opts = {})
      data, _status_code, _headers = patch_ip_allowlist_config_with_http_info(patch_ip_allowlist_config_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IpAllowlistResponse, Integer, Hash)>] IpAllowlistResponse data, response status code and response headers
    def patch_ip_allowlist_config_with_http_info(patch_ip_allowlist_config_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IPAllowlistBetaApi.patch_ip_allowlist_config ...'
      end
      # verify the required parameter 'patch_ip_allowlist_config_request' is set
      if @api_client.config.client_side_validation && patch_ip_allowlist_config_request.nil?
        fail ArgumentError, "Missing the required parameter 'patch_ip_allowlist_config_request' when calling IPAllowlistBetaApi.patch_ip_allowlist_config"
      end
      # resource path
      local_var_path = '/api/v2/account/ip-allowlist'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patch_ip_allowlist_config_request)
      ...
      new_options = opts.merge(
        :operation => :"IPAllowlistBetaApi.patch_ip_allowlist_config",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IPAllowlistBetaApi#patch_ip_allowlist_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] Unique identifier for the allowlist entry
    # @param patch_ip_allowlist_entry_request [PatchIpAllowlistEntryRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IpAllowlistEntryResponse]
    def patch_ip_allowlist_entry(id, patch_ip_allowlist_entry_request, opts = {})
      data, _status_code, _headers = patch_ip_allowlist_entry_with_http_info(id, patch_ip_allowlist_entry_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IpAllowlistEntryResponse, Integer, Hash)>] IpAllowlistEntryResponse data, response status code and response headers
    def patch_ip_allowlist_entry_with_http_info(id, patch_ip_allowlist_entry_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IPAllowlistBetaApi.patch_ip_allowlist_entry ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IPAllowlistBetaApi.patch_ip_allowlist_entry"
      end
      # verify the required parameter 'patch_ip_allowlist_entry_request' is set
      if @api_client.config.client_side_validation && patch_ip_allowlist_entry_request.nil?
        fail ArgumentError, "Missing the required parameter 'patch_ip_allowlist_entry_request' when calling IPAllowlistBetaApi.patch_ip_allowlist_entry"
      end
      # resource path
      local_var_path = '/api/v2/account/ip-allowlist/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patch_ip_allowlist_entry_request)
      ...
      new_options = opts.merge(
        :operation => :"IPAllowlistBetaApi.patch_ip_allowlist_entry",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IPAllowlistBetaApi#patch_ip_allowlist_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
