  ...
  class WorkflowsApi
    ...
    def delete_workflow_with_http_info(project_key, feature_flag_key, environment_key, workflow_id, opts = {})
      ...
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling WorkflowsApi.delete_workflow"
      end
      # verify the required parameter 'feature_flag_key' is set
      if @api_client.config.client_side_validation && feature_flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'feature_flag_key' when calling WorkflowsApi.delete_workflow"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling WorkflowsApi.delete_workflow"
      end
    ...
    # @param workflow_id [String] The workflow ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomWorkflowOutput, Integer, Hash)>] CustomWorkflowOutput data, response status code and response headers
    def get_custom_workflow_with_http_info(project_key, feature_flag_key, environment_key, workflow_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowsApi.get_custom_workflow ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling WorkflowsApi.get_custom_workflow"
      end
      # verify the required parameter 'feature_flag_key' is set
      if @api_client.config.client_side_validation && feature_flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'feature_flag_key' when calling WorkflowsApi.get_custom_workflow"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling WorkflowsApi.get_custom_workflow"
      end
      # verify the required parameter 'workflow_id' is set
      if @api_client.config.client_side_validation && workflow_id.nil?
        fail ArgumentError, "Missing the required parameter 'workflow_id' when calling WorkflowsApi.get_custom_workflow"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows/{workflowId}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'featureFlagKey' + '}', CGI.escape(feature_flag_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s)).sub('{' + 'workflowId' + '}', CGI.escape(workflow_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkflowsApi.get_custom_workflow",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowsApi#get_custom_workflow\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param environment_key [String] The environment key
    # @param [Hash] opts the optional parameters
    # @option opts [String] :status Filter results by workflow status. Valid status filters are &#x60;active&#x60;, &#x60;completed&#x60;, and &#x60;failed&#x60;.
    # @option opts [String] :sort A field to sort the items by. Prefix field by a dash ( - ) to sort in descending order. This endpoint supports sorting by &#x60;creationDate&#x60; or &#x60;stopDate&#x60;.
    # @option opts [Integer] :limit The maximum number of workflows to return. Defaults to 20.
    # @option opts [Integer] :offset Where to start in the list. Defaults to 0. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    ...
    # @option opts [Integer] :limit The maximum number of workflows to return. Defaults to 20.
    # @option opts [Integer] :offset Where to start in the list. Defaults to 0. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(CustomWorkflowsListingOutput, Integer, Hash)>] CustomWorkflowsListingOutput data, response status code and response headers
    def get_workflows_with_http_info(project_key, feature_flag_key, environment_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowsApi.get_workflows ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling WorkflowsApi.get_workflows"
      end
      # verify the required parameter 'feature_flag_key' is set
      if @api_client.config.client_side_validation && feature_flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'feature_flag_key' when calling WorkflowsApi.get_workflows"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling WorkflowsApi.get_workflows"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"WorkflowsApi.get_workflows",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowsApi#get_workflows\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param feature_flag_key [String] The feature flag key
    # @param environment_key [String] The environment key
    # @param custom_workflow_input [CustomWorkflowInput] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :template_key The template key to apply as a starting point for the new workflow
    # @option opts [Boolean] :dry_run Whether to call the endpoint in dry-run mode
    # @return [CustomWorkflowOutput]
    ...
    def post_workflow_with_http_info(project_key, feature_flag_key, environment_key, custom_workflow_input, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowsApi.post_workflow ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling WorkflowsApi.post_workflow"
      end
      # verify the required parameter 'feature_flag_key' is set
      if @api_client.config.client_side_validation && feature_flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'feature_flag_key' when calling WorkflowsApi.post_workflow"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling WorkflowsApi.post_workflow"
      end
      ...
      if @api_client.config.client_side_validation && custom_workflow_input.nil?
        fail ArgumentError, "Missing the required parameter 'custom_workflow_input' when calling WorkflowsApi.post_workflow"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'featureFlagKey' + '}', CGI.escape(feature_flag_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkflowsApi.post_workflow",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowsApi#post_workflow\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
