...
module LaunchDarklyApi
  class FollowFlagsApi
    ...
    # @param member_id [String] The memberId of the member to remove as a follower of the flag. Reader roles can only remove themselves.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_flag_followers(project_key, feature_flag_key, environment_key, member_id, opts = {})
      delete_flag_followers_with_http_info(project_key, feature_flag_key, environment_key, member_id, opts)
      nil
    end
    ...
    def delete_flag_followers_with_http_info(project_key, feature_flag_key, environment_key, member_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FollowFlagsApi.delete_flag_followers ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling FollowFlagsApi.delete_flag_followers"
      end
      # verify the required parameter 'feature_flag_key' is set
      if @api_client.config.client_side_validation && feature_flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'feature_flag_key' when calling FollowFlagsApi.delete_flag_followers"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling FollowFlagsApi.delete_flag_followers"
      end
      # verify the required parameter 'member_id' is set
      if @api_client.config.client_side_validation && member_id.nil?
        fail ArgumentError, "Missing the required parameter 'member_id' when calling FollowFlagsApi.delete_flag_followers"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers/{memberId}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'featureFlagKey' + '}', CGI.escape(feature_flag_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s)).sub('{' + 'memberId' + '}', CGI.escape(member_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"FollowFlagsApi.delete_flag_followers",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FollowFlagsApi#delete_flag_followers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_flag_followers(project_key, feature_flag_key, environment_key, opts = {})
      data, _status_code, _headers = get_flag_followers_with_http_info(project_key, feature_flag_key, environment_key, opts)
      data
    end
    ...
    # @param environment_key [String] The environment key
    # @param [Hash] opts the optional parameters
    # @return [Array<(FlagFollowersGetRep, Integer, Hash)>] FlagFollowersGetRep data, response status code and response headers
    def get_flag_followers_with_http_info(project_key, feature_flag_key, environment_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FollowFlagsApi.get_flag_followers ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling FollowFlagsApi.get_flag_followers"
      end
      # verify the required parameter 'feature_flag_key' is set
      if @api_client.config.client_side_validation && feature_flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'feature_flag_key' when calling FollowFlagsApi.get_flag_followers"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling FollowFlagsApi.get_flag_followers"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'featureFlagKey' + '}', CGI.escape(feature_flag_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FlagFollowersGetRep'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"FollowFlagsApi.get_flag_followers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FollowFlagsApi#get_flag_followers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_followers_by_proj_env(project_key, environment_key, opts = {})
      data, _status_code, _headers = get_followers_by_proj_env_with_http_info(project_key, environment_key, opts)
      data
    end
    ...
    # @param environment_key [String] The environment key
    # @param [Hash] opts the optional parameters
    # @return [Array<(FlagFollowersByProjEnvGetRep, Integer, Hash)>] FlagFollowersByProjEnvGetRep data, response status code and response headers
    def get_followers_by_proj_env_with_http_info(project_key, environment_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FollowFlagsApi.get_followers_by_proj_env ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling FollowFlagsApi.get_followers_by_proj_env"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling FollowFlagsApi.get_followers_by_proj_env"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/environments/{environmentKey}/followers'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FlagFollowersByProjEnvGetRep'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"FollowFlagsApi.get_followers_by_proj_env",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FollowFlagsApi#get_followers_by_proj_env\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param feature_flag_key [String] The feature flag key
    # @param environment_key [String] The environment key
    # @param member_id [String] The memberId of the member to add as a follower of the flag. Reader roles can only add themselves.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def put_flag_followers(project_key, feature_flag_key, environment_key, member_id, opts = {})
      put_flag_followers_with_http_info(project_key, feature_flag_key, environment_key, member_id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def put_flag_followers_with_http_info(project_key, feature_flag_key, environment_key, member_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FollowFlagsApi.put_flag_followers ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling FollowFlagsApi.put_flag_followers"
      end
      # verify the required parameter 'feature_flag_key' is set
      if @api_client.config.client_side_validation && feature_flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'feature_flag_key' when calling FollowFlagsApi.put_flag_followers"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling FollowFlagsApi.put_flag_followers"
      end
      # verify the required parameter 'member_id' is set
      if @api_client.config.client_side_validation && member_id.nil?
        fail ArgumentError, "Missing the required parameter 'member_id' when calling FollowFlagsApi.put_flag_followers"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers/{memberId}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'featureFlagKey' + '}', CGI.escape(feature_flag_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s)).sub('{' + 'memberId' + '}', CGI.escape(member_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"FollowFlagsApi.put_flag_followers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FollowFlagsApi#put_flag_followers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
