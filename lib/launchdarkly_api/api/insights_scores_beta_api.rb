...
module LaunchDarklyApi
  class InsightsScoresBetaApi
    ...
    # Create insight group
    # @param post_insight_group_params [PostInsightGroupParams] 
    # @param [Hash] opts the optional parameters
    # @return [InsightGroup]
    def create_insight_group(post_insight_group_params, opts = {})
      data, _status_code, _headers = create_insight_group_with_http_info(post_insight_group_params, opts)
      data
    end
    ...
    # @param post_insight_group_params [PostInsightGroupParams] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(InsightGroup, Integer, Hash)>] InsightGroup data, response status code and response headers
    def create_insight_group_with_http_info(post_insight_group_params, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InsightsScoresBetaApi.create_insight_group ...'
      end
      # verify the required parameter 'post_insight_group_params' is set
      if @api_client.config.client_side_validation && post_insight_group_params.nil?
        fail ArgumentError, "Missing the required parameter 'post_insight_group_params' when calling InsightsScoresBetaApi.create_insight_group"
      end
      # resource path
      local_var_path = '/api/v2/engineering-insights/insights/group'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(post_insight_group_params)

      # return_type
      return_type = opts[:debug_return_type] || 'InsightGroup'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"InsightsScoresBetaApi.create_insight_group",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InsightsScoresBetaApi#create_insight_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # Delete insight group
    # @param insight_group_key [String] The insight group key
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_insight_group(insight_group_key, opts = {})
      delete_insight_group_with_http_info(insight_group_key, opts)
      nil
    end
    ...
    def delete_insight_group_with_http_info(insight_group_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InsightsScoresBetaApi.delete_insight_group ...'
      end
      # verify the required parameter 'insight_group_key' is set
      if @api_client.config.client_side_validation && insight_group_key.nil?
        fail ArgumentError, "Missing the required parameter 'insight_group_key' when calling InsightsScoresBetaApi.delete_insight_group"
      end
      # resource path
      local_var_path = '/api/v2/engineering-insights/insights/groups/{insightGroupKey}'.sub('{' + 'insightGroupKey' + '}', CGI.escape(insight_group_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"InsightsScoresBetaApi.delete_insight_group",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InsightsScoresBetaApi#delete_insight_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param insight_group_key [String] The insight group key
    # @param [Hash] opts the optional parameters
    # @option opts [String] :expand Options: &#x60;scores&#x60;, &#x60;environment&#x60;
    # @return [InsightGroup]
    def get_insight_group(insight_group_key, opts = {})
      data, _status_code, _headers = get_insight_group_with_http_info(insight_group_key, opts)
      data
    end
    ...
    # @option opts [String] :expand Options: &#x60;scores&#x60;, &#x60;environment&#x60;
    # @return [Array<(InsightGroup, Integer, Hash)>] InsightGroup data, response status code and response headers
    def get_insight_group_with_http_info(insight_group_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InsightsScoresBetaApi.get_insight_group ...'
      end
      # verify the required parameter 'insight_group_key' is set
      if @api_client.config.client_side_validation && insight_group_key.nil?
        fail ArgumentError, "Missing the required parameter 'insight_group_key' when calling InsightsScoresBetaApi.get_insight_group"
      end
      # resource path
      local_var_path = '/api/v2/engineering-insights/insights/groups/{insightGroupKey}'.sub('{' + 'insightGroupKey' + '}', CGI.escape(insight_group_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"InsightsScoresBetaApi.get_insight_group",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InsightsScoresBetaApi#get_insight_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :limit The number of insight groups to return. Default is 20. Must be between 1 and 20 inclusive.
    ...
    # @option opts [String] :sort Sort flag list by field. Prefix field with &lt;code&gt;-&lt;/code&gt; to sort in descending order. Allowed fields: name
    # @option opts [String] :query Filter list of insights groups by name.
    # @option opts [String] :expand Options: &#x60;scores&#x60;, &#x60;environment&#x60;, &#x60;metadata&#x60;
    # @return [InsightGroupCollection]
    def get_insight_groups(opts = {})
      data, _status_code, _headers = get_insight_groups_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :query Filter list of insights groups by name.
    # @option opts [String] :expand Options: &#x60;scores&#x60;, &#x60;environment&#x60;, &#x60;metadata&#x60;
    # @return [Array<(InsightGroupCollection, Integer, Hash)>] InsightGroupCollection data, response status code and response headers
    def get_insight_groups_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InsightsScoresBetaApi.get_insight_groups ...'
      end
      # resource path
      local_var_path = '/api/v2/engineering-insights/insights/groups'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InsightGroupCollection'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"InsightsScoresBetaApi.get_insight_groups",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InsightsScoresBetaApi#get_insight_groups\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_insights_scores(project_key, environment_key, opts = {})
      data, _status_code, _headers = get_insights_scores_with_http_info(project_key, environment_key, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :application_key Comma separated list of application keys
    # @return [Array<(InsightScores, Integer, Hash)>] InsightScores data, response status code and response headers
    def get_insights_scores_with_http_info(project_key, environment_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InsightsScoresBetaApi.get_insights_scores ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling InsightsScoresBetaApi.get_insights_scores"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling InsightsScoresBetaApi.get_insights_scores"
      end
      # resource path
      local_var_path = '/api/v2/engineering-insights/insights/scores'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InsightScores'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"InsightsScoresBetaApi.get_insights_scores",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InsightsScoresBetaApi#get_insights_scores\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [InsightGroup]
    def patch_insight_group(insight_group_key, patch_operation, opts = {})
      data, _status_code, _headers = patch_insight_group_with_http_info(insight_group_key, patch_operation, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InsightGroup, Integer, Hash)>] InsightGroup data, response status code and response headers
    def patch_insight_group_with_http_info(insight_group_key, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InsightsScoresBetaApi.patch_insight_group ...'
      end
      # verify the required parameter 'insight_group_key' is set
      if @api_client.config.client_side_validation && insight_group_key.nil?
        fail ArgumentError, "Missing the required parameter 'insight_group_key' when calling InsightsScoresBetaApi.patch_insight_group"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling InsightsScoresBetaApi.patch_insight_group"
      end
      # resource path
      local_var_path = '/api/v2/engineering-insights/insights/groups/{insightGroupKey}'.sub('{' + 'insightGroupKey' + '}', CGI.escape(insight_group_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"InsightsScoresBetaApi.patch_insight_group",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InsightsScoresBetaApi#patch_insight_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
