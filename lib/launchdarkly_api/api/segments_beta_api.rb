...
module LaunchDarklyApi
  class SegmentsBetaApi
    ...
    def get_context_instance_segments_membership_by_env_with_http_info(project_key, environment_key, request_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SegmentsBetaApi.get_context_instance_segments_membership_by_env ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling SegmentsBetaApi.get_context_instance_segments_membership_by_env"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling SegmentsBetaApi.get_context_instance_segments_membership_by_env"
      end
      # verify the required parameter 'request_body' is set
      if @api_client.config.client_side_validation && request_body.nil?
        fail ArgumentError, "Missing the required parameter 'request_body' when calling SegmentsBetaApi.get_context_instance_segments_membership_by_env"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"SegmentsBetaApi.get_context_instance_segments_membership_by_env",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SegmentsBetaApi#get_context_instance_segments_membership_by_env\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
