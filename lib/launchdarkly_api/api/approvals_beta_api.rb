...
module LaunchDarklyApi
  class ApprovalsBetaApi
    ...
    def patch_approval_request(id, opts = {})
      data, _status_code, _headers = patch_approval_request_with_http_info(id, opts)
      data
    end
    ...
    def patch_approval_request_with_http_info(id, opts = {})
      if @api_client.config.debugging
