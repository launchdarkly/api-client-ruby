...
module LaunchDarklyApi
  class InsightsDeploymentsBetaApi
    ...
    # Create deployment event
    # @param post_deployment_event_input [PostDeploymentEventInput] 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :expand Expand properties in response. Options: &#x60;pullRequests&#x60;, &#x60;flagReferences&#x60;
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :expand Expand properties in response. Options: &#x60;pullRequests&#x60;, &#x60;flagReferences&#x60;
    # @return [Array<(DeploymentRep, Integer, Hash)>] DeploymentRep data, response status code and response headers
    ...
    # @option opts [String] :after Identifier used for pagination
    # @option opts [String] :before Identifier used for pagination
    # @option opts [String] :kind The deployment kind
    # @option opts [String] :status The deployment status
    ...
    # @option opts [String] :kind The deployment kind
    # @option opts [String] :status The deployment status
    # @return [Array<(DeploymentCollectionRep, Integer, Hash)>] DeploymentCollectionRep data, response status code and response headers
