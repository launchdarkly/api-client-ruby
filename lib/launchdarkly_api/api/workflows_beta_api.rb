...
module LaunchDarklyApi
  class WorkflowsBetaApi
    ...
    # @param workflow_id [String] The workflow ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomWorkflowOutputRep, Integer, Hash)>] CustomWorkflowOutputRep data, response status code and response headers
    ...
    # @param environment_key [String] The environment key
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomWorkflowsListingOutputRep, Integer, Hash)>] CustomWorkflowsListingOutputRep data, response status code and response headers
    def get_workflows_with_http_info(project_key, feature_flag_key, environment_key, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CustomWorkflowsListingOutputRep'
    ...
    # @param feature_flag_key [String] The feature flag key
    # @param environment_key [String] The environment key
    # @param custom_workflow_input_rep [CustomWorkflowInputRep] 
    # @param [Hash] opts the optional parameters
    # @return [CustomWorkflowOutputRep]
    def post_workflow(project_key, feature_flag_key, environment_key, custom_workflow_input_rep, opts = {})
      data, _status_code, _headers = post_workflow_with_http_info(project_key, feature_flag_key, environment_key, custom_workflow_input_rep, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomWorkflowOutputRep, Integer, Hash)>] CustomWorkflowOutputRep data, response status code and response headers
    def post_workflow_with_http_info(project_key, feature_flag_key, environment_key, custom_workflow_input_rep, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'custom_workflow_input_rep' is set
      if @api_client.config.client_side_validation && custom_workflow_input_rep.nil?
        fail ArgumentError, "Missing the required parameter 'custom_workflow_input_rep' when calling WorkflowsBetaApi.post_workflow"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'featureFlagKey' + '}', CGI.escape(feature_flag_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(custom_workflow_input_rep)
