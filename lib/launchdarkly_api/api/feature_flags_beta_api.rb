...
module LaunchDarklyApi
  class FeatureFlagsBetaApi
    ...
    def get_dependent_flags(proj_key, flag_key, opts = {})
      data, _status_code, _headers = get_dependent_flags_with_http_info(proj_key, flag_key, opts)
      data
    end
    ...
    def get_dependent_flags_with_http_info(proj_key, flag_key, opts = {})
      ...
      if @api_client.config.client_side_validation && proj_key.nil?
        fail ArgumentError, "Missing the required parameter 'proj_key' when calling FeatureFlagsBetaApi.get_dependent_flags"
      end
      # verify the required parameter 'flag_key' is set
      if @api_client.config.client_side_validation && flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'flag_key' when calling FeatureFlagsBetaApi.get_dependent_flags"
      end
      # resource path
      local_var_path = '/api/v2/flags/{projKey}/{flagKey}/dependent-flags'.sub('{' + 'projKey' + '}', CGI.escape(proj_key.to_s)).sub('{' + 'flagKey' + '}', CGI.escape(flag_key.to_s))
    ...
    def get_dependent_flags_by_env(proj_key, env_key, flag_key, opts = {})
      data, _status_code, _headers = get_dependent_flags_by_env_with_http_info(proj_key, env_key, flag_key, opts)
      data
    end
    ...
    def get_dependent_flags_by_env_with_http_info(proj_key, env_key, flag_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FeatureFlagsBetaApi.get_dependent_flags_by_env ...'
      end
      # verify the required parameter 'proj_key' is set
      if @api_client.config.client_side_validation && proj_key.nil?
        fail ArgumentError, "Missing the required parameter 'proj_key' when calling FeatureFlagsBetaApi.get_dependent_flags_by_env"
      end
      # verify the required parameter 'env_key' is set
      if @api_client.config.client_side_validation && env_key.nil?
        fail ArgumentError, "Missing the required parameter 'env_key' when calling FeatureFlagsBetaApi.get_dependent_flags_by_env"
      end
      # verify the required parameter 'flag_key' is set
      if @api_client.config.client_side_validation && flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'flag_key' when calling FeatureFlagsBetaApi.get_dependent_flags_by_env"
      end
      # resource path
      local_var_path = '/api/v2/flags/{projKey}/{envKey}/{flagKey}/dependent-flags'.sub('{' + 'projKey' + '}', CGI.escape(proj_key.to_s)).sub('{' + 'envKey' + '}', CGI.escape(env_key.to_s)).sub('{' + 'flagKey' + '}', CGI.escape(flag_key.to_s))
