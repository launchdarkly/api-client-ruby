...
module LaunchDarklyApi
  class WorkflowTemplatesBetaApi
    ...
    # @param create_workflow_template_input [CreateWorkflowTemplateInput] 
    # @param [Hash] opts the optional parameters
    # @return [WorkflowTemplateOutput]
    def create_workflow_template(create_workflow_template_input, opts = {})
      data, _status_code, _headers = create_workflow_template_with_http_info(create_workflow_template_input, opts)
      data
    end
    ...
    # @param create_workflow_template_input [CreateWorkflowTemplateInput] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkflowTemplateOutput, Integer, Hash)>] WorkflowTemplateOutput data, response status code and response headers
    def create_workflow_template_with_http_info(create_workflow_template_input, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowTemplatesBetaApi.create_workflow_template ...'
      end
      # verify the required parameter 'create_workflow_template_input' is set
      if @api_client.config.client_side_validation && create_workflow_template_input.nil?
        fail ArgumentError, "Missing the required parameter 'create_workflow_template_input' when calling WorkflowTemplatesBetaApi.create_workflow_template"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_workflow_template_input)

      # return_type
      return_type = opts[:debug_return_type] || 'WorkflowTemplateOutput'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"WorkflowTemplatesBetaApi.create_workflow_template",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowTemplatesBetaApi#create_workflow_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_workflow_template(template_key, opts = {})
      delete_workflow_template_with_http_info(template_key, opts)
      nil
    end
    ...
    def delete_workflow_template_with_http_info(template_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowTemplatesBetaApi.delete_workflow_template ...'
      end
      # verify the required parameter 'template_key' is set
      if @api_client.config.client_side_validation && template_key.nil?
        fail ArgumentError, "Missing the required parameter 'template_key' when calling WorkflowTemplatesBetaApi.delete_workflow_template"
      end
      # resource path
      local_var_path = '/api/v2/templates/{templateKey}'.sub('{' + 'templateKey' + '}', CGI.escape(template_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WorkflowTemplatesBetaApi.delete_workflow_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowTemplatesBetaApi#delete_workflow_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :summary Whether the entire template object or just a summary should be returned
    # @option opts [String] :search The substring in either the name or description of a template
    # @return [WorkflowTemplatesListingOutputRep]
    def get_workflow_templates(opts = {})
      data, _status_code, _headers = get_workflow_templates_with_http_info(opts)
      data
    end
    ...
    # @option opts [Boolean] :summary Whether the entire template object or just a summary should be returned
    # @option opts [String] :search The substring in either the name or description of a template
    # @return [Array<(WorkflowTemplatesListingOutputRep, Integer, Hash)>] WorkflowTemplatesListingOutputRep data, response status code and response headers
    def get_workflow_templates_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowTemplatesBetaApi.get_workflow_templates ...'
      end
      # resource path
      local_var_path = '/api/v2/templates'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'WorkflowTemplatesListingOutputRep'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"WorkflowTemplatesBetaApi.get_workflow_templates",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowTemplatesBetaApi#get_workflow_templates\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
