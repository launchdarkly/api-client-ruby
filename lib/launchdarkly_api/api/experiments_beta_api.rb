...
module LaunchDarklyApi
  class ExperimentsBetaApi
    ...
    def get_experiment_results_for_metric_group_with_http_info(project_key, environment_key, experiment_key, metric_group_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExperimentsBetaApi.get_experiment_results_for_metric_group ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ExperimentsBetaApi.get_experiment_results_for_metric_group"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ExperimentsBetaApi.get_experiment_results_for_metric_group"
      end
      # verify the required parameter 'experiment_key' is set
      if @api_client.config.client_side_validation && experiment_key.nil?
        fail ArgumentError, "Missing the required parameter 'experiment_key' when calling ExperimentsBetaApi.get_experiment_results_for_metric_group"
      end
      # verify the required parameter 'metric_group_key' is set
      if @api_client.config.client_side_validation && metric_group_key.nil?
        fail ArgumentError, "Missing the required parameter 'metric_group_key' when calling ExperimentsBetaApi.get_experiment_results_for_metric_group"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ExperimentsBetaApi.get_experiment_results_for_metric_group",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExperimentsBetaApi#get_experiment_results_for_metric_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_experimentation_settings_with_http_info(project_key, randomization_settings_put, opts = {})
      ...
      if @api_client.config.client_side_validation && randomization_settings_put.nil?
        fail ArgumentError, "Missing the required parameter 'randomization_settings_put' when calling ExperimentsBetaApi.put_experimentation_settings"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/experimentation-settings'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
