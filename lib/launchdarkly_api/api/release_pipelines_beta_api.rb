...
module LaunchDarklyApi
  class ReleasePipelinesBetaApi
    ...
    # @param pipeline_key [String] The release pipeline key
    ...
    # @option opts [Integer] :limit The maximum number of items to return. Defaults to 20.
    ...
    # @option opts [Integer] :limit The maximum number of items to return. Defaults to 20.
    # @option opts [Integer] :offset Where to start in the list. Defaults to 0. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(ReleasePipelineCollection, Integer, Hash)>] ReleasePipelineCollection data, response status code and response headers
    ...
    # @option opts [Integer] :limit The maximum number of items to return. Defaults to 20.
    # @option opts [Integer] :offset Where to start in the list. Defaults to 0. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(ReleaseProgressionCollection, Integer, Hash)>] ReleaseProgressionCollection data, response status code and response headers
    ...
    # @param pipeline_key [String] The release pipeline key
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReleasePipeline, Integer, Hash)>] ReleasePipeline data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @return [ReleasePipeline]
    def patch_release_pipeline(project_key, pipeline_key, opts = {})
      data, _status_code, _headers = patch_release_pipeline_with_http_info(project_key, pipeline_key, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReleasePipeline, Integer, Hash)>] ReleasePipeline data, response status code and response headers
    def patch_release_pipeline_with_http_info(project_key, pipeline_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReleasePipelinesBetaApi.patch_release_pipeline ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ReleasePipelinesBetaApi.patch_release_pipeline"
      end
      # verify the required parameter 'pipeline_key' is set
      if @api_client.config.client_side_validation && pipeline_key.nil?
        fail ArgumentError, "Missing the required parameter 'pipeline_key' when calling ReleasePipelinesBetaApi.patch_release_pipeline"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'pipelineKey' + '}', CGI.escape(pipeline_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ReleasePipelinesBetaApi.patch_release_pipeline",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReleasePipelinesBetaApi#patch_release_pipeline\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param project_key [String] The project key
    # @param create_release_pipeline_input [CreateReleasePipelineInput] 
    # @param [Hash] opts the optional parameters
    # @return [ReleasePipeline]
