...
module LaunchDarklyApi
  class SDKKeysBetaApi
    ...
    # @param environment_key [String] 
    # @param sdk_key_key [String] The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value.
    ...
    # @param sdk_key_key [String] The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value.
    # @param [Hash] opts the optional parameters
    # @return [Array<(SdkKey, Integer, Hash)>] SdkKey data, response status code and response headers
    ...
    # @param environment_key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :filter A filter to apply to the list of SDK keys. Supports the following fields and operators: &#x60;kind&#x60; (equals \&quot;sdk\&quot; or \&quot;mobile\&quot;), &#x60;active&#x60; (equals true or false). Format: &#x60;field:value&#x60;. Example: &#x60;kind:sdk&#x60;.
    # @option opts [Integer] :limit The number of SDK keys to return. Defaults to 20. Maximum is 100.
    # @option opts [Integer] :offset The number of SDK keys to skip. Used for pagination.
    # @option opts [String] :sort A sort to apply to the list of SDK keys. Supported field: &#x60;createdAt&#x60;. Prefix the field with &#x60;-&#x60; to sort in descending order (for example, &#x60;-createdAt&#x60;).
    # @return [SdkKeysForGetSdkKeys]
    def get_sdk_keys(ld_api_version, project_key, environment_key, opts = {})
      data, _status_code, _headers = get_sdk_keys_with_http_info(ld_api_version, project_key, environment_key, opts)
      data
    end
    ...
    # @option opts [Integer] :offset The number of SDK keys to skip. Used for pagination.
    # @option opts [String] :sort A sort to apply to the list of SDK keys. Supported field: &#x60;createdAt&#x60;. Prefix the field with &#x60;-&#x60; to sort in descending order (for example, &#x60;-createdAt&#x60;).
    # @return [Array<(SdkKeysForGetSdkKeys, Integer, Hash)>] SdkKeysForGetSdkKeys data, response status code and response headers
    def get_sdk_keys_with_http_info(ld_api_version, project_key, environment_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SDKKeysBetaApi.get_sdk_keys ...'
      end
      # verify the required parameter 'ld_api_version' is set
      if @api_client.config.client_side_validation && ld_api_version.nil?
        fail ArgumentError, "Missing the required parameter 'ld_api_version' when calling SDKKeysBetaApi.get_sdk_keys"
      end
      # verify enum value
      allowable_values = ["beta"]
      if @api_client.config.client_side_validation && !allowable_values.include?(ld_api_version)
      ...
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling SDKKeysBetaApi.get_sdk_keys"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling SDKKeysBetaApi.get_sdk_keys"
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SdkKeysForGetSdkKeys'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"SDKKeysBetaApi.get_sdk_keys",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SDKKeysBetaApi#get_sdk_keys\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param environment_key [String] 
    # @param sdk_key_key [String] The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value.
    # @param sdk_key_patch [SdkKeyPatch] An array of patches for updating an existing SDK key. The following fields are supported: &#x60;name&#x60;, &#x60;description&#x60;, &#x60;expiry&#x60;.
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :version The version of the SDK key for optimistic locking. If provided, the update will only succeed if the current version matches.
    # @return [SdkKey]
    ...
    # @param project_key [String] 
    # @param environment_key [String] 
    # @param sdk_key_post [SdkKeyPost] Parameters for creating a new SDK key
    # @param [Hash] opts the optional parameters
    # @return [SdkKey]
