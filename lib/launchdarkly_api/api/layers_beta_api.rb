...
module LaunchDarklyApi
  class LayersBetaApi
    ...
    # @param layer_post [LayerPost] 
    # @param [Hash] opts the optional parameters
    # @return [LayerRep]
    def create_layer(project_key, layer_post, opts = {})
      data, _status_code, _headers = create_layer_with_http_info(project_key, layer_post, opts)
      data
    end
    ...
    # @param layer_post [LayerPost] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(LayerRep, Integer, Hash)>] LayerRep data, response status code and response headers
    def create_layer_with_http_info(project_key, layer_post, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LayersBetaApi.create_layer ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling LayersBetaApi.create_layer"
      end
      # verify the required parameter 'layer_post' is set
      if @api_client.config.client_side_validation && layer_post.nil?
        fail ArgumentError, "Missing the required parameter 'layer_post' when calling LayersBetaApi.create_layer"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/layers'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(layer_post)

      # return_type
      return_type = opts[:debug_return_type] || 'LayerRep'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"LayersBetaApi.create_layer",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LayersBetaApi#create_layer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param project_key [String] The project key
    # @param [Hash] opts the optional parameters
    # @option opts [String] :filter A comma-separated list of filters. This endpoint only accepts filtering by &#x60;experimentKey&#x60;. The filter returns layers which include that experiment for the selected environment(s). For example: &#x60;filter&#x3D;reservations.experimentKey contains expKey&#x60;.
    # @return [LayerCollectionRep]
    def get_layers(project_key, opts = {})
      data, _status_code, _headers = get_layers_with_http_info(project_key, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :filter A comma-separated list of filters. This endpoint only accepts filtering by &#x60;experimentKey&#x60;. The filter returns layers which include that experiment for the selected environment(s). For example: &#x60;filter&#x3D;reservations.experimentKey contains expKey&#x60;.
    # @return [Array<(LayerCollectionRep, Integer, Hash)>] LayerCollectionRep data, response status code and response headers
    def get_layers_with_http_info(project_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LayersBetaApi.get_layers ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling LayersBetaApi.get_layers"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/layers'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'LayerCollectionRep'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"LayersBetaApi.get_layers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LayersBetaApi#get_layers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param project_key [String] The project key
    # @param layer_key [String] The layer key
    # @param layer_patch_input [LayerPatchInput] 
    # @param [Hash] opts the optional parameters
    # @return [LayerRep]
    def update_layer(project_key, layer_key, layer_patch_input, opts = {})
      data, _status_code, _headers = update_layer_with_http_info(project_key, layer_key, layer_patch_input, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(LayerRep, Integer, Hash)>] LayerRep data, response status code and response headers
    def update_layer_with_http_info(project_key, layer_key, layer_patch_input, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LayersBetaApi.update_layer ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling LayersBetaApi.update_layer"
      end
      # verify the required parameter 'layer_key' is set
      if @api_client.config.client_side_validation && layer_key.nil?
        fail ArgumentError, "Missing the required parameter 'layer_key' when calling LayersBetaApi.update_layer"
      end
      # verify the required parameter 'layer_patch_input' is set
      if @api_client.config.client_side_validation && layer_patch_input.nil?
        fail ArgumentError, "Missing the required parameter 'layer_patch_input' when calling LayersBetaApi.update_layer"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/layers/{layerKey}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'layerKey' + '}', CGI.escape(layer_key.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(layer_patch_input)
      ...
      new_options = opts.merge(
        :operation => :"LayersBetaApi.update_layer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LayersBetaApi#update_layer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
