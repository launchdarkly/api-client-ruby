...
module LaunchDarklyApi
  class RelayProxyConfigurationsApi
    ...
    # @param id [String] The relay auto config id
    ...
    # @param id [String] The relay auto config id
    # @param [Hash] opts the optional parameters
    # @return [Array<(RelayAutoConfigRep, Integer, Hash)>] RelayAutoConfigRep data, response status code and response headers
    ...
    # Get a list of Relay Proxy configurations in the account.
    # @param [Hash] opts the optional parameters
    # @return [Array<(RelayAutoConfigCollectionRep, Integer, Hash)>] RelayAutoConfigCollectionRep data, response status code and response headers
    ...
    # @param relay_auto_config_post [RelayAutoConfigPost] 
    # @param [Hash] opts the optional parameters
    # @return [RelayAutoConfigRep]
    ...
    # @param id [String] The Relay Proxy configuration ID
    # @param [Hash] opts the optional parameters
