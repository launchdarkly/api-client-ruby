...
module LaunchDarklyApi
  class FeatureFlagsApi
    ...
    def post_migration_safety_issues_with_http_info(project_key, flag_key, environment_key, flag_sempatch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FeatureFlagsApi.post_migration_safety_issues ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling FeatureFlagsApi.post_migration_safety_issues"
      end
      # verify the required parameter 'flag_key' is set
      if @api_client.config.client_side_validation && flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'flag_key' when calling FeatureFlagsApi.post_migration_safety_issues"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling FeatureFlagsApi.post_migration_safety_issues"
      end
      # verify the required parameter 'flag_sempatch' is set
      if @api_client.config.client_side_validation && flag_sempatch.nil?
        fail ArgumentError, "Missing the required parameter 'flag_sempatch' when calling FeatureFlagsApi.post_migration_safety_issues"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"FeatureFlagsApi.post_migration_safety_issues",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FeatureFlagsApi#post_migration_safety_issues\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
