...
module LaunchDarklyApi
  class DataExportDestinationsApi
    ...
    # @return [nil]
    def delete_destination(project_key, environment_key, id, opts = {})
      delete_destination_with_http_info(project_key, environment_key, id, opts)
      nil
    end
    ...
    def delete_destination_with_http_info(project_key, environment_key, id, opts = {})
      ...
      # resource path
      local_var_path = '/api/v2/destinations/{projectKey}/{environmentKey}/{id}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s)).sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Destination]
    def get_destination(project_key, environment_key, id, opts = {})
      data, _status_code, _headers = get_destination_with_http_info(project_key, environment_key, id, opts)
      data
    end
    ...
    def get_destination_with_http_info(project_key, environment_key, id, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [Destination]
    def patch_destination(project_key, environment_key, id, patch_operation, opts = {})
      data, _status_code, _headers = patch_destination_with_http_info(project_key, environment_key, id, patch_operation, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Destination, Integer, Hash)>] Destination data, response status code and response headers
    def patch_destination_with_http_info(project_key, environment_key, id, patch_operation, opts = {})
      if @api_client.config.debugging
    ...
    # @param kind [String] The destination kind (snowflake-v2, bigquery, clickhouse, redshift, databricks)
    # @param complete_setup_post_body [CompleteSetupPostBody] 
    # @param [Hash] opts the optional parameters
    # @return [Destination]
    def post_complete_warehouse_destination_setup(proj_key, env_key, kind, complete_setup_post_body, opts = {})
      data, _status_code, _headers = post_complete_warehouse_destination_setup_with_http_info(proj_key, env_key, kind, complete_setup_post_body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Destination, Integer, Hash)>] Destination data, response status code and response headers
    def post_complete_warehouse_destination_setup_with_http_info(proj_key, env_key, kind, complete_setup_post_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DataExportDestinationsApi.post_complete_warehouse_destination_setup ...'
      end
      # verify the required parameter 'proj_key' is set
      if @api_client.config.client_side_validation && proj_key.nil?
        fail ArgumentError, "Missing the required parameter 'proj_key' when calling DataExportDestinationsApi.post_complete_warehouse_destination_setup"
      end
      # verify the required parameter 'env_key' is set
      if @api_client.config.client_side_validation && env_key.nil?
        fail ArgumentError, "Missing the required parameter 'env_key' when calling DataExportDestinationsApi.post_complete_warehouse_destination_setup"
      end
      # verify the required parameter 'kind' is set
      if @api_client.config.client_side_validation && kind.nil?
        fail ArgumentError, "Missing the required parameter 'kind' when calling DataExportDestinationsApi.post_complete_warehouse_destination_setup"
      end
      # verify the required parameter 'complete_setup_post_body' is set
      if @api_client.config.client_side_validation && complete_setup_post_body.nil?
        fail ArgumentError, "Missing the required parameter 'complete_setup_post_body' when calling DataExportDestinationsApi.post_complete_warehouse_destination_setup"
      end
      # resource path
      local_var_path = '/api/v2/destinations/projects/{projKey}/environments/{envKey}/kinds/{kind}/complete-setup'.sub('{' + 'projKey' + '}', CGI.escape(proj_key.to_s)).sub('{' + 'envKey' + '}', CGI.escape(env_key.to_s)).sub('{' + 'kind' + '}', CGI.escape(kind.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(complete_setup_post_body)
      ...
      new_options = opts.merge(
        :operation => :"DataExportDestinationsApi.post_complete_warehouse_destination_setup",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DataExportDestinationsApi#post_complete_warehouse_destination_setup\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Destination]
    def post_destination(project_key, environment_key, destination_post, opts = {})
      data, _status_code, _headers = post_destination_with_http_info(project_key, environment_key, destination_post, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Destination, Integer, Hash)>] Destination data, response status code and response headers
    def post_destination_with_http_info(project_key, environment_key, destination_post, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/v2/destinations/{projectKey}/{environmentKey}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s))
    ...
    def post_generate_project_env_warehouse_destination_key_pair(proj_key, env_key, opts = {})
      data, _status_code, _headers = post_generate_project_env_warehouse_destination_key_pair_with_http_info(proj_key, env_key, opts)
      data
    end
    ...
    # @param env_key [String] The environment key
    # @param [Hash] opts the optional parameters
    # @return [Array<(GenerateWarehouseDestinationKeyPairPostRep, Integer, Hash)>] GenerateWarehouseDestinationKeyPairPostRep data, response status code and response headers
    def post_generate_project_env_warehouse_destination_key_pair_with_http_info(proj_key, env_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DataExportDestinationsApi.post_generate_project_env_warehouse_destination_key_pair ...'
      end
      # verify the required parameter 'proj_key' is set
      if @api_client.config.client_side_validation && proj_key.nil?
        fail ArgumentError, "Missing the required parameter 'proj_key' when calling DataExportDestinationsApi.post_generate_project_env_warehouse_destination_key_pair"
      end
      # verify the required parameter 'env_key' is set
      if @api_client.config.client_side_validation && env_key.nil?
        fail ArgumentError, "Missing the required parameter 'env_key' when calling DataExportDestinationsApi.post_generate_project_env_warehouse_destination_key_pair"
      end
      # resource path
      local_var_path = '/api/v2/destinations/projects/{projKey}/environments/{envKey}/generate-warehouse-destination-key-pair'.sub('{' + 'projKey' + '}', CGI.escape(proj_key.to_s)).sub('{' + 'envKey' + '}', CGI.escape(env_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GenerateWarehouseDestinationKeyPairPostRep'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"DataExportDestinationsApi.post_generate_project_env_warehouse_destination_key_pair",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DataExportDestinationsApi#post_generate_project_env_warehouse_destination_key_pair\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GenerateWarehouseDestinationKeyPairPostRep]
    def post_generate_warehouse_destination_key_pair(opts = {})
      data, _status_code, _headers = post_generate_warehouse_destination_key_pair_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GenerateWarehouseDestinationKeyPairPostRep, Integer, Hash)>] GenerateWarehouseDestinationKeyPairPostRep data, response status code and response headers
    def post_generate_warehouse_destination_key_pair_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DataExportDestinationsApi.post_generate_warehouse_destination_key_pair ...'
      end
      # resource path
      local_var_path = '/api/v2/destinations/generate-warehouse-destination-key-pair'
      ...
      new_options = opts.merge(
        :operation => :"DataExportDestinationsApi.post_generate_warehouse_destination_key_pair",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DataExportDestinationsApi#post_generate_warehouse_destination_key_pair\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param proj_key [String] The project key
    # @param env_key [String] The environment key
    # @param kind [String] The destination kind (snowflake-v2, redshift, clickhouse)
    # @param [Hash] opts the optional parameters
    # @option opts [WarehouseSetupScriptPostBody] :warehouse_setup_script_post_body 
    # @return [WarehouseDestinationSetupScriptRep]
    def post_generate_warehouse_destination_setup_script(proj_key, env_key, kind, opts = {})
      data, _status_code, _headers = post_generate_warehouse_destination_setup_script_with_http_info(proj_key, env_key, kind, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [WarehouseSetupScriptPostBody] :warehouse_setup_script_post_body 
    # @return [Array<(WarehouseDestinationSetupScriptRep, Integer, Hash)>] WarehouseDestinationSetupScriptRep data, response status code and response headers
    def post_generate_warehouse_destination_setup_script_with_http_info(proj_key, env_key, kind, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DataExportDestinationsApi.post_generate_warehouse_destination_setup_script ...'
      end
      # verify the required parameter 'proj_key' is set
      if @api_client.config.client_side_validation && proj_key.nil?
        fail ArgumentError, "Missing the required parameter 'proj_key' when calling DataExportDestinationsApi.post_generate_warehouse_destination_setup_script"
      end
      # verify the required parameter 'env_key' is set
      if @api_client.config.client_side_validation && env_key.nil?
        fail ArgumentError, "Missing the required parameter 'env_key' when calling DataExportDestinationsApi.post_generate_warehouse_destination_setup_script"
      end
      # verify the required parameter 'kind' is set
      if @api_client.config.client_side_validation && kind.nil?
        fail ArgumentError, "Missing the required parameter 'kind' when calling DataExportDestinationsApi.post_generate_warehouse_destination_setup_script"
      end
      # resource path
      local_var_path = '/api/v2/destinations/projects/{projKey}/environments/{envKey}/kinds/{kind}/setup'.sub('{' + 'projKey' + '}', CGI.escape(proj_key.to_s)).sub('{' + 'envKey' + '}', CGI.escape(env_key.to_s)).sub('{' + 'kind' + '}', CGI.escape(kind.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'warehouse_setup_script_post_body'])

      # return_type
      return_type = opts[:debug_return_type] || 'WarehouseDestinationSetupScriptRep'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"DataExportDestinationsApi.post_generate_warehouse_destination_setup_script",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DataExportDestinationsApi#post_generate_warehouse_destination_setup_script\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
