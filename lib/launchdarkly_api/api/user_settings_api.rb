...
module LaunchDarklyApi
  class UserSettingsApi
    ...
    def patch_expiring_flags_for_user(project_key, user_key, environment_key, patch_with_comment, opts = {})
      data, _status_code, _headers = patch_expiring_flags_for_user_with_http_info(project_key, user_key, environment_key, patch_with_comment, opts)
      data
    end
    ...
    def patch_expiring_flags_for_user_with_http_info(project_key, user_key, environment_key, patch_with_comment, opts = {})
      if @api_client.config.debugging
