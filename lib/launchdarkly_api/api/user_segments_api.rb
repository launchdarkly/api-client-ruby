...
module LaunchDarklyApi
  class UserSegmentsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def updated_big_segment_targets(project_key, environment_key, user_segment_key, big_segment_targets_body, opts = {})
      updated_big_segment_targets_with_http_info(project_key, environment_key, user_segment_key, big_segment_targets_body, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def updated_big_segment_targets_with_http_info(project_key, environment_key, user_segment_key, big_segment_targets_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserSegmentsApi.updated_big_segment_targets ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling UserSegmentsApi.updated_big_segment_targets"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling UserSegmentsApi.updated_big_segment_targets"
      end
      # verify the required parameter 'user_segment_key' is set
      if @api_client.config.client_side_validation && user_segment_key.nil?
        fail ArgumentError, "Missing the required parameter 'user_segment_key' when calling UserSegmentsApi.updated_big_segment_targets"
      end
      ...
      if @api_client.config.client_side_validation && big_segment_targets_body.nil?
        fail ArgumentError, "Missing the required parameter 'big_segment_targets_body' when calling UserSegmentsApi.updated_big_segment_targets"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserSegmentsApi#updated_big_segment_targets\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
