...
module LaunchDarklyApi
  class IntegrationDeliveryConfigurationsBetaApi
    ...
    # @param integration_delivery_configuration_post [IntegrationDeliveryConfigurationPost] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IntegrationDeliveryConfiguration, Integer, Hash)>] IntegrationDeliveryConfiguration data, response status code and response headers
    ...
    # @param environment_key [String] The environment key
    # @param [Hash] opts the optional parameters
    # @return [Array<(IntegrationDeliveryConfigurationCollection, Integer, Hash)>] IntegrationDeliveryConfigurationCollection data, response status code and response headers
    ...
    # @param id [String] The configuration ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(IntegrationDeliveryConfigurationResponse, Integer, Hash)>] IntegrationDeliveryConfigurationResponse data, response status code and response headers
