...
module LaunchDarklyApi
  class OAuth2ClientsBetaApi
    ...
    # @param oauth_client_post [OauthClientPost] 
    ...
    def create_o_auth2_client_with_http_info(oauth_client_post, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuth2ClientsBetaApi.create_o_auth2_client ...'
      end
      # verify the required parameter 'oauth_client_post' is set
      if @api_client.config.client_side_validation && oauth_client_post.nil?
        fail ArgumentError, "Missing the required parameter 'oauth_client_post' when calling OAuth2ClientsBetaApi.create_o_auth2_client"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OAuth2ClientsBetaApi.create_o_auth2_client",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OAuth2ClientsBetaApi#create_o_auth2_client\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_o_auth_client_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuth2ClientsBetaApi.delete_o_auth_client ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OAuth2ClientsBetaApi.delete_o_auth_client"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OAuth2ClientsBetaApi.delete_o_auth_client",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OAuth2ClientsBetaApi#delete_o_auth_client\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_o_auth_client_by_id_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuth2ClientsBetaApi.get_o_auth_client_by_id ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OAuth2ClientsBetaApi.get_o_auth_client_by_id"
      end
      # resource path
      local_var_path = '/api/v2/oauth/clients/{clientId}'.sub('{' + 'clientId' + '}', CGI.escape(client_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OAuth2ClientsBetaApi.get_o_auth_client_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OAuth2ClientsBetaApi#get_o_auth_client_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_o_auth_clients_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuth2ClientsBetaApi.get_o_auth_clients ...'
      end
      # resource path
      local_var_path = '/api/v2/oauth/clients'
      ...
      new_options = opts.merge(
        :operation => :"OAuth2ClientsBetaApi.get_o_auth_clients",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OAuth2ClientsBetaApi#get_o_auth_clients\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_o_auth_client_with_http_info(client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuth2ClientsBetaApi.patch_o_auth_client ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OAuth2ClientsBetaApi.patch_o_auth_client"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling OAuth2ClientsBetaApi.patch_o_auth_client"
      end
      # resource path
      local_var_path = '/api/v2/oauth/clients/{clientId}'.sub('{' + 'clientId' + '}', CGI.escape(client_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OAuth2ClientsBetaApi.patch_o_auth_client",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OAuth2ClientsBetaApi#patch_o_auth_client\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
