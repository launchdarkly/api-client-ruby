  ...
  class WorkflowTemplatesApi
    ...
    def create_workflow_template_with_http_info(create_workflow_template_input, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowTemplatesApi.create_workflow_template ...'
      end
      ...
      if @api_client.config.client_side_validation && create_workflow_template_input.nil?
        fail ArgumentError, "Missing the required parameter 'create_workflow_template_input' when calling WorkflowTemplatesApi.create_workflow_template"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"WorkflowTemplatesApi.create_workflow_template",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowTemplatesApi#create_workflow_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_workflow_template_with_http_info(template_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowTemplatesApi.delete_workflow_template ...'
      end
      # verify the required parameter 'template_key' is set
      if @api_client.config.client_side_validation && template_key.nil?
        fail ArgumentError, "Missing the required parameter 'template_key' when calling WorkflowTemplatesApi.delete_workflow_template"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"WorkflowTemplatesApi.delete_workflow_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowTemplatesApi#delete_workflow_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_workflow_templates_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WorkflowTemplatesApi.get_workflow_templates ...'
      end
      # resource path
      local_var_path = '/api/v2/templates'
      ...
      new_options = opts.merge(
        :operation => :"WorkflowTemplatesApi.get_workflow_templates",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkflowTemplatesApi#get_workflow_templates\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
