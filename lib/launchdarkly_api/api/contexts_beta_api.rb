  ...
  class ContextsBetaApi
    ...
    def delete_context_instances_with_http_info(project_key, environment_key, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.delete_context_instances ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.delete_context_instances"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ContextsBetaApi.delete_context_instances"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContextsBetaApi.delete_context_instances"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.delete_context_instances",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#delete_context_instances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def evaluate_context_instance_with_http_info(project_key, environment_key, request_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.evaluate_context_instance ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.evaluate_context_instance"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ContextsBetaApi.evaluate_context_instance"
      end
      # verify the required parameter 'request_body' is set
      if @api_client.config.client_side_validation && request_body.nil?
        fail ArgumentError, "Missing the required parameter 'request_body' when calling ContextsBetaApi.evaluate_context_instance"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.evaluate_context_instance",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#evaluate_context_instance\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_context_attribute_names_with_http_info(project_key, environment_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.get_context_attribute_names ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.get_context_attribute_names"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ContextsBetaApi.get_context_attribute_names"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.get_context_attribute_names",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#get_context_attribute_names\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_context_attribute_values_with_http_info(project_key, environment_key, attribute_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.get_context_attribute_values ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.get_context_attribute_values"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ContextsBetaApi.get_context_attribute_values"
      end
      # verify the required parameter 'attribute_name' is set
      if @api_client.config.client_side_validation && attribute_name.nil?
        fail ArgumentError, "Missing the required parameter 'attribute_name' when calling ContextsBetaApi.get_context_attribute_values"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.get_context_attribute_values",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#get_context_attribute_values\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_context_instances_with_http_info(project_key, environment_key, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.get_context_instances ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.get_context_instances"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ContextsBetaApi.get_context_instances"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContextsBetaApi.get_context_instances"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/environments/{environmentKey}/context-instances/{id}'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s)).sub('{' + 'environmentKey' + '}', CGI.escape(environment_key.to_s)).sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.get_context_instances",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#get_context_instances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_context_kinds_by_project_key_with_http_info(project_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.get_context_kinds_by_project_key ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.get_context_kinds_by_project_key"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.get_context_kinds_by_project_key",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#get_context_kinds_by_project_key\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_contexts_with_http_info(project_key, environment_key, kind, key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.get_contexts ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.get_contexts"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ContextsBetaApi.get_contexts"
      end
      # verify the required parameter 'kind' is set
      if @api_client.config.client_side_validation && kind.nil?
        fail ArgumentError, "Missing the required parameter 'kind' when calling ContextsBetaApi.get_contexts"
      end
      # verify the required parameter 'key' is set
      if @api_client.config.client_side_validation && key.nil?
        fail ArgumentError, "Missing the required parameter 'key' when calling ContextsBetaApi.get_contexts"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.get_contexts",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#get_contexts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_context_kind_with_http_info(project_key, key, upsert_context_kind_payload, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.put_context_kind ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.put_context_kind"
      end
      # verify the required parameter 'key' is set
      if @api_client.config.client_side_validation && key.nil?
        fail ArgumentError, "Missing the required parameter 'key' when calling ContextsBetaApi.put_context_kind"
      end
      ...
      if @api_client.config.client_side_validation && upsert_context_kind_payload.nil?
        fail ArgumentError, "Missing the required parameter 'upsert_context_kind_payload' when calling ContextsBetaApi.put_context_kind"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.put_context_kind",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#put_context_kind\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def search_context_instances_with_http_info(project_key, environment_key, context_instance_search, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.search_context_instances ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.search_context_instances"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ContextsBetaApi.search_context_instances"
      end
      ...
      if @api_client.config.client_side_validation && context_instance_search.nil?
        fail ArgumentError, "Missing the required parameter 'context_instance_search' when calling ContextsBetaApi.search_context_instances"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.search_context_instances",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#search_context_instances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def search_contexts_with_http_info(project_key, environment_key, context_search, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContextsBetaApi.search_contexts ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ContextsBetaApi.search_contexts"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ContextsBetaApi.search_contexts"
      end
      # verify the required parameter 'context_search' is set
      if @api_client.config.client_side_validation && context_search.nil?
        fail ArgumentError, "Missing the required parameter 'context_search' when calling ContextsBetaApi.search_contexts"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContextsBetaApi.search_contexts",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContextsBetaApi#search_contexts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
