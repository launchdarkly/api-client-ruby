...
module LaunchDarklyApi
  class ProjectsApi
    ...
    def get_flag_defaults_by_project(project_key, opts = {})
      data, _status_code, _headers = get_flag_defaults_by_project_with_http_info(project_key, opts)
      data
    end
    ...
    # @param project_key [String] The project key
    # @param [Hash] opts the optional parameters
    # @return [Array<(FlagDefaultsRep, Integer, Hash)>] FlagDefaultsRep data, response status code and response headers
    def get_flag_defaults_by_project_with_http_info(project_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectsApi.get_flag_defaults_by_project ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ProjectsApi.get_flag_defaults_by_project"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/flag-defaults'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FlagDefaultsRep'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"ProjectsApi.get_flag_defaults_by_project",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProjectsApi#get_flag_defaults_by_project\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :limit The number of projects to return in the response. Defaults to 20.
    ...
    # @option opts [String] :filter A comma-separated list of filters. Each filter is constructed as &#x60;field:value&#x60;.
    ...
    def patch_flag_defaults_by_project(project_key, patch_operation, opts = {})
      data, _status_code, _headers = patch_flag_defaults_by_project_with_http_info(project_key, patch_operation, opts)
      data
    end
    ...
    # @param patch_operation [Array<PatchOperation>] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpsertPayloadRep, Integer, Hash)>] UpsertPayloadRep data, response status code and response headers
    def patch_flag_defaults_by_project_with_http_info(project_key, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectsApi.patch_flag_defaults_by_project ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ProjectsApi.patch_flag_defaults_by_project"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling ProjectsApi.patch_flag_defaults_by_project"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/flag-defaults'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UpsertPayloadRep'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"ProjectsApi.patch_flag_defaults_by_project",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProjectsApi#patch_flag_defaults_by_project\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param patch_operation [Array<PatchOperation>] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ProjectRep, Integer, Hash)>] ProjectRep data, response status code and response headers
    def patch_project_with_http_info(project_key, patch_operation, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ProjectRep'
    ...
    # @param project_post [ProjectPost] 
    # @param [Hash] opts the optional parameters
    # @return [ProjectRep]
    ...
    # @param project_key [String] The project key
    # @param upsert_flag_defaults_payload [UpsertFlagDefaultsPayload] 
    # @param [Hash] opts the optional parameters
    # @return [UpsertPayloadRep]
    def put_flag_defaults_by_project(project_key, upsert_flag_defaults_payload, opts = {})
      data, _status_code, _headers = put_flag_defaults_by_project_with_http_info(project_key, upsert_flag_defaults_payload, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpsertPayloadRep, Integer, Hash)>] UpsertPayloadRep data, response status code and response headers
    def put_flag_defaults_by_project_with_http_info(project_key, upsert_flag_defaults_payload, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectsApi.put_flag_defaults_by_project ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ProjectsApi.put_flag_defaults_by_project"
      end
      # verify the required parameter 'upsert_flag_defaults_payload' is set
      if @api_client.config.client_side_validation && upsert_flag_defaults_payload.nil?
        fail ArgumentError, "Missing the required parameter 'upsert_flag_defaults_payload' when calling ProjectsApi.put_flag_defaults_by_project"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/flag-defaults'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(upsert_flag_defaults_payload)
      ...
      new_options = opts.merge(
        :operation => :"ProjectsApi.put_flag_defaults_by_project",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProjectsApi#put_flag_defaults_by_project\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
