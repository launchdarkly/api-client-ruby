...
module LaunchDarklyApi
  class ExperimentsApi
    ...
    def get_legacy_experiment_results_with_http_info(project_key, feature_flag_key, environment_key, metric_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExperimentsApi.get_legacy_experiment_results ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ExperimentsApi.get_legacy_experiment_results"
      end
      # verify the required parameter 'feature_flag_key' is set
      if @api_client.config.client_side_validation && feature_flag_key.nil?
        fail ArgumentError, "Missing the required parameter 'feature_flag_key' when calling ExperimentsApi.get_legacy_experiment_results"
      end
      # verify the required parameter 'environment_key' is set
      if @api_client.config.client_side_validation && environment_key.nil?
        fail ArgumentError, "Missing the required parameter 'environment_key' when calling ExperimentsApi.get_legacy_experiment_results"
      end
      # verify the required parameter 'metric_key' is set
      if @api_client.config.client_side_validation && metric_key.nil?
        fail ArgumentError, "Missing the required parameter 'metric_key' when calling ExperimentsApi.get_legacy_experiment_results"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ExperimentsApi.get_legacy_experiment_results",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExperimentsApi#get_legacy_experiment_results\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
