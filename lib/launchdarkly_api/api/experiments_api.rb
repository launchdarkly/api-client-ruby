...
module LaunchDarklyApi
  class ExperimentsApi
    ...
    # @option opts [String] :lifecycle_state A comma-separated list of experiment archived states. Supports &#x60;archived&#x60;, &#x60;active&#x60;, or both. Defaults to &#x60;active&#x60; experiments.
    # @return [ExperimentCollectionRep]
    def get_experiments_any_env(project_key, opts = {})
      data, _status_code, _headers = get_experiments_any_env_with_http_info(project_key, opts)
      data
    end
    ...
    # @option opts [String] :lifecycle_state A comma-separated list of experiment archived states. Supports &#x60;archived&#x60;, &#x60;active&#x60;, or both. Defaults to &#x60;active&#x60; experiments.
    # @return [Array<(ExperimentCollectionRep, Integer, Hash)>] ExperimentCollectionRep data, response status code and response headers
    def get_experiments_any_env_with_http_info(project_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExperimentsApi.get_experiments_any_env ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling ExperimentsApi.get_experiments_any_env"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/experiments'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ExperimentsApi.get_experiments_any_env",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExperimentsApi#get_experiments_any_env\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
