  ...
  class LayersApi
    ...
    def create_layer_with_http_info(project_key, layer_post, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LayersApi.create_layer ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling LayersApi.create_layer"
      end
      # verify the required parameter 'layer_post' is set
      if @api_client.config.client_side_validation && layer_post.nil?
        fail ArgumentError, "Missing the required parameter 'layer_post' when calling LayersApi.create_layer"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"LayersApi.create_layer",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LayersApi#create_layer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_layers_with_http_info(project_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LayersApi.get_layers ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling LayersApi.get_layers"
      end
      # resource path
      local_var_path = '/api/v2/projects/{projectKey}/layers'.sub('{' + 'projectKey' + '}', CGI.escape(project_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"LayersApi.get_layers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LayersApi#get_layers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_layer_with_http_info(project_key, layer_key, layer_patch_input, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LayersApi.update_layer ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling LayersApi.update_layer"
      end
      # verify the required parameter 'layer_key' is set
      if @api_client.config.client_side_validation && layer_key.nil?
        fail ArgumentError, "Missing the required parameter 'layer_key' when calling LayersApi.update_layer"
      end
      # verify the required parameter 'layer_patch_input' is set
      if @api_client.config.client_side_validation && layer_patch_input.nil?
        fail ArgumentError, "Missing the required parameter 'layer_patch_input' when calling LayersApi.update_layer"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"LayersApi.update_layer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LayersApi#update_layer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
