...
module LaunchDarklyApi
  class AccessTokensApi
    ...
    # @param id [String] The ID of the access token to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_token(id, opts = {})
      delete_token_with_http_info(id, opts)
      nil
    end
    ...
    def delete_token_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccessTokensApi.delete_token"
      end
      # resource path
      local_var_path = '/api/v2/tokens/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccessTokensApi.delete_token",
    ...
    # @param id [String] The ID of the access token
    # @param [Hash] opts the optional parameters
    # @return [Token]
    def get_token(id, opts = {})
      data, _status_code, _headers = get_token_with_http_info(id, opts)
      data
    end
    ...
    def get_token_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccessTokensApi.get_token ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccessTokensApi.get_token"
      end
      # resource path
      local_var_path = '/api/v2/tokens/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccessTokensApi.get_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [Integer] :limit The number of access tokens to return in the response. Defaults to 25.
    ...
    # @option opts [Integer] :limit The number of access tokens to return in the response. Defaults to 25.
    # @option opts [Integer] :offset Where to start in the list. This is for use with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
    # @return [Array<(Tokens, Integer, Hash)>] Tokens data, response status code and response headers
    def get_tokens_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccessTokensApi.get_tokens ...'
      end
      # resource path
      local_var_path = '/api/v2/tokens'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Tokens'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"AccessTokensApi.get_tokens",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @return [Token]
    def patch_token(id, patch_operation, opts = {})
      data, _status_code, _headers = patch_token_with_http_info(id, patch_operation, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Token, Integer, Hash)>] Token data, response status code and response headers
    def patch_token_with_http_info(id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccessTokensApi.patch_token ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccessTokensApi.patch_token"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling AccessTokensApi.patch_token"
      end
      # resource path
      local_var_path = '/api/v2/tokens/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccessTokensApi.patch_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param access_token_post [AccessTokenPost] 
    # @param [Hash] opts the optional parameters
    # @return [Token]
    def post_token(access_token_post, opts = {})
      data, _status_code, _headers = post_token_with_http_info(access_token_post, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Token, Integer, Hash)>] Token data, response status code and response headers
    def post_token_with_http_info(access_token_post, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccessTokensApi.post_token ...'
      end
      # verify the required parameter 'access_token_post' is set
      if @api_client.config.client_side_validation && access_token_post.nil?
        fail ArgumentError, "Missing the required parameter 'access_token_post' when calling AccessTokensApi.post_token"
      end
      # resource path
      local_var_path = '/api/v2/tokens'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(access_token_post)
      ...
      new_options = opts.merge(
        :operation => :"AccessTokensApi.post_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @return [Token]
    def reset_token(id, opts = {})
      data, _status_code, _headers = reset_token_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Integer] :expiry An expiration time for the old token key, expressed as a Unix epoch time in milliseconds. By default, the token will expire immediately.
    # @return [Array<(Token, Integer, Hash)>] Token data, response status code and response headers
    def reset_token_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccessTokensApi.reset_token ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccessTokensApi.reset_token"
      end
      # resource path
      local_var_path = '/api/v2/tokens/{id}/reset'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccessTokensApi.reset_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
