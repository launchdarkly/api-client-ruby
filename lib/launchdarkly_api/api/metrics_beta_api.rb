...
module LaunchDarklyApi
  class MetricsBetaApi
    ...
    # @param metric_group_post [MetricGroupPost] 
    ...
    # @param metric_group_post [MetricGroupPost] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(MetricGroupRep, Integer, Hash)>] MetricGroupRep data, response status code and response headers
    ...
    # @param project_key [String] The project key
    # @param [Hash] opts the optional parameters
    # @option opts [String] :filter Accepts filter by &#x60;experimentStatus&#x60; and &#x60;query&#x60;. Example: &#x60;filter&#x3D;experimentStatus equals &#39;running&#39; and query equals &#39;test&#39;&#x60;.
    # @option opts [String] :expand A comma-separated list of properties that can reveal additional information in the response.
