...
module LaunchDarklyApi
  class AuditLogApi
    ...
    # @option opts [String] :q Text to search for. You can search for the full or partial name of the resource.
    # @option opts [Integer] :limit A limit on the number of audit log entries that return. Set between 1 and 20. The default is 10.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :before A timestamp filter, expressed as a Unix epoch time in milliseconds.  All entries returned occurred before the timestamp.
    # @option opts [Integer] :after A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries returned occurred after the timestamp.
    # @option opts [String] :q Text to search for. You can search for the full or partial name of the resource.
    # @option opts [Integer] :limit A limit on the number of audit log entries that return. Set between 1 and 20. The default is 10.
    # @option opts [Array<StatementPost>] :statement_post 
    # @return [AuditLogEntryListingRepCollection]
