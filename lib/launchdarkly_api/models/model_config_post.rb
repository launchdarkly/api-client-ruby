...
module LaunchDarklyApi
  class ModelConfigPost < ApiModelBase
    ...
    attr_accessor :cost_per_input_token

    # Cost per output token in USD
    attr_accessor :cost_per_output_token

    # Cost per cached input token in USD
    attr_accessor :cost_per_cached_input_token
    ...
    def self.attribute_map
      {
        ...
        :'cost_per_cached_input_token' => :'costPerCachedInputToken'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'cost_per_cached_input_token' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ModelConfigPost` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ModelConfigPost`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cost_per_cached_input_token')
        self.cost_per_cached_input_token = attributes[:'cost_per_cached_input_token']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cost_per_cached_input_token == o.cost_per_cached_input_token
    end
    ...
    def hash
      [name, key, id, maintainer_id, maintainer_team_key, icon, provider, params, custom_params, tags, cost_per_input_token, cost_per_output_token, cost_per_cached_input_token].hash
    end
