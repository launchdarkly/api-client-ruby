...
module LaunchDarklyApi
  class ContextRecord < ApiModelBase
    ...
    attr_accessor :associated_contexts
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ContextRecord` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ContextRecord`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'associated_contexts')
        self.associated_contexts = attributes[:'associated_contexts']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _links == o._links &&
          _access == o._access &&
          associated_contexts == o.associated_contexts
    end
    ...
    def hash
      [last_seen, application_id, context, _links, _access, associated_contexts].hash
    end
