...
module LaunchDarklyApi
  class Maintainer < ApiModelBase
    attr_accessor :id

    attr_accessor :kind

    attr_accessor :maintainer_member

    attr_accessor :maintainer_team
    ...
    def self.attribute_map
      {
        :'id' => :'id',
        :'kind' => :'kind',
        :'maintainer_member' => :'maintainerMember',
        :'maintainer_team' => :'maintainerTeam'
      }
    end
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'kind' => :'String',
        :'maintainer_member' => :'ViewsMaintainerMember',
        :'maintainer_team' => :'ViewsMaintainerTeam'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::Maintainer` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::Maintainer`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'maintainer_member')
        self.maintainer_member = attributes[:'maintainer_member']
      end

      if attributes.key?(:'maintainer_team')
        self.maintainer_team = attributes[:'maintainer_team']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          kind == o.kind &&
          maintainer_member == o.maintainer_member &&
          maintainer_team == o.maintainer_team
    end
    ...
    def hash
      [id, kind, maintainer_member, maintainer_team].hash
    end
