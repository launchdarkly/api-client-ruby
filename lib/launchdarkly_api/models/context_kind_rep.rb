...
module LaunchDarklyApi
  class ContextKindRep < ApiModelBase
    ...
    attr_accessor :environment_observations

    attr_accessor :created_from

    # Alias for archived.
    attr_accessor :hide_in_targeting
    ...
    def self.openapi_types
      {
        ...
        :'last_seen' => :'Integer',
        :'environment_observations' => :'Array<ContextKindEnvironmentObservation>',
        :'created_from' => :'String',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ContextKindRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'environment_observations')
        if (value = attributes[:'environment_observations']).is_a?(Array)
          self.environment_observations = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          environment_observations == o.environment_observations &&
    ...
    def hash
      [key, name, description, version, creation_date, last_modified, last_seen, environment_observations, created_from, hide_in_targeting, archived, _links].hash
    end
