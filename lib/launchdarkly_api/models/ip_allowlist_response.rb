...
module LaunchDarklyApi
  class IpAllowlistResponse < ApiModelBase
    attr_accessor :_links

    attr_accessor :session_allowlist_enabled

    attr_accessor :api_token_allowlist_enabled

    # The total number of entries matching the query, before pagination.
    ...
    def self.attribute_map
      {
        :'_links' => :'_links',
        :'session_allowlist_enabled' => :'sessionAllowlistEnabled',
        :'api_token_allowlist_enabled' => :'apiTokenAllowlistEnabled',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::IpAllowlistResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::IpAllowlistResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'session_allowlist_enabled')
        self.session_allowlist_enabled = attributes[:'session_allowlist_enabled']
      else
        self.session_allowlist_enabled = nil
      end

      if attributes.key?(:'api_token_allowlist_enabled')
        self.api_token_allowlist_enabled = attributes[:'api_token_allowlist_enabled']
      else
        self.api_token_allowlist_enabled = nil
      end
    ...
    def list_invalid_properties
      ...
      if @session_allowlist_enabled.nil?
        invalid_properties.push('invalid value for "session_allowlist_enabled", session_allowlist_enabled cannot be nil.')
      end

      if @api_token_allowlist_enabled.nil?
        invalid_properties.push('invalid value for "api_token_allowlist_enabled", api_token_allowlist_enabled cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @session_allowlist_enabled.nil?
      return false if @api_token_allowlist_enabled.nil?
      return false if @entries.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] session_allowlist_enabled Value to be assigned
    def session_allowlist_enabled=(session_allowlist_enabled)
      if session_allowlist_enabled.nil?
        fail ArgumentError, 'session_allowlist_enabled cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] api_token_allowlist_enabled Value to be assigned
    def api_token_allowlist_enabled=(api_token_allowlist_enabled)
      if api_token_allowlist_enabled.nil?
        fail ArgumentError, 'api_token_allowlist_enabled cannot be nil'
      end

      @api_token_allowlist_enabled = api_token_allowlist_enabled
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _links == o._links &&
          session_allowlist_enabled == o.session_allowlist_enabled &&
          api_token_allowlist_enabled == o.api_token_allowlist_enabled &&
    ...
    def hash
      [_links, session_allowlist_enabled, api_token_allowlist_enabled, total_count, entries].hash
    end
