...
module LaunchDarklyApi
  class AiConfigsLegacyExperimentRep
    ...
    attr_accessor :_environment_settings
    ...
    def self.openapi_types
      {
        ...
        :'_environment_settings' => :'Hash<String, AiConfigsExperimentEnvironmentSettingRep>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AiConfigsLegacyExperimentRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AiConfigsLegacyExperimentRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_metric')
        self._metric = attributes[:'_metric']
      end
      ...
      if attributes.key?(:'_environment_settings')
        if (value = attributes[:'_environment_settings']).is_a?(Hash)
          self._environment_settings = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _environment_settings == o._environment_settings
    end
    ...
    def hash
      [metric_key, _metric, environments, _environment_settings].hash
    end
