...
module LaunchDarklyApi
  class ExpandedTeamRep
    ...
    attr_accessor :team_maintainers
    ...
    def self.attribute_map
      {
        ...
        :'team_maintainers' => :'teamMaintainers',
    ...
    def self.openapi_types
      {
        :'custom_roles' => :'Array<CustomRolesRep>',
        :'team_maintainers' => :'Array<MemberSummaryRep>',
        :'custom_role_keys' => :'Array<String>',
        :'description' => :'String',
        :'key' => :'String',
        :'member_ids' => :'Array<String>',
        :'name' => :'String',
        :'permission_grants' => :'Array<PermissionGrantRep>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ExpandedTeamRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ExpandedTeamRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'team_maintainers')
        if (value = attributes[:'team_maintainers']).is_a?(Array)
          self.team_maintainers = value
        end
      end

      if attributes.key?(:'custom_role_keys')
        if (value = attributes[:'custom_role_keys']).is_a?(Array)
          self.custom_role_keys = value
        end
      end
      ...
      if attributes.key?(:'project_keys')
        if (value = attributes[:'project_keys']).is_a?(Array)
          self.project_keys = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          team_maintainers == o.team_maintainers &&
          custom_role_keys == o.custom_role_keys &&
    ...
    def hash
      [custom_roles, team_maintainers, custom_role_keys, description, key, member_ids, name, permission_grants, project_keys, _access, _created_at, _links, _updated_at, _version].hash
    end
