...
module LaunchDarklyApi
  class ReleaseProgression < ApiModelBase
    attr_accessor :_created_at

    attr_accessor :_completed_at

    # The flag key
    attr_accessor :flag_key

    # The ID of the currently active release phase
    attr_accessor :active_phase_id

    attr_accessor :active_phase_status
    ...
    def self.attribute_map
      {
        ...
        :'_completed_at' => :'_completedAt',
        :'flag_key' => :'flagKey',
        :'active_phase_id' => :'activePhaseId',
        :'active_phase_status' => :'activePhaseStatus',
        :'_links' => :'_links'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ReleaseProgression` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ReleaseProgression`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_completed_at')
        self._completed_at = attributes[:'_completed_at']
      end
      ...
      if attributes.key?(:'active_phase_id')
        self.active_phase_id = attributes[:'active_phase_id']
      end

      if attributes.key?(:'active_phase_status')
        self.active_phase_status = attributes[:'active_phase_status']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _completed_at == o._completed_at &&
          flag_key == o.flag_key &&
          active_phase_id == o.active_phase_id &&
          active_phase_status == o.active_phase_status &&
          _links == o._links
    end
    ...
    def hash
      [_created_at, _completed_at, flag_key, active_phase_id, active_phase_status, _links].hash
    end
