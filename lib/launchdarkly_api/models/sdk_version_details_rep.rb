...
module LaunchDarklyApi
  class SdkVersionDetailsRep < ApiModelBase
    attr_accessor :name
    ...
    attr_accessor :ld_latest_version
    ...
    attr_accessor :eol_status

    attr_accessor :latest_release_url

    attr_accessor :connection_type

    attr_accessor :relay_version
    ...
    attr_accessor :relay_eol_status

    attr_accessor :relay_latest_version

    attr_accessor :relay_latest_release_url
    ...
    def self.attribute_map
      {
        ...
        :'ld_latest_version' => :'ldLatestVersion',
        :'eol_status' => :'eolStatus',
        :'latest_release_url' => :'latestReleaseUrl',
        :'connection_type' => :'connectionType',
        :'relay_version' => :'relayVersion',
        :'relay_eol_status' => :'relayEolStatus',
        :'relay_latest_version' => :'relayLatestVersion',
        :'relay_latest_release_url' => :'relayLatestReleaseUrl'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'ld_latest_version' => :'String',
        :'eol_status' => :'String',
        :'latest_release_url' => :'String',
        :'connection_type' => :'String',
        :'relay_version' => :'String',
        :'relay_eol_status' => :'String',
        :'relay_latest_version' => :'String',
        :'relay_latest_release_url' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::SdkVersionDetailsRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::SdkVersionDetailsRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ld_latest_version')
        self.ld_latest_version = attributes[:'ld_latest_version']
      end

      if attributes.key?(:'eol_status')
        self.eol_status = attributes[:'eol_status']
      end

      if attributes.key?(:'latest_release_url')
        self.latest_release_url = attributes[:'latest_release_url']
      end
      ...
      if attributes.key?(:'relay_version')
        self.relay_version = attributes[:'relay_version']
      end

      if attributes.key?(:'relay_eol_status')
        self.relay_eol_status = attributes[:'relay_eol_status']
      end

      if attributes.key?(:'relay_latest_version')
        self.relay_latest_version = attributes[:'relay_latest_version']
      end

      if attributes.key?(:'relay_latest_release_url')
        self.relay_latest_release_url = attributes[:'relay_latest_release_url']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ld_latest_version == o.ld_latest_version &&
          eol_status == o.eol_status &&
          latest_release_url == o.latest_release_url &&
          connection_type == o.connection_type &&
          relay_version == o.relay_version &&
          relay_eol_status == o.relay_eol_status &&
          relay_latest_version == o.relay_latest_version &&
          relay_latest_release_url == o.relay_latest_release_url
    end
    ...
    def hash
      [name, version, type, project_id, project_key, project_name, environment_id, environment_key, environment_name, application_id, ld_latest_version, eol_status, latest_release_url, connection_type, relay_version, relay_eol_status, relay_latest_version, relay_latest_release_url].hash
    end
