...
module LaunchDarklyApi
  class MetricRep
    ...
    def hash
      [experiment_count, _id, key, name, kind, _attached_flag_count, _links, _site, _access, tags, _creation_date, last_modified, maintainer_id, _maintainer, description, is_numeric, success_criteria, unit, event_key, randomization_units, experiments, is_active, _attached_features, _version, selector, urls].hash
    end
