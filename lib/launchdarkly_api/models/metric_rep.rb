...
module LaunchDarklyApi
  class MetricRep < ApiModelBase
    ...
    attr_accessor :window_start_offset
    ...
    attr_accessor :window_end_offset
    ...
    attr_accessor :winsor_lower_percentile
    ...
    attr_accessor :winsor_upper_percentile

    # Deprecated and ignored. Use winsorIncludeImputed instead.
    attr_accessor :winsor_exclude_imputed
    ...
    attr_accessor :winsor_include_imputed
    ...
    attr_accessor :trace_value_location
    ...
    attr_accessor :metric_groups

    attr_accessor :last_used_in_experiment

    attr_accessor :last_used_in_guarded_rollout
    ...
    def self.attribute_map
      {
        ...
        :'selector' => :'selector',
        :'urls' => :'urls',
        :'window_start_offset' => :'windowStartOffset',
        :'window_end_offset' => :'windowEndOffset',
        :'winsor_lower_percentile' => :'winsorLowerPercentile',
        :'winsor_upper_percentile' => :'winsorUpperPercentile',
        :'winsor_exclude_imputed' => :'winsorExcludeImputed',
        :'winsor_include_imputed' => :'winsorIncludeImputed',
        :'trace_query' => :'traceQuery',
        :'trace_value_location' => :'traceValueLocation',
    ...
    def self.openapi_types
      {
        ...
        :'selector' => :'String',
        :'urls' => :'Array<Hash>',
        :'window_start_offset' => :'Integer',
        :'window_end_offset' => :'Integer',
        :'winsor_lower_percentile' => :'Float',
        :'winsor_upper_percentile' => :'Float',
        :'winsor_exclude_imputed' => :'Boolean',
        :'winsor_include_imputed' => :'Boolean',
        :'trace_query' => :'String',
        :'trace_value_location' => :'String',
        :'denominator' => :'MetricDenominatorRep',
        :'experiments' => :'Array<DependentExperimentRep>',
        :'metric_groups' => :'Array<DependentMetricGroupRep>',
        :'last_used_in_experiment' => :'DependentExperimentRep',
        :'last_used_in_guarded_rollout' => :'DependentMeasuredRolloutRep',
        :'is_active' => :'Boolean',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::MetricRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'metric_group_count')
        self.metric_group_count = attributes[:'metric_group_count']
      end
      ...
      if attributes.key?(:'randomization_units')
        if (value = attributes[:'randomization_units']).is_a?(Array)
          self.randomization_units = value
        end
      end

      if attributes.key?(:'analysis_units')
        if (value = attributes[:'analysis_units']).is_a?(Array)
          self.analysis_units = value
        end
      end
      ...
      if attributes.key?(:'window_start_offset')
        self.window_start_offset = attributes[:'window_start_offset']
      end

      if attributes.key?(:'window_end_offset')
        self.window_end_offset = attributes[:'window_end_offset']
      end

      if attributes.key?(:'winsor_lower_percentile')
        self.winsor_lower_percentile = attributes[:'winsor_lower_percentile']
      end

      if attributes.key?(:'winsor_upper_percentile')
        self.winsor_upper_percentile = attributes[:'winsor_upper_percentile']
      end

      if attributes.key?(:'winsor_exclude_imputed')
        self.winsor_exclude_imputed = attributes[:'winsor_exclude_imputed']
      end

      if attributes.key?(:'winsor_include_imputed')
        self.winsor_include_imputed = attributes[:'winsor_include_imputed']
      end

      if attributes.key?(:'trace_query')
        self.trace_query = attributes[:'trace_query']
      end

      if attributes.key?(:'trace_value_location')
        self.trace_value_location = attributes[:'trace_value_location']
      end
      ...
      if attributes.key?(:'metric_groups')
        if (value = attributes[:'metric_groups']).is_a?(Array)
          self.metric_groups = value
        end
      end

      if attributes.key?(:'last_used_in_experiment')
        self.last_used_in_experiment = attributes[:'last_used_in_experiment']
      end

      if attributes.key?(:'last_used_in_guarded_rollout')
        self.last_used_in_guarded_rollout = attributes[:'last_used_in_guarded_rollout']
      end
    ...
    def valid?
      ...
      kind_validator = EnumAttributeValidator.new('String', ["pageview", "click", "custom", "trace"])
      ...
      unit_aggregation_type_validator = EnumAttributeValidator.new('String', ["average", "sum", "count_distinct"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] _version_id Value to be assigned
    def _version_id=(_version_id)
      if _version_id.nil?
        fail ArgumentError, '_version_id cannot be nil'
      end
    ...
    def kind=(kind)
      validator = EnumAttributeValidator.new('String', ["pageview", "click", "custom", "trace"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] _creation_date Value to be assigned
    def _creation_date=(_creation_date)
      if _creation_date.nil?
        fail ArgumentError, '_creation_date cannot be nil'
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] unit_aggregation_type Object to be assigned
    def unit_aggregation_type=(unit_aggregation_type)
      validator = EnumAttributeValidator.new('String', ["average", "sum", "count_distinct"])
      unless validator.valid?(unit_aggregation_type)
        fail ArgumentError, "invalid value for \"unit_aggregation_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def analysis_type=(analysis_type)
      validator = EnumAttributeValidator.new('String', ["mean", "percentile"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          analysis_units == o.analysis_units &&
          filters == o.filters &&
          ...
          selector == o.selector &&
          urls == o.urls &&
          window_start_offset == o.window_start_offset &&
          window_end_offset == o.window_end_offset &&
          winsor_lower_percentile == o.winsor_lower_percentile &&
          winsor_upper_percentile == o.winsor_upper_percentile &&
          winsor_exclude_imputed == o.winsor_exclude_imputed &&
          winsor_include_imputed == o.winsor_include_imputed &&
          trace_query == o.trace_query &&
          trace_value_location == o.trace_value_location &&
          denominator == o.denominator &&
          experiments == o.experiments &&
          metric_groups == o.metric_groups &&
          last_used_in_experiment == o.last_used_in_experiment &&
          last_used_in_guarded_rollout == o.last_used_in_guarded_rollout &&
    ...
    def hash
      [experiment_count, metric_group_count, active_experiment_count, active_guarded_rollout_count, _id, _version_id, _version, key, name, kind, _attached_flag_count, _links, _site, _access, tags, _creation_date, last_modified, maintainer_id, _maintainer, description, category, is_numeric, success_criteria, unit, event_key, randomization_units, analysis_units, filters, unit_aggregation_type, analysis_type, percentile_value, event_default, data_source, last_seen, archived, archived_at, selector, urls, window_start_offset, window_end_offset, winsor_lower_percentile, winsor_upper_percentile, winsor_exclude_imputed, winsor_include_imputed, trace_query, trace_value_location, denominator, experiments, metric_groups, last_used_in_experiment, last_used_in_guarded_rollout, is_active, _attached_features].hash
    end
