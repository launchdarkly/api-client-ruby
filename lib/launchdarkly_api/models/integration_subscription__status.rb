...
module LaunchDarklyApi
  class IntegrationSubscriptionStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'successCount')
        self.success_count = attributes[:'successCount']
      end

      if attributes.has_key?(:'lastSuccess')
        self.last_success = attributes[:'lastSuccess']
      end
    ...
    def hash
      [success_count, last_success, error_count].hash
    end
