...
module LaunchDarklyApi
  class MetricListingRep
    ...
    def hash
      [experiment_count, _id, key, name, kind, _attached_flag_count, _links, _site, _access, tags, _creation_date, last_modified, maintainer_id, _maintainer, description, is_numeric, success_criteria, unit, event_key, randomization_units, unit_aggregation_type, analysis_type, percentile_value, event_default].hash
    end
