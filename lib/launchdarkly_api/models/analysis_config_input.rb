...
module LaunchDarklyApi
  class AnalysisConfigInput < ApiModelBase
    ...
    attr_accessor :bayesian_threshold
    ...
    attr_accessor :test_direction

    # The method to use for multiple comparison correction.
    attr_accessor :multiple_comparison_correction_method

    # The scope of the multiple comparison correction.
    attr_accessor :multiple_comparison_correction_scope

    # Whether sequential testing is enabled for Frequentist analysis
    attr_accessor :sequential_testing_enabled
    ...
    def self.attribute_map
      {
        :'bayesian_threshold' => :'bayesianThreshold',
        :'significance_threshold' => :'significanceThreshold',
        :'test_direction' => :'testDirection',
        :'multiple_comparison_correction_method' => :'multipleComparisonCorrectionMethod',
        :'multiple_comparison_correction_scope' => :'multipleComparisonCorrectionScope',
    ...
    def self.openapi_types
      {
        :'bayesian_threshold' => :'String',
        :'significance_threshold' => :'String',
        :'test_direction' => :'String',
        :'multiple_comparison_correction_method' => :'String',
        :'multiple_comparison_correction_scope' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AnalysisConfigInput` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AnalysisConfigInput`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'bayesian_threshold')
        self.bayesian_threshold = attributes[:'bayesian_threshold']
      end
      ...
      if attributes.key?(:'test_direction')
        self.test_direction = attributes[:'test_direction']
      end

      if attributes.key?(:'multiple_comparison_correction_method')
        self.multiple_comparison_correction_method = attributes[:'multiple_comparison_correction_method']
      end

      if attributes.key?(:'multiple_comparison_correction_scope')
        self.multiple_comparison_correction_scope = attributes[:'multiple_comparison_correction_scope']
      end

      if attributes.key?(:'sequential_testing_enabled')
        self.sequential_testing_enabled = attributes[:'sequential_testing_enabled']
      end
    end
    ...
    def valid?
      ...
      multiple_comparison_correction_method_validator = EnumAttributeValidator.new('String', ["bonferroni", "benjamini-hochberg"])
      return false unless multiple_comparison_correction_method_validator.valid?(@multiple_comparison_correction_method)
      multiple_comparison_correction_scope_validator = EnumAttributeValidator.new('String', ["variations", "variations-and-metrics", "metrics"])
      return false unless multiple_comparison_correction_scope_validator.valid?(@multiple_comparison_correction_scope)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] multiple_comparison_correction_method Object to be assigned
    def multiple_comparison_correction_method=(multiple_comparison_correction_method)
      validator = EnumAttributeValidator.new('String', ["bonferroni", "benjamini-hochberg"])
      unless validator.valid?(multiple_comparison_correction_method)
        fail ArgumentError, "invalid value for \"multiple_comparison_correction_method\", must be one of #{validator.allowable_values}."
      end
      @multiple_comparison_correction_method = multiple_comparison_correction_method
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] multiple_comparison_correction_scope Object to be assigned
    def multiple_comparison_correction_scope=(multiple_comparison_correction_scope)
      validator = EnumAttributeValidator.new('String', ["variations", "variations-and-metrics", "metrics"])
      unless validator.valid?(multiple_comparison_correction_scope)
        fail ArgumentError, "invalid value for \"multiple_comparison_correction_scope\", must be one of #{validator.allowable_values}."
      end
      @multiple_comparison_correction_scope = multiple_comparison_correction_scope
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          bayesian_threshold == o.bayesian_threshold &&
          significance_threshold == o.significance_threshold &&
          test_direction == o.test_direction &&
          multiple_comparison_correction_method == o.multiple_comparison_correction_method &&
          multiple_comparison_correction_scope == o.multiple_comparison_correction_scope &&
          sequential_testing_enabled == o.sequential_testing_enabled
    end
    ...
    def hash
      [bayesian_threshold, significance_threshold, test_direction, multiple_comparison_correction_method, multiple_comparison_correction_scope, sequential_testing_enabled].hash
    end
