...
module LaunchDarklyApi
  class AgentOptimizationResult < ApiModelBase
    ...
    attr_accessor :agent_optimization_id

    attr_accessor :agent_optimization_version
    ...
    attr_accessor :generation_tokens

    attr_accessor :evaluation_tokens

    attr_accessor :generation_latency

    attr_accessor :evaluation_latencies

    attr_accessor :completed_at

    attr_accessor :created_variation_key
    ...
    def self.attribute_map
      {
        ...
        :'id' => :'id',
        :'run_id' => :'runId',
        :'agent_optimization_id' => :'agentOptimizationId',
        :'agent_optimization_version' => :'agentOptimizationVersion',
        :'status' => :'status',
        :'activity' => :'activity',
        :'iteration' => :'iteration',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AgentOptimizationResult` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AgentOptimizationResult`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'agent_optimization_id')
        self.agent_optimization_id = attributes[:'agent_optimization_id']
      else
        self.agent_optimization_id = nil
      end

      if attributes.key?(:'agent_optimization_version')
        self.agent_optimization_version = attributes[:'agent_optimization_version']
      else
        self.agent_optimization_version = nil
      end
      ...
      if attributes.key?(:'user_input')
        self.user_input = attributes[:'user_input']
      else
        self.user_input = nil
      end
    ...
    def list_invalid_properties
      ...
      if @agent_optimization_id.nil?
        invalid_properties.push('invalid value for "agent_optimization_id", agent_optimization_id cannot be nil.')
      end

      if @agent_optimization_version.nil?
        invalid_properties.push('invalid value for "agent_optimization_version", agent_optimization_version cannot be nil.')
      end
      ...
      if @user_input.nil?
        invalid_properties.push('invalid value for "user_input", user_input cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @agent_optimization_id.nil?
      return false if @agent_optimization_version.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] agent_optimization_id Value to be assigned
    def agent_optimization_id=(agent_optimization_id)
      if agent_optimization_id.nil?
        fail ArgumentError, 'agent_optimization_id cannot be nil'
      end

      @agent_optimization_id = agent_optimization_id
    end

    # Custom attribute writer method with validation
    # @param [Object] agent_optimization_version Value to be assigned
    def agent_optimization_version=(agent_optimization_version)
      if agent_optimization_version.nil?
        fail ArgumentError, 'agent_optimization_version cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] activity Value to be assigned
    def activity=(activity)
      if activity.nil?
        fail ArgumentError, 'activity cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] iteration Value to be assigned
    def iteration=(iteration)
      if iteration.nil?
        fail ArgumentError, 'iteration cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] user_input Value to be assigned
    def user_input=(user_input)
      if user_input.nil?
        fail ArgumentError, 'user_input cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          run_id == o.run_id &&
          agent_optimization_id == o.agent_optimization_id &&
          agent_optimization_version == o.agent_optimization_version &&
          status == o.status &&
          activity == o.activity &&
    ...
    def hash
      [_access, _links, id, run_id, agent_optimization_id, agent_optimization_version, status, activity, iteration, instructions, parameters, user_input, completion_response, variation, scores, generation_tokens, evaluation_tokens, generation_latency, evaluation_latencies, completed_at, created_variation_key, created_at, updated_at].hash
    end
