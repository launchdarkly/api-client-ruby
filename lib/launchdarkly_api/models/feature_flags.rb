...
module LaunchDarklyApi
  class FeatureFlags < ApiModelBase
    ...
    attr_accessor :total_count_with_differences
    ...
    def self.attribute_map
      {
        ...
        :'total_count_with_differences' => :'totalCountWithDifferences'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'total_count' => :'Integer',
        :'total_count_with_differences' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::FeatureFlags` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::FeatureFlags`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_count_with_differences')
        self.total_count_with_differences = attributes[:'total_count_with_differences']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_count_with_differences == o.total_count_with_differences
    end
    ...
    def hash
      [items, _links, total_count, total_count_with_differences].hash
    end
