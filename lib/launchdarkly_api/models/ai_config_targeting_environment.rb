...
module LaunchDarklyApi
  class AIConfigTargetingEnvironment < ApiModelBase
    ...
    attr_accessor :track_events_fallthrough

    attr_accessor :_environment_name
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AIConfigTargetingEnvironment`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] fallthrough Value to be assigned
    def fallthrough=(fallthrough)
      if fallthrough.nil?
        fail ArgumentError, 'fallthrough cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] track_events Value to be assigned
    def track_events=(track_events)
      if track_events.nil?
        fail ArgumentError, 'track_events cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] track_events_fallthrough Value to be assigned
    def track_events_fallthrough=(track_events_fallthrough)
      if track_events_fallthrough.nil?
        fail ArgumentError, 'track_events_fallthrough cannot be nil'
      end

      @track_events_fallthrough = track_events_fallthrough
    end

    # Custom attribute writer method with validation
    # @param [Object] _environment_name Value to be assigned
    def _environment_name=(_environment_name)
      if _environment_name.nil?
        fail ArgumentError, '_environment_name cannot be nil'
      end
