...
module LaunchDarklyApi
  class BooleanFlagDefaults < ApiModelBase
    ...
    def self.attribute_map
      {
        :'true_display_name' => :'trueDisplayName',
        :'false_display_name' => :'falseDisplayName',
        :'true_description' => :'trueDescription',
        :'false_description' => :'falseDescription',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::BooleanFlagDefaults` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::BooleanFlagDefaults`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'true_display_name')
        self.true_display_name = attributes[:'true_display_name']
      else
        self.true_display_name = nil
      end

      if attributes.key?(:'false_display_name')
        self.false_display_name = attributes[:'false_display_name']
      else
        self.false_display_name = nil
      end

      if attributes.key?(:'true_description')
        self.true_description = attributes[:'true_description']
      else
        self.true_description = nil
      end

      if attributes.key?(:'false_description')
        self.false_description = attributes[:'false_description']
      else
        self.false_description = nil
      end

      if attributes.key?(:'on_variation')
        self.on_variation = attributes[:'on_variation']
      else
        self.on_variation = nil
      end
    ...
    def list_invalid_properties
      ...
      if @true_display_name.nil?
        invalid_properties.push('invalid value for "true_display_name", true_display_name cannot be nil.')
      end

      if @false_display_name.nil?
        invalid_properties.push('invalid value for "false_display_name", false_display_name cannot be nil.')
      end

      if @true_description.nil?
        invalid_properties.push('invalid value for "true_description", true_description cannot be nil.')
      end

      if @false_description.nil?
        invalid_properties.push('invalid value for "false_description", false_description cannot be nil.')
      end

      if @on_variation.nil?
        invalid_properties.push('invalid value for "on_variation", on_variation cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @true_display_name.nil?
      return false if @false_display_name.nil?
      return false if @true_description.nil?
      return false if @false_description.nil?
      return false if @on_variation.nil?
      return false if @off_variation.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] true_display_name Value to be assigned
    def true_display_name=(true_display_name)
      if true_display_name.nil?
        fail ArgumentError, 'true_display_name cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] false_display_name Value to be assigned
    def false_display_name=(false_display_name)
      if false_display_name.nil?
        fail ArgumentError, 'false_display_name cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] true_description Value to be assigned
    def true_description=(true_description)
      if true_description.nil?
        fail ArgumentError, 'true_description cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] false_description Value to be assigned
    def false_description=(false_description)
      if false_description.nil?
        fail ArgumentError, 'false_description cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] on_variation Value to be assigned
    def on_variation=(on_variation)
      if on_variation.nil?
        fail ArgumentError, 'on_variation cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          true_display_name == o.true_display_name &&
          false_display_name == o.false_display_name &&
          true_description == o.true_description &&
          false_description == o.false_description &&
          on_variation == o.on_variation &&
    ...
    def hash
      [true_display_name, false_display_name, true_description, false_description, on_variation, off_variation].hash
    end
