...
module LaunchDarklyApi
  class DenominatorPost < ApiModelBase
    ...
    # For a numeric denominator, the column holding the numeric value. Overrides the value column mapped on the denominator data source.
    ...
    def hash
      [event_name, is_numeric, data_source, unit_aggregation_type, unit_aggregation_field, value_column, filters, window_start_offset, window_end_offset, winsor_lower_percentile, winsor_upper_percentile, winsor_include_imputed].hash
    end
