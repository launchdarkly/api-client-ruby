...
module LaunchDarklyApi
  class BigSegmentStoreStatus < ApiModelBase
    ...
    attr_accessor :potentially_stale
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::BigSegmentStoreStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::BigSegmentStoreStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'potentially_stale')
        self.potentially_stale = attributes[:'potentially_stale']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          potentially_stale == o.potentially_stale &&
    ...
    def hash
      [available, potentially_stale, last_sync, last_error, errors].hash
    end
