...
module LaunchDarklyApi
  class HoldoutDetailRep < ApiModelBase
    attr_accessor :_id
    ...
    attr_accessor :base_experiment

    attr_accessor :related_experiments
    ...
    def self.attribute_map
      {
        ...
        :'holdout_amount' => :'holdoutAmount',
        :'is_dirty' => :'isDirty',
        :'created_at' => :'createdAt',
        :'updated_at' => :'updatedAt',
        :'base_experiment' => :'baseExperiment',
        :'related_experiments' => :'relatedExperiments'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'String',
        :'description' => :'String',
        :'holdout_amount' => :'String',
        :'is_dirty' => :'Boolean',
        :'created_at' => :'Integer',
        :'updated_at' => :'Integer',
        :'base_experiment' => :'Experiment',
        :'related_experiments' => :'Array<Experiment>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::HoldoutDetailRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::HoldoutDetailRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'holdout_amount')
        self.holdout_amount = attributes[:'holdout_amount']
      else
        self.holdout_amount = nil
      end

      if attributes.key?(:'is_dirty')
        self.is_dirty = attributes[:'is_dirty']
      end
      ...
      if attributes.key?(:'base_experiment')
        self.base_experiment = attributes[:'base_experiment']
      else
        self.base_experiment = nil
      end

      if attributes.key?(:'related_experiments')
        if (value = attributes[:'related_experiments']).is_a?(Array)
          self.related_experiments = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @holdout_amount.nil?
        invalid_properties.push('invalid value for "holdout_amount", holdout_amount cannot be nil.')
      end
      ...
      if @base_experiment.nil?
        invalid_properties.push('invalid value for "base_experiment", base_experiment cannot be nil.')
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["created", "enabled", "running", "ended"])
      return false unless status_validator.valid?(@status)
      return false if @holdout_amount.nil?
      return false if @created_at.nil?
      return false if @updated_at.nil?
      return false if @base_experiment.nil?
      true
    end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["created", "enabled", "running", "ended"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] holdout_amount Value to be assigned
    def holdout_amount=(holdout_amount)
      if holdout_amount.nil?
        fail ArgumentError, 'holdout_amount cannot be nil'
      end

      @holdout_amount = holdout_amount
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] base_experiment Value to be assigned
    def base_experiment=(base_experiment)
      if base_experiment.nil?
        fail ArgumentError, 'base_experiment cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          holdout_amount == o.holdout_amount &&
          is_dirty == o.is_dirty &&
          created_at == o.created_at &&
          updated_at == o.updated_at &&
          base_experiment == o.base_experiment &&
    ...
    def hash
      [_id, status, description, holdout_amount, is_dirty, created_at, updated_at, base_experiment, related_experiments].hash
    end
