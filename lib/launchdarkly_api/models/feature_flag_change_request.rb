...
module LaunchDarklyApi
  class FeatureFlagChangeRequest
    ...
    def hash
      [_id, _version, creation_date, requestor_id, review_status, status, applied_by_member_id, applied_date, current_reviews_by_member_id, all_reviews, notify_member_ids, instructions].hash
    end
