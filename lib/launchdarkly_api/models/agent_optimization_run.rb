...
module LaunchDarklyApi
  class AgentOptimizationRun < ApiModelBase
    attr_accessor :run_id

    attr_accessor :optimization_key
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AgentOptimizationRun` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AgentOptimizationRun`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'optimization_key')
        self.optimization_key = attributes[:'optimization_key']
      else
        self.optimization_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @optimization_key.nil?
        invalid_properties.push('invalid value for "optimization_key", optimization_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @optimization_key.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] optimization_key Value to be assigned
    def optimization_key=(optimization_key)
      if optimization_key.nil?
        fail ArgumentError, 'optimization_key cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          run_id == o.run_id &&
          optimization_key == o.optimization_key &&
    ...
    def hash
      [run_id, optimization_key, agent_optimization_id, agent_optimization_version, status, activity, created_at, completed_at].hash
    end
