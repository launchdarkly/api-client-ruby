...
module LaunchDarklyApi
  class ParameterDefault
    ...
    attr_accessor :boolean_variation_value

    attr_accessor :rule_clause

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'value' => :'value',
        :'boolean_variation_value' => :'booleanVariationValue',
    ...
    def self.openapi_types
      {
        :'value' => :'Object',
        :'boolean_variation_value' => :'Boolean',
        :'rule_clause' => :'RuleClause'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ParameterDefault` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ParameterDefault`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'boolean_variation_value')
        self.boolean_variation_value = attributes[:'boolean_variation_value']
      end

      if attributes.key?(:'rule_clause')
        self.rule_clause = attributes[:'rule_clause']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          value == o.value &&
          boolean_variation_value == o.boolean_variation_value &&
          rule_clause == o.rule_clause
    end
    ...
    def hash
      [value, boolean_variation_value, rule_clause].hash
    end
