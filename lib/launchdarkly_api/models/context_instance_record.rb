...
module LaunchDarklyApi
  class ContextInstanceRecord < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'anonymous_kinds' => :'anonymousKinds',
        :'context' => :'context',
        :'_links' => :'_links',
        :'_access' => :'_access'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ContextInstanceRecord` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ContextInstanceRecord`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'anonymous_kinds')
        if (value = attributes[:'anonymous_kinds']).is_a?(Array)
          self.anonymous_kinds = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          anonymous_kinds == o.anonymous_kinds &&
          context == o.context &&
          _links == o._links &&
          _access == o._access
    end
    ...
    def hash
      [last_seen, id, application_id, anonymous_kinds, context, _links, _access].hash
    end
