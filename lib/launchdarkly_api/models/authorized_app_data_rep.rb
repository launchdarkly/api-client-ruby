...
module LaunchDarklyApi
  class AuthorizedAppDataRep < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AuthorizedAppDataRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AuthorizedAppDataRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'maintainer_name')
        self.maintainer_name = attributes[:'maintainer_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_scim == o.is_scim &&
          name == o.name &&
          maintainer_name == o.maintainer_name
    end
    ...
    def hash
      [_links, _id, is_scim, name, maintainer_name].hash
    end
