...
module LaunchDarklyApi
  class InsightGroupCollectionMetadata
    attr_accessor :count_by_indicator

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'count_by_indicator' => :'countByIndicator'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::InsightGroupCollectionMetadata` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::InsightGroupCollectionMetadata`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'count_by_indicator')
        self.count_by_indicator = attributes[:'count_by_indicator']
      else
        self.count_by_indicator = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @count_by_indicator.nil?
        invalid_properties.push('invalid value for "count_by_indicator", count_by_indicator cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @count_by_indicator.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] count_by_indicator Value to be assigned
    def count_by_indicator=(count_by_indicator)
      if count_by_indicator.nil?
        fail ArgumentError, 'count_by_indicator cannot be nil'
      end

      @count_by_indicator = count_by_indicator
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          count_by_indicator == o.count_by_indicator
    end
