...
module LaunchDarklyApi
  class QuickStats < ApiModelBase
    attr_accessor :active_configs

    attr_accessor :active_experiments

    attr_accessor :average_satisfaction7_d

    attr_accessor :spend_month_to_date
    ...
    def self.attribute_map
      {
        ...
        :'average_satisfaction7_d' => :'averageSatisfaction7D',
        :'spend_month_to_date' => :'spendMonthToDate'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::QuickStats` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::QuickStats`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'active_configs')
        self.active_configs = attributes[:'active_configs']
      else
        self.active_configs = nil
      end

      if attributes.key?(:'active_experiments')
        self.active_experiments = attributes[:'active_experiments']
      else
        self.active_experiments = nil
      end

      if attributes.key?(:'average_satisfaction7_d')
        self.average_satisfaction7_d = attributes[:'average_satisfaction7_d']
      end

      if attributes.key?(:'spend_month_to_date')
        self.spend_month_to_date = attributes[:'spend_month_to_date']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @active_configs.nil?
        invalid_properties.push('invalid value for "active_configs", active_configs cannot be nil.')
      end

      if @active_experiments.nil?
        invalid_properties.push('invalid value for "active_experiments", active_experiments cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @active_configs.nil?
      return false if @active_experiments.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] active_configs Value to be assigned
    def active_configs=(active_configs)
      if active_configs.nil?
        fail ArgumentError, 'active_configs cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] active_experiments Value to be assigned
    def active_experiments=(active_experiments)
      if active_experiments.nil?
        fail ArgumentError, 'active_experiments cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          active_configs == o.active_configs &&
          active_experiments == o.active_experiments &&
          average_satisfaction7_d == o.average_satisfaction7_d &&
          spend_month_to_date == o.spend_month_to_date
    end
    ...
    def hash
      [active_configs, active_experiments, average_satisfaction7_d, spend_month_to_date].hash
    end
