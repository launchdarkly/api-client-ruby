...
module LaunchDarklyApi
  class HMACSignature
    ...
    attr_accessor :hmac_secret_form_variable_key

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'header_name' => :'headerName',
        :'hmac_secret_form_variable_key' => :'hmacSecretFormVariableKey'
      }
    end
    ...
    def self.openapi_types
      {
        :'header_name' => :'String',
        :'hmac_secret_form_variable_key' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::HMACSignature` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::HMACSignature`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hmac_secret_form_variable_key')
        self.hmac_secret_form_variable_key = attributes[:'hmac_secret_form_variable_key']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          hmac_secret_form_variable_key == o.hmac_secret_form_variable_key
    end
    ...
    def hash
      [header_name, hmac_secret_form_variable_key].hash
    end
