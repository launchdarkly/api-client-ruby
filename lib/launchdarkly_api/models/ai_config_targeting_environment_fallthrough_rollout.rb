...
module LaunchDarklyApi
  class AIConfigTargetingEnvironmentFallthroughRollout < ApiModelBase
    attr_accessor :bucket_by

    attr_accessor :context_kind

    attr_accessor :experiment_allocation
    ...
    def self.attribute_map
      {
        ...
        :'experiment_allocation' => :'experimentAllocation',
        :'seed' => :'seed',
    ...
    def self.openapi_types
      {
        :'bucket_by' => :'String',
        :'context_kind' => :'String',
        :'experiment_allocation' => :'AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation',
        :'seed' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AIConfigTargetingEnvironmentFallthroughRollout` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AIConfigTargetingEnvironmentFallthroughRollout`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'experiment_allocation')
        self.experiment_allocation = attributes[:'experiment_allocation']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          experiment_allocation == o.experiment_allocation &&
          seed == o.seed &&
    ...
    def hash
      [bucket_by, context_kind, experiment_allocation, seed, variations].hash
    end
