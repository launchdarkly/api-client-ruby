...
module LaunchDarklyApi
  class ExpiringTargetError < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ExpiringTargetError` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ExpiringTargetError`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'instruction_index')
        self.instruction_index = attributes[:'instruction_index']
      else
        self.instruction_index = nil
      end
    ...
    def list_invalid_properties
      ...
      if @instruction_index.nil?
        invalid_properties.push('invalid value for "instruction_index", instruction_index cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @instruction_index.nil?
      return false if @message.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] instruction_index Value to be assigned
    def instruction_index=(instruction_index)
      if instruction_index.nil?
        fail ArgumentError, 'instruction_index cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          instruction_index == o.instruction_index &&
          message == o.message
    end
    ...
    def hash
      [instruction_index, message].hash
    end
