...
module LaunchDarklyApi
  class RelativeDifferenceRep
    ...
    attr_accessor :from_treatment_id
    ...
    def self.attribute_map
      {
        :'upper' => :'upper',
        :'lower' => :'lower',
        :'from_treatment_id' => :'fromTreatmentId',
        :'variance' => :'variance',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::RelativeDifferenceRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::RelativeDifferenceRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'from_treatment_id')
        self.from_treatment_id = attributes[:'from_treatment_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          upper == o.upper &&
          lower == o.lower &&
          from_treatment_id == o.from_treatment_id &&
          variance == o.variance &&
    ...
    def hash
      [upper, lower, from_treatment_id, variance, variance_reduction].hash
    end
