...
module LaunchDarklyApi
  class ApprovalRequestResponse
    ...
    def hash
      [_id, _version, creation_date, service_kind, requestor_id, description, review_status, all_reviews, notify_member_ids, applied_date, applied_by_member_id, status, instructions, conflicts, _links, execution_date, operating_on_id, integration_metadata, source, custom_workflow_metadata, resource_id, approval_settings].hash
    end
