...
module LaunchDarklyApi
  class AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation < ApiModelBase
    attr_accessor :can_reshuffle
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'can_reshuffle')
        self.can_reshuffle = attributes[:'can_reshuffle']
      else
        self.can_reshuffle = nil
      end

      if attributes.key?(:'default_variation')
        self.default_variation = attributes[:'default_variation']
      else
        self.default_variation = nil
      end
    ...
    def list_invalid_properties
      ...
      if @can_reshuffle.nil?
        invalid_properties.push('invalid value for "can_reshuffle", can_reshuffle cannot be nil.')
      end

      if @default_variation.nil?
        invalid_properties.push('invalid value for "default_variation", default_variation cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @can_reshuffle.nil?
      return false if @default_variation.nil?
      return false if @type.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] can_reshuffle Value to be assigned
    def can_reshuffle=(can_reshuffle)
      if can_reshuffle.nil?
        fail ArgumentError, 'can_reshuffle cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] default_variation Value to be assigned
    def default_variation=(default_variation)
      if default_variation.nil?
        fail ArgumentError, 'default_variation cannot be nil'
      end
    ...
    def hash
      [can_reshuffle, default_variation, type].hash
    end
