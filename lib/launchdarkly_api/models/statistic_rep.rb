...
module LaunchDarklyApi
  class StatisticRep < ApiModelBase
    # The repository name
    attr_accessor :name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::StatisticRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::StatisticRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hunk_count')
        self.hunk_count = attributes[:'hunk_count']
      else
        self.hunk_count = nil
      end
      ...
      if attributes.key?(:'latest_commit_time')
        self.latest_commit_time = attributes[:'latest_commit_time']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @source_link.nil?
        invalid_properties.push('invalid value for "source_link", source_link cannot be nil.')
      end
      ...
      if @hunk_count.nil?
        invalid_properties.push('invalid value for "hunk_count", hunk_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @source_link.nil?
      return false if @default_branch.nil?
      return false if @enabled.nil?
      return false if @version.nil?
      return false if @hunk_count.nil?
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["bitbucket", "custom", "github", "gitlab"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] source_link Value to be assigned
    def source_link=(source_link)
      if source_link.nil?
        fail ArgumentError, 'source_link cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] hunk_count Value to be assigned
    def hunk_count=(hunk_count)
      if hunk_count.nil?
        fail ArgumentError, 'hunk_count cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled == o.enabled &&
          version == o.version &&
          hunk_count == o.hunk_count &&
          file_count == o.file_count &&
          _links == o._links &&
          latest_commit_time == o.latest_commit_time
    end
    ...
    def hash
      [name, type, source_link, default_branch, enabled, version, hunk_count, file_count, _links, latest_commit_time].hash
    end
