...
module LaunchDarklyApi
  class SegmentsSummary
    ...
    def self.openapi_types
      {
        :'count' => :'Integer',
        :'linked_segments' => :'ExpandedDirectlyLinkedSegments'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::SegmentsSummary` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::SegmentsSummary`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'linked_segments')
        self.linked_segments = attributes[:'linked_segments']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          count == o.count &&
          linked_segments == o.linked_segments
    end
