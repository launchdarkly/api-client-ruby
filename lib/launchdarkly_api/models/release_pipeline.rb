...
module LaunchDarklyApi
  class ReleasePipeline < ApiModelBase
    ...
    attr_accessor :is_project_default

    # Whether this release pipeline is a legacy pipeline
    attr_accessor :_is_legacy
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ReleasePipeline` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ReleasePipeline`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_project_default')
        self.is_project_default = attributes[:'is_project_default']
      end

      if attributes.key?(:'_is_legacy')
        self._is_legacy = attributes[:'_is_legacy']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _version == o._version &&
          _access == o._access &&
          is_project_default == o.is_project_default &&
          _is_legacy == o._is_legacy
    end
    ...
    def hash
      [created_at, description, key, name, phases, tags, _version, _access, is_project_default, _is_legacy].hash
    end
