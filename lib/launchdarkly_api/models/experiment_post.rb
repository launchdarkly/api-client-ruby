...
module LaunchDarklyApi
  class ExperimentPost < ApiModelBase
    # The experiment name
    attr_accessor :name
    ...
    def self.openapi_types
      {
        ...
        :'tags' => :'Array<String>',
        :'methodology' => :'String',
        :'analysis_config' => :'AnalysisConfigInput',
        :'data_source' => :'String',
        :'type' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ExperimentPost` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ExperimentPost`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["experiment", "mab", "holdout"])
    ...
    # @param [Object] methodology Object to be assigned
    def methodology=(methodology)
      validator = EnumAttributeValidator.new('String', ["bayesian", "frequentist", "export_only"])
      unless validator.valid?(methodology)
        fail ArgumentError, "invalid value for \"methodology\", must be one of #{validator.allowable_values}."
      end
      @methodology = methodology
    end
    ...
    def data_source=(data_source)
      validator = EnumAttributeValidator.new('String', ["launchdarkly", "snowflake"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["experiment", "mab", "holdout"])
    ...
    def hash
      [name, description, maintainer_id, key, iteration, holdout_id, tags, methodology, analysis_config, data_source, type].hash
    end
