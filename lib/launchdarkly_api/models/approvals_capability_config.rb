...
module LaunchDarklyApi
  class ApprovalsCapabilityConfig
    ...
    attr_accessor :additional_form_variables

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'additional_form_variables' => :'additionalFormVariables'
      }
    end
    ...
    def self.openapi_types
      {
        :'additional_form_variables' => :'Array<FormVariable>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ApprovalsCapabilityConfig` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ApprovalsCapabilityConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'additional_form_variables')
        if (value = attributes[:'additional_form_variables']).is_a?(Array)
          self.additional_form_variables = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          additional_form_variables == o.additional_form_variables
    end
    ...
    def hash
      [additional_form_variables].hash
    end
