...
module LaunchDarklyApi
  class ExperimentTotalsRep
    attr_accessor :cumulative_value

    attr_accessor :cumulative_count

    attr_accessor :cumulative_impression_count

    attr_accessor :cumulative_conversion_rate

    attr_accessor :cumulative_confidence_interval
    ...
    def self.attribute_map
      {
        ...
        :'cumulative_impression_count' => :'cumulativeImpressionCount',
        :'cumulative_conversion_rate' => :'cumulativeConversionRate',
        :'cumulative_confidence_interval' => :'cumulativeConfidenceInterval',
        :'p_value' => :'pValue',
    ...
    def self.openapi_types
      {
        ...
        :'cumulative_impression_count' => :'Integer',
        :'cumulative_conversion_rate' => :'Float',
        :'cumulative_confidence_interval' => :'ConfidenceIntervalRep',
        :'p_value' => :'Float',
        :'improvement' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ExperimentTotalsRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ExperimentTotalsRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'cumulative_value')
        self.cumulative_value = attributes[:'cumulative_value']
      end

      if attributes.key?(:'cumulative_count')
        self.cumulative_count = attributes[:'cumulative_count']
      end

      if attributes.key?(:'cumulative_impression_count')
        self.cumulative_impression_count = attributes[:'cumulative_impression_count']
      end

      if attributes.key?(:'cumulative_conversion_rate')
        self.cumulative_conversion_rate = attributes[:'cumulative_conversion_rate']
      end

      if attributes.key?(:'cumulative_confidence_interval')
        self.cumulative_confidence_interval = attributes[:'cumulative_confidence_interval']
      end
      ...
      if attributes.key?(:'improvement')
        self.improvement = attributes[:'improvement']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cumulative_value == o.cumulative_value &&
          cumulative_count == o.cumulative_count &&
          cumulative_impression_count == o.cumulative_impression_count &&
          cumulative_conversion_rate == o.cumulative_conversion_rate &&
          cumulative_confidence_interval == o.cumulative_confidence_interval &&
          p_value == o.p_value &&
    ...
    def hash
      [cumulative_value, cumulative_count, cumulative_impression_count, cumulative_conversion_rate, cumulative_confidence_interval, p_value, improvement, min_sample_size].hash
    end
