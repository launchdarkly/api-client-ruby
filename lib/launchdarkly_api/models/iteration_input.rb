...
module LaunchDarklyApi
  class IterationInput < ApiModelBase
    ...
    attr_accessor :primary_single_metric_key
    ...
    attr_accessor :primary_funnel_key
    ...
    attr_accessor :reallocation_frequency_millis

    # The ID of the covariate CSV
    attr_accessor :covariate_id
    ...
    def self.attribute_map
      {
        ...
        :'metrics' => :'metrics',
        :'primary_single_metric_key' => :'primarySingleMetricKey',
        :'primary_funnel_key' => :'primaryFunnelKey',
    ...
    def self.openapi_types
      {
        ...
        :'primary_single_metric_key' => :'String',
        :'primary_funnel_key' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::IterationInput` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::IterationInput`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'primary_single_metric_key')
        self.primary_single_metric_key = attributes[:'primary_single_metric_key']
      end

      if attributes.key?(:'primary_funnel_key')
        self.primary_funnel_key = attributes[:'primary_funnel_key']
      end
      ...
      if attributes.key?(:'covariate_id')
        self.covariate_id = attributes[:'covariate_id']
      end
    ...
    def list_invalid_properties
      ...
      if @treatments.nil?
        invalid_properties.push('invalid value for "treatments", treatments cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @treatments.nil?
    ...
    def hypothesis=(hypothesis)
      if hypothesis.nil?
        fail ArgumentError, 'hypothesis cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] treatments Value to be assigned
    def treatments=(treatments)
      if treatments.nil?
        fail ArgumentError, 'treatments cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          metrics == o.metrics &&
          primary_single_metric_key == o.primary_single_metric_key &&
          primary_funnel_key == o.primary_funnel_key &&
    ...
    def hash
      [hypothesis, can_reshuffle_traffic, metrics, primary_single_metric_key, primary_funnel_key, treatments, flags, randomization_unit, reallocation_frequency_millis, covariate_id, attributes].hash
    end
