...
module LaunchDarklyApi
  class LayerReservationRep < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::LayerReservationRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::LayerReservationRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'experiment_key')
        self.experiment_key = attributes[:'experiment_key']
      else
        self.experiment_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @experiment_key.nil?
        invalid_properties.push('invalid value for "experiment_key", experiment_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @experiment_key.nil?
    ...
    # @param [Object] experiment_key Value to be assigned
    def experiment_key=(experiment_key)
      if experiment_key.nil?
        fail ArgumentError, 'experiment_key cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          experiment_key == o.experiment_key &&
          flag_key == o.flag_key &&
    ...
    def hash
      [experiment_key, flag_key, reservation_percent].hash
    end
