...
module LaunchDarklyApi
  class DependentMeasuredRolloutRep < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::DependentMeasuredRolloutRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::DependentMeasuredRolloutRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'flag_purpose')
        self.flag_purpose = attributes[:'flag_purpose']
      end
    ...
    def list_invalid_properties
      ...
      if @flag_name.nil?
        invalid_properties.push('invalid value for "flag_name", flag_name cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] flag_name Value to be assigned
    def flag_name=(flag_name)
      if flag_name.nil?
        fail ArgumentError, 'flag_name cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] environment_name Value to be assigned
    def environment_name=(environment_name)
      if environment_name.nil?
        fail ArgumentError, 'environment_name cannot be nil'
      end
    ...
    def hash
      [_id, flag_key, flag_name, flag_purpose, environment_key, environment_name, status, creation_date, _links].hash
    end
