...
module LaunchDarklyApi
  class IntegrationConfigurationPost < ApiModelBase
    ...
    # Custom attribute writer method with validation
    # @param [Object] config_values Value to be assigned
    def config_values=(config_values)
      if config_values.nil?
        fail ArgumentError, 'config_values cannot be nil'
      end
