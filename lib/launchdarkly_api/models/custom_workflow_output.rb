...
module LaunchDarklyApi
  class CustomWorkflowOutput < ApiModelBase
    ...
    # Custom attribute writer method with validation
    # @param [Object] _conflicts Value to be assigned
    def _conflicts=(_conflicts)
      if _conflicts.nil?
        fail ArgumentError, '_conflicts cannot be nil'
      end
