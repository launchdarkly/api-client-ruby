...
module LaunchDarklyApi
  class HoldoutPostRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::HoldoutPostRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::HoldoutPostRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'randomizationunit')
        self.randomizationunit = attributes[:'randomizationunit']
      end
      ...
      if attributes.key?(:'holdoutamount')
        self.holdoutamount = attributes[:'holdoutamount']
      end

      if attributes.key?(:'primarymetrickey')
        self.primarymetrickey = attributes[:'primarymetrickey']
      end
      ...
      if attributes.key?(:'prerequisiteflagkey')
        self.prerequisiteflagkey = attributes[:'prerequisiteflagkey']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          randomizationunit == o.randomizationunit &&
          attributes == o.attributes &&
          holdoutamount == o.holdoutamount &&
          primarymetrickey == o.primarymetrickey &&
          metrics == o.metrics &&
          prerequisiteflagkey == o.prerequisiteflagkey &&
    ...
    def hash
      [name, key, description, randomizationunit, attributes, holdoutamount, primarymetrickey, metrics, prerequisiteflagkey, maintainer_id].hash
    end
