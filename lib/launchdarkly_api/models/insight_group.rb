...
module LaunchDarklyApi
  class InsightGroup < ApiModelBase
    attr_accessor :environment

    attr_accessor :scores

    attr_accessor :score_metadata
    ...
    def self.openapi_types
      {
        ...
        :'score_metadata' => :'InsightGroupCollectionScoreMetadata',
        :'key' => :'String',
        :'name' => :'String',
        :'project_key' => :'String',
        :'environment_key' => :'String',
        :'application_keys' => :'Array<String>',
        :'created_at' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::InsightGroup` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::InsightGroup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'score_metadata')
        self.score_metadata = attributes[:'score_metadata']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scores == o.scores &&
          score_metadata == o.score_metadata &&
          key == o.key &&
          name == o.name &&
    ...
    def hash
      [environment, scores, score_metadata, key, name, project_key, environment_key, application_keys, created_at].hash
    end
