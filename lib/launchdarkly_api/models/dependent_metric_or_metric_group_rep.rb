...
module LaunchDarklyApi
  class DependentMetricOrMetricGroupRep
    ...
    def valid?
      ...
      kind_validator = EnumAttributeValidator.new('String', ["pageview", "click", "custom", "funnel"])
    ...
    def kind=(kind)
      validator = EnumAttributeValidator.new('String', ["pageview", "click", "custom", "funnel"])
    ...
    def hash
      [key, name, kind, _links, is_group, metrics].hash
    end
