...
module LaunchDarklyApi
  class DependentMetricOrMetricGroupRep < ApiModelBase
    ...
    def valid?
      ...
      kind_validator = EnumAttributeValidator.new('String', ["pageview", "click", "custom", "funnel", "standard", "guardrail"])
    ...
    def kind=(kind)
      validator = EnumAttributeValidator.new('String', ["pageview", "click", "custom", "funnel", "standard", "guardrail"])
    ...
    def hash
      [key, _version_id, name, kind, is_numeric, event_key, _links, is_group, metrics].hash
    end
