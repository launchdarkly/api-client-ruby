...
module LaunchDarklyApi
  class CreateReleaseInput
    ...
    attr_accessor :release_variation_id
    ...
    def self.attribute_map
      {
        :'release_variation_id' => :'releaseVariationId',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::CreateReleaseInput` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::CreateReleaseInput`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'release_variation_id')
        self.release_variation_id = attributes[:'release_variation_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          release_variation_id == o.release_variation_id &&
    ...
    def hash
      [release_variation_id, release_pipeline_key].hash
    end
