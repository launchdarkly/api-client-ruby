...
module LaunchDarklyApi
  class ContextInstanceSegmentMembership < ApiModelBase
    ...
    attr_accessor :is_individually_targeted
    ...
    attr_accessor :is_rule_targeted
    ...
    def self.attribute_map
      {
        ...
        :'external' => :'external',
        :'is_member' => :'isMember',
        :'is_individually_targeted' => :'isIndividuallyTargeted',
        :'is_rule_targeted' => :'isRuleTargeted',
        :'_links' => :'_links'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'external' => :'String',
        :'is_member' => :'Boolean',
        :'is_individually_targeted' => :'Boolean',
        :'is_rule_targeted' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ContextInstanceSegmentMembership` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ContextInstanceSegmentMembership`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_individually_targeted')
        self.is_individually_targeted = attributes[:'is_individually_targeted']
      else
        self.is_individually_targeted = nil
      end

      if attributes.key?(:'is_rule_targeted')
        self.is_rule_targeted = attributes[:'is_rule_targeted']
      else
        self.is_rule_targeted = nil
      end
    ...
    def list_invalid_properties
      ...
      if @unbounded.nil?
        invalid_properties.push('invalid value for "unbounded", unbounded cannot be nil.')
      end
      ...
      if @is_individually_targeted.nil?
        invalid_properties.push('invalid value for "is_individually_targeted", is_individually_targeted cannot be nil.')
      end

      if @is_rule_targeted.nil?
        invalid_properties.push('invalid value for "is_rule_targeted", is_rule_targeted cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @unbounded.nil?
      return false if @external.nil?
      return false if @is_member.nil?
      return false if @is_individually_targeted.nil?
      return false if @is_rule_targeted.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] unbounded Value to be assigned
    def unbounded=(unbounded)
      if unbounded.nil?
        fail ArgumentError, 'unbounded cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] is_individually_targeted Value to be assigned
    def is_individually_targeted=(is_individually_targeted)
      if is_individually_targeted.nil?
        fail ArgumentError, 'is_individually_targeted cannot be nil'
      end

      @is_individually_targeted = is_individually_targeted
    end

    # Custom attribute writer method with validation
    # @param [Object] is_rule_targeted Value to be assigned
    def is_rule_targeted=(is_rule_targeted)
      if is_rule_targeted.nil?
        fail ArgumentError, 'is_rule_targeted cannot be nil'
      end

      @is_rule_targeted = is_rule_targeted
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_individually_targeted == o.is_individually_targeted &&
          is_rule_targeted == o.is_rule_targeted &&
          _links == o._links
    end
    ...
    def hash
      [name, key, description, unbounded, external, is_member, is_individually_targeted, is_rule_targeted, _links].hash
    end
