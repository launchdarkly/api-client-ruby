...
module LaunchDarklyApi
  class TriggerWorkflowRep < ApiModelBase
    attr_accessor :_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'_last_failed_at')
        self._last_failed_at = attributes[:'_last_failed_at']
      end
    ...
    def valid?
      ...
      _status_validator = EnumAttributeValidator.new('String', ["active", "inactive", "failed"])
    ...
    def _status=(_status)
      validator = EnumAttributeValidator.new('String', ["active", "inactive", "failed"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled == o.enabled &&
          _status == o._status &&
          _last_failed_at == o._last_failed_at &&
    ...
    def hash
      [_id, _version, _creation_date, _maintainer_id, _maintainer, enabled, _status, _last_failed_at, _integration_key, instructions, _last_triggered_at, _recent_trigger_bodies, _trigger_count, trigger_url, _links].hash
    end
