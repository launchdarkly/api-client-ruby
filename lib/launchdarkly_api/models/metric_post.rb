...
module LaunchDarklyApi
  class MetricPost < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'value_column')
        self.value_column = attributes[:'value_column']
      end
