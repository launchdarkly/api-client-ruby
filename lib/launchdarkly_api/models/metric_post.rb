...
module LaunchDarklyApi
  class MetricPost
    ...
    def hash
      [key, name, description, kind, selector, urls, is_numeric, unit, event_key, success_criteria, tags, randomization_units, maintainer_id, unit_aggregation_type, analysis_type, percentile_value, event_default].hash
    end
