...
module LaunchDarklyApi
  class MetricPost < ApiModelBase
    ...
    attr_accessor :unit_aggregation_field
    ...
    def self.attribute_map
      {
        ...
        :'unit_aggregation_field' => :'unitAggregationField',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::MetricPost`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unit_aggregation_field')
        self.unit_aggregation_field = attributes[:'unit_aggregation_field']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          unit_aggregation_field == o.unit_aggregation_field &&
    ...
    def hash
      [key, name, description, kind, selector, urls, is_numeric, unit, event_key, success_criteria, tags, randomization_units, analysis_units, maintainer_id, unit_aggregation_type, analysis_type, percentile_value, event_default, data_source, filters, window_start_offset, window_end_offset, winsor_lower_percentile, winsor_upper_percentile, winsor_exclude_imputed, winsor_include_imputed, trace_query, trace_value_location, unit_aggregation_field, denominator].hash
    end
