...
module LaunchDarklyApi
  class AudienceConfiguration < ApiModelBase
    attr_accessor :release_strategy
    ...
    attr_accessor :notify_team_keys

    attr_accessor :release_guardian_configuration
    ...
    def self.attribute_map
      {
        ...
        :'notify_team_keys' => :'notifyTeamKeys',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AudienceConfiguration` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AudienceConfiguration`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'release_strategy')
        self.release_strategy = attributes[:'release_strategy']
      else
        self.release_strategy = nil
      end

      if attributes.key?(:'require_approval')
        self.require_approval = attributes[:'require_approval']
      else
        self.require_approval = nil
      end
      ...
      if attributes.key?(:'notify_team_keys')
        if (value = attributes[:'notify_team_keys']).is_a?(Array)
          self.notify_team_keys = value
        end
      end

      if attributes.key?(:'release_guardian_configuration')
        self.release_guardian_configuration = attributes[:'release_guardian_configuration']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @release_strategy.nil?
        invalid_properties.push('invalid value for "release_strategy", release_strategy cannot be nil.')
      end

      if @require_approval.nil?
        invalid_properties.push('invalid value for "require_approval", require_approval cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @release_strategy.nil?
      return false if @require_approval.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] release_strategy Value to be assigned
    def release_strategy=(release_strategy)
      if release_strategy.nil?
        fail ArgumentError, 'release_strategy cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] require_approval Value to be assigned
    def require_approval=(require_approval)
      if require_approval.nil?
        fail ArgumentError, 'require_approval cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          release_strategy == o.release_strategy &&
          require_approval == o.require_approval &&
          notify_member_ids == o.notify_member_ids &&
          notify_team_keys == o.notify_team_keys &&
          release_guardian_configuration == o.release_guardian_configuration
    end
    ...
    def hash
      [release_strategy, require_approval, notify_member_ids, notify_team_keys, release_guardian_configuration].hash
    end
