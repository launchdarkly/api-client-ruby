...
module LaunchDarklyApi
  class DefaultClientSideAvailability < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::DefaultClientSideAvailability` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::DefaultClientSideAvailability`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'using_mobile_key')
        self.using_mobile_key = attributes[:'using_mobile_key']
      else
        self.using_mobile_key = nil
      end

      if attributes.key?(:'using_environment_id')
        self.using_environment_id = attributes[:'using_environment_id']
      else
        self.using_environment_id = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @using_mobile_key.nil?
        invalid_properties.push('invalid value for "using_mobile_key", using_mobile_key cannot be nil.')
      end

      if @using_environment_id.nil?
        invalid_properties.push('invalid value for "using_environment_id", using_environment_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @using_mobile_key.nil?
      return false if @using_environment_id.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] using_mobile_key Value to be assigned
    def using_mobile_key=(using_mobile_key)
      if using_mobile_key.nil?
        fail ArgumentError, 'using_mobile_key cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] using_environment_id Value to be assigned
    def using_environment_id=(using_environment_id)
      if using_environment_id.nil?
        fail ArgumentError, 'using_environment_id cannot be nil'
      end
    ...
    def hash
      [using_mobile_key, using_environment_id].hash
    end
