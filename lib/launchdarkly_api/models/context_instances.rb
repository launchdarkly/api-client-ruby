...
module LaunchDarklyApi
  class ContextInstances < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'_environment_id' => :'_environmentId',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ContextInstances` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ContextInstances`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_environment_id')
        self._environment_id = attributes[:'_environment_id']
      else
    ...
    def list_invalid_properties
      ...
      if @_environment_id.nil?
        invalid_properties.push('invalid value for "_environment_id", _environment_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @_environment_id.nil?
      return false if @items.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] _environment_id Value to be assigned
    def _environment_id=(_environment_id)
      if _environment_id.nil?
        fail ArgumentError, '_environment_id cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _environment_id == o._environment_id &&
    ...
    def hash
      [_links, total_count, _environment_id, continuation_token, items].hash
    end
