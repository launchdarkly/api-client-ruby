...
module LaunchDarklyApi
  class FeatureFlagStatusForQueriedEnvironment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastRequested')
        self.last_requested = attributes[:'lastRequested']
      end
    ...
    def valid?
      name_validator = EnumAttributeValidator.new('String', ['new', 'active', 'inactive', 'launched'])
    ...
    def name=(name)
      validator = EnumAttributeValidator.new('String', ['new', 'active', 'inactive', 'launched'])
