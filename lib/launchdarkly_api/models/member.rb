...
module LaunchDarklyApi
  class Member < ApiModelBase
    ...
    def hash
      [_links, _id, first_name, last_name, role, email, _pending_invite, _verified, _pending_email, custom_roles, mfa, excluded_dashboards, _last_seen, _last_seen_metadata, _integration_metadata, teams, permission_grants, creation_date, oauth_providers, version, role_attributes].hash
    end
