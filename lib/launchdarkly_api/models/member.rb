...
module LaunchDarklyApi
  class Member < ApiModelBase
    ...
    attr_accessor :excluded_dashboards

    attr_accessor :_last_seen

    attr_accessor :_last_seen_metadata

    attr_accessor :_integration_metadata
    ...
    attr_accessor :role_attributes

    attr_accessor :mfa_enforced

    attr_accessor :mfa_grace_period_expires_at
    ...
    def self.attribute_map
      {
        ...
        :'mfa_grace_period_expires_at' => :'mfaGracePeriodExpiresAt'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'version' => :'Integer',
        :'role_attributes' => :'Hash<String, Array>',
        :'mfa_enforced' => :'Boolean',
        :'mfa_grace_period_expires_at' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::Member`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_last_seen_metadata')
        self._last_seen_metadata = attributes[:'_last_seen_metadata']
      end

      if attributes.key?(:'_integration_metadata')
        self._integration_metadata = attributes[:'_integration_metadata']
      end
      ...
      if attributes.key?(:'role_attributes')
        if (value = attributes[:'role_attributes']).is_a?(Hash)
          self.role_attributes = value
        end
      end

      if attributes.key?(:'mfa_enforced')
        self.mfa_enforced = attributes[:'mfa_enforced']
      end

      if attributes.key?(:'mfa_grace_period_expires_at')
        self.mfa_grace_period_expires_at = attributes[:'mfa_grace_period_expires_at']
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _pending_invite Value to be assigned
    def _pending_invite=(_pending_invite)
      if _pending_invite.nil?
        fail ArgumentError, '_pending_invite cannot be nil'
      end

      @_pending_invite = _pending_invite
    end

    # Custom attribute writer method with validation
    # @param [Object] _verified Value to be assigned
    def _verified=(_verified)
      if _verified.nil?
        fail ArgumentError, '_verified cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] custom_roles Value to be assigned
    def custom_roles=(custom_roles)
      if custom_roles.nil?
        fail ArgumentError, 'custom_roles cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _last_seen Value to be assigned
    def _last_seen=(_last_seen)
      if _last_seen.nil?
        fail ArgumentError, '_last_seen cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          version == o.version &&
          role_attributes == o.role_attributes &&
          mfa_enforced == o.mfa_enforced &&
          mfa_grace_period_expires_at == o.mfa_grace_period_expires_at
    end
    ...
    def hash
      [_links, _id, first_name, last_name, role, email, _pending_invite, _verified, _pending_email, custom_roles, mfa, excluded_dashboards, _last_seen, _last_seen_metadata, _integration_metadata, teams, permission_grants, creation_date, oauth_providers, has_password, version, role_attributes, mfa_enforced, mfa_grace_period_expires_at].hash
    end
