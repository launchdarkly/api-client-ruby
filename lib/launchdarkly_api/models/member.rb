...
module LaunchDarklyApi
  class Member
    ...
    def self.swagger_types
      {
        ...
        :'is_beta' => :'BOOLEAN',
        :'custom_roles' => :'Array<Id>',
        :'_last_seen' => :'Integer',
        :'_last_seen_metadata' => :'MemberLastSeenMetadata'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'_verified')
      ...
      if attributes.has_key?(:'_lastSeen')
        self._last_seen = attributes[:'_lastSeen']
      end

      if attributes.has_key?(:'_lastSeenMetadata')
        self._last_seen_metadata = attributes[:'_lastSeenMetadata']
      end
    end
    ...
    def hash
      [_links, _id, role, email, first_name, last_name, _verified, _pending_invite, is_beta, custom_roles, _last_seen, _last_seen_metadata].hash
    end
