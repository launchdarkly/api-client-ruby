...
module LaunchDarklyApi
  class LeadTimeStagesRep < ApiModelBase
    ...
    attr_accessor :wait_duration_ms

    # The deploy duration in milliseconds
    attr_accessor :deploy_duration_ms

    # The total lead time in milliseconds
    attr_accessor :total_lead_time_ms
    ...
    def self.attribute_map
      {
        ...
        :'deploy_duration_ms' => :'deployDurationMs',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::LeadTimeStagesRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::LeadTimeStagesRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'wait_duration_ms')
        self.wait_duration_ms = attributes[:'wait_duration_ms']
      end

      if attributes.key?(:'deploy_duration_ms')
        self.deploy_duration_ms = attributes[:'deploy_duration_ms']
      end

      if attributes.key?(:'total_lead_time_ms')
        self.total_lead_time_ms = attributes[:'total_lead_time_ms']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          wait_duration_ms == o.wait_duration_ms &&
          deploy_duration_ms == o.deploy_duration_ms &&
          total_lead_time_ms == o.total_lead_time_ms
    end
    ...
    def hash
      [coding_duration_ms, review_duration_ms, wait_duration_ms, deploy_duration_ms, total_lead_time_ms].hash
    end
