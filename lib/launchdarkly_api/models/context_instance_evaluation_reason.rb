...
module LaunchDarklyApi
  class ContextInstanceEvaluationReason < ApiModelBase
    ...
    attr_accessor :prerequisite_key
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ContextInstanceEvaluationReason` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ContextInstanceEvaluationReason`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'prerequisite_key')
        self.prerequisite_key = attributes[:'prerequisite_key']
      end

      if attributes.key?(:'in_experiment')
        self.in_experiment = attributes[:'in_experiment']
      end

      if attributes.key?(:'error_kind')
        self.error_kind = attributes[:'error_kind']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rule_id == o.rule_id &&
          prerequisite_key == o.prerequisite_key &&
          in_experiment == o.in_experiment &&
    ...
    def hash
      [kind, rule_index, rule_id, prerequisite_key, in_experiment, error_kind].hash
    end
