...
module LaunchDarklyApi
  class FeatureFlag < ApiModelBase
    ...
    attr_accessor :client_side_availability
    ...
    attr_accessor :_maintainer_team
    ...
    def self.attribute_map
      {
        ...
        :'_maintainer_team' => :'_maintainerTeam',
        :'goal_ids' => :'goalIds',
    ...
    def self.openapi_types
      {
        ...
        :'_maintainer_team' => :'MaintainerTeam',
        ...
        :'defaults' => :'Defaults',
        :'_purpose' => :'String',
        :'migration_settings' => :'FlagMigrationSettingsRep',
        :'stale' => :'StaleFlagData',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::FeatureFlag`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_maintainer_team')
        self._maintainer_team = attributes[:'_maintainer_team']
      end
      ...
      if attributes.key?(:'deprecated_date')
        self.deprecated_date = attributes[:'deprecated_date']
      end
      ...
      if attributes.key?(:'_purpose')
        self._purpose = attributes[:'_purpose']
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] experiments Value to be assigned
    def experiments=(experiments)
      if experiments.nil?
        fail ArgumentError, 'experiments cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] custom_properties Value to be assigned
    def custom_properties=(custom_properties)
      if custom_properties.nil?
        fail ArgumentError, 'custom_properties cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _maintainer_team == o._maintainer_team &&
          goal_ids == o.goal_ids &&
          ...
          deprecated_date == o.deprecated_date &&
          defaults == o.defaults &&
          _purpose == o._purpose &&
    ...
    def hash
      [name, kind, description, key, _version, creation_date, include_in_snippet, client_side_availability, variations, temporary, tags, _links, maintainer_id, _maintainer, maintainer_team_key, _maintainer_team, goal_ids, experiments, custom_properties, archived, archived_date, deprecated, deprecated_date, defaults, _purpose, migration_settings, stale, environments].hash
    end
