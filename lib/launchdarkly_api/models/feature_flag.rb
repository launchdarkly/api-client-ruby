...
module LaunchDarklyApi
  class FeatureFlag
    ...
    def hash
      [key, name, description, kind, creation_date, include_in_snippet, temporary, maintainer_id, tags, variations, goal_ids, _version, custom_properties, _links, _maintainer, environments, archived_date, archived, defaults].hash
    end
