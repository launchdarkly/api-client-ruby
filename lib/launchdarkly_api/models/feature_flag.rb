...
module LaunchDarklyApi
  class FeatureFlag
    ...
    def hash
      [name, kind, description, key, _version, creation_date, include_in_snippet, client_side_availability, variations, temporary, tags, _links, maintainer_id, _maintainer, maintainer_team_key, _maintainer_team, goal_ids, experiments, custom_properties, archived, archived_date, defaults, environments].hash
    end
