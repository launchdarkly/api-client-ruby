...
module LaunchDarklyApi
  class FeatureFlag
    ...
    attr_accessor :variation_json_schema
    ...
    def hash
      [name, kind, description, key, _version, creation_date, include_in_snippet, client_side_availability, variations, variation_json_schema, temporary, tags, _links, maintainer_id, _maintainer, goal_ids, experiments, custom_properties, archived, archived_date, defaults, environments].hash
    end
