...
module LaunchDarklyApi
  class AuditLogEntryRep < ApiModelBase
    ...
    def hash
      [_links, _id, _account_id, date, accesses, kind, name, description, short_description, comment, subject, member, token, app, title_verb, title, target, parent, delta, trigger_body, merge, previous_version, current_version, subentries].hash
    end
