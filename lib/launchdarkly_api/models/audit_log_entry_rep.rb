...
module LaunchDarklyApi
  class AuditLogEntryRep < ApiModelBase
    ...
    attr_accessor :related_flag

    attr_accessor :related_experiment

    attr_accessor :related_ai_config
    ...
    def self.attribute_map
      {
        ...
        :'related_experiment' => :'relatedExperiment',
        :'related_ai_config' => :'relatedAIConfig',
        :'subject' => :'subject',
        :'member' => :'member',
        :'token' => :'token',
        :'app' => :'app',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AuditLogEntryRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'related_flag')
        self.related_flag = attributes[:'related_flag']
      end

      if attributes.key?(:'related_experiment')
        self.related_experiment = attributes[:'related_experiment']
      end

      if attributes.key?(:'related_ai_config')
        self.related_ai_config = attributes[:'related_ai_config']
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _account_id Value to be assigned
    def _account_id=(_account_id)
      if _account_id.nil?
        fail ArgumentError, '_account_id cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] accesses Value to be assigned
    def accesses=(accesses)
      if accesses.nil?
        fail ArgumentError, 'accesses cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          comment == o.comment &&
          related_flag == o.related_flag &&
          related_experiment == o.related_experiment &&
          related_ai_config == o.related_ai_config &&
          subject == o.subject &&
          member == o.member &&
          token == o.token &&
          app == o.app &&
    ...
    def hash
      [_links, _id, _account_id, date, accesses, kind, name, description, short_description, comment, related_flag, related_experiment, related_ai_config, subject, member, token, app, title_verb, title, target, parent, delta, trigger_body, merge, previous_version, current_version, subentries].hash
    end
