...
module LaunchDarklyApi
  class RandomizationSettingsRep < ApiModelBase
    # The project ID
    attr_accessor :_project_id

    # The project key
    attr_accessor :_project_key
    ...
    def self.attribute_map
      {
        :'_project_id' => :'_projectId',
        :'_project_key' => :'_projectKey',
    ...
    def self.openapi_types
      {
        :'_project_id' => :'String',
        :'_project_key' => :'String',
        :'randomization_units' => :'Array<RandomizationUnitRep>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::RandomizationSettingsRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::RandomizationSettingsRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'_project_id')
        self._project_id = attributes[:'_project_id']
      end

      if attributes.key?(:'_project_key')
        self._project_key = attributes[:'_project_key']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _project_id == o._project_id &&
          _project_key == o._project_key &&
    ...
    def hash
      [_project_id, _project_key, randomization_units, _creation_date, _links].hash
    end
