...
module LaunchDarklyApi
  class FlagEventRep < ApiModelBase
    # The flag event ID
    attr_accessor :id
    ...
    attr_accessor :audit_log_entry_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::FlagEventRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::FlagEventRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'audit_log_entry_id')
        self.audit_log_entry_id = attributes[:'audit_log_entry_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          audit_log_entry_id == o.audit_log_entry_id &&
          member == o.member &&
          actions == o.actions &&
          impact == o.impact &&
    ...
    def hash
      [id, project_id, project_key, environment_id, environment_key, flag_key, event_type, event_time, description, audit_log_entry_id, member, actions, impact, experiments].hash
    end
