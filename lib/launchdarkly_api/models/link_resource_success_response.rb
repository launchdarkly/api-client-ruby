...
module LaunchDarklyApi
  class LinkResourceSuccessResponse < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'linked_resources' => :'ViewLinkedResources',
        :'failed_resources' => :'Array<FailedResourceLink>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::LinkResourceSuccessResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::LinkResourceSuccessResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'failure_count')
        ...
        self.failure_count = nil
      end

      if attributes.key?(:'linked_resources')
        self.linked_resources = attributes[:'linked_resources']
      end

      if attributes.key?(:'failed_resources')
        if (value = attributes[:'failed_resources']).is_a?(Array)
          self.failed_resources = value
        end
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] failure_count Value to be assigned
    def failure_count=(failure_count)
      if failure_count.nil?
        fail ArgumentError, 'failure_count cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          failed_resources == o.failed_resources
    end
    ...
    def hash
      [success_count, failure_count, linked_resources, failed_resources].hash
    end
