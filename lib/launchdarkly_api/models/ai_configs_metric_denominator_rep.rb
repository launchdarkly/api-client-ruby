...
module LaunchDarklyApi
  class AiConfigsMetricDenominatorRep < ApiModelBase
    ...
    # For a numeric denominator, the column holding the numeric value
    ...
    def hash
      [event_name, is_numeric, unit_aggregation_type, unit_aggregation_field, value_column, data_source, filters, window_start_offset, window_end_offset, winsor_lower_percentile, winsor_upper_percentile, winsor_include_imputed].hash
    end
