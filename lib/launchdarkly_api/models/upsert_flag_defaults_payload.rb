...
module LaunchDarklyApi
  class UpsertFlagDefaultsPayload < ApiModelBase
    ...
    attr_accessor :boolean_defaults
    ...
    def self.attribute_map
      {
        :'tags' => :'tags',
        :'temporary' => :'temporary',
        :'boolean_defaults' => :'booleanDefaults',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::UpsertFlagDefaultsPayload` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::UpsertFlagDefaultsPayload`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'boolean_defaults')
        self.boolean_defaults = attributes[:'boolean_defaults']
      else
        self.boolean_defaults = nil
      end

      if attributes.key?(:'default_client_side_availability')
        self.default_client_side_availability = attributes[:'default_client_side_availability']
      else
        self.default_client_side_availability = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @boolean_defaults.nil?
        invalid_properties.push('invalid value for "boolean_defaults", boolean_defaults cannot be nil.')
      end

      if @default_client_side_availability.nil?
        invalid_properties.push('invalid value for "default_client_side_availability", default_client_side_availability cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @boolean_defaults.nil?
      return false if @default_client_side_availability.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] temporary Value to be assigned
    def temporary=(temporary)
      if temporary.nil?
        fail ArgumentError, 'temporary cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] boolean_defaults Value to be assigned
    def boolean_defaults=(boolean_defaults)
      if boolean_defaults.nil?
        fail ArgumentError, 'boolean_defaults cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] default_client_side_availability Value to be assigned
    def default_client_side_availability=(default_client_side_availability)
      if default_client_side_availability.nil?
        fail ArgumentError, 'default_client_side_availability cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          boolean_defaults == o.boolean_defaults &&
    ...
    def hash
      [tags, temporary, boolean_defaults, default_client_side_availability].hash
    end
