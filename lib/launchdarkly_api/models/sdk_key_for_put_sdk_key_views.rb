...
module LaunchDarklyApi
  class SdkKeyForPutSdkKeyViews < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'_created_by_member_id' => :'_createdByMemberId',
    ...
    def self.openapi_types
      {
        ...
        :'value' => :'String',
        :'is_default' => :'Boolean',
        :'_created_by_member_id' => :'String',
        :'_created_at' => :'Integer',
        :'_updated_at' => :'Integer',
        :'_version' => :'Integer',
        :'view_summaries' => :'Array<ViewSummary>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::SdkKeyForPutSdkKeyViews` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::SdkKeyForPutSdkKeyViews`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_created_by_member_id')
        self._created_by_member_id = attributes[:'_created_by_member_id']
      end
      ...
      if attributes.key?(:'_updated_at')
        self._updated_at = attributes[:'_updated_at']
      else
      ...
      if attributes.key?(:'view_summaries')
        if (value = attributes[:'view_summaries']).is_a?(Array)
          self.view_summaries = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @_created_at.nil?
        invalid_properties.push('invalid value for "_created_at", _created_at cannot be nil.')
      end

      if @_updated_at.nil?
        invalid_properties.push('invalid value for "_updated_at", _updated_at cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @_created_at.nil?
      return false if @_updated_at.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] _created_at Value to be assigned
    def _created_at=(_created_at)
      if _created_at.nil?
        fail ArgumentError, '_created_at cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _updated_at Value to be assigned
    def _updated_at=(_updated_at)
      if _updated_at.nil?
        fail ArgumentError, '_updated_at cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _created_by_member_id == o._created_by_member_id &&
          _created_at == o._created_at &&
          _updated_at == o._updated_at &&
          _version == o._version &&
          view_summaries == o.view_summaries
    end
    ...
    def hash
      [_links, kind, key, name, description, expiry, value, is_default, _created_by_member_id, _created_at, _updated_at, _version, view_summaries].hash
    end
