  ...
  class IntegrationMetadata
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::IntegrationMetadata` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::IntegrationMetadata`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'external_status')
        self.external_status = attributes[:'external_status']
      else
        self.external_status = nil
      end
    ...
    def list_invalid_properties
      ...
      if @external_status.nil?
        invalid_properties.push('invalid value for "external_status", external_status cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @external_status.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] external_status Value to be assigned
    def external_status=(external_status)
      if external_status.nil?
        fail ArgumentError, 'external_status cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] last_checked Value to be assigned
    def last_checked=(last_checked)
      if last_checked.nil?
        fail ArgumentError, 'last_checked cannot be nil'
      end
    ...
    def hash
      [external_id, external_status, external_url, last_checked].hash
    end
