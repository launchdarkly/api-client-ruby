...
module LaunchDarklyApi
  class FlagGlobalAttributesRep
    ...
    def hash
      [name, kind, description, key, _version, creation_date, include_in_snippet, client_side_availability, variations, temporary, tags, _links, maintainer_id, _maintainer, goal_ids, experiments, custom_properties, archived, archived_date, defaults].hash
    end
