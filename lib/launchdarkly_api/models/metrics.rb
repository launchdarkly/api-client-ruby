...
module LaunchDarklyApi
  class Metrics < ApiModelBase
    ...
    attr_accessor :generation_success_count

    # Number of generations with errors
    attr_accessor :generation_error_count

    attr_accessor :thumbs_up

    attr_accessor :thumbs_down

    attr_accessor :duration_ms

    attr_accessor :time_to_first_token_ms

    # A value between 0 and 1 representing satisfaction rating
    attr_accessor :satisfaction_rating

    # Cost of input tokens in USD
    attr_accessor :input_cost
    ...
    def self.openapi_types
      {
        ...
        :'generation_success_count' => :'Integer',
        :'generation_error_count' => :'Integer',
        :'thumbs_up' => :'Integer',
        :'thumbs_down' => :'Integer',
        :'duration_ms' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::Metrics` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::Metrics`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'generation_count')
        self.generation_count = attributes[:'generation_count']
      end

      if attributes.key?(:'generation_success_count')
        self.generation_success_count = attributes[:'generation_success_count']
      end

      if attributes.key?(:'generation_error_count')
        self.generation_error_count = attributes[:'generation_error_count']
      end

      if attributes.key?(:'thumbs_up')
        self.thumbs_up = attributes[:'thumbs_up']
      end

      if attributes.key?(:'thumbs_down')
        self.thumbs_down = attributes[:'thumbs_down']
      end
      ...
      if attributes.key?(:'time_to_first_token_ms')
        self.time_to_first_token_ms = attributes[:'time_to_first_token_ms']
      end

      if attributes.key?(:'satisfaction_rating')
        self.satisfaction_rating = attributes[:'satisfaction_rating']
      end

      if attributes.key?(:'input_cost')
        self.input_cost = attributes[:'input_cost']
      end
    ...
    def list_invalid_properties
      ...
      if !@satisfaction_rating.nil? && @satisfaction_rating > 1
        invalid_properties.push('invalid value for "satisfaction_rating", must be smaller than or equal to 1.')
      end

      if !@satisfaction_rating.nil? && @satisfaction_rating < 0
    ...
    # @param [Object] satisfaction_rating Value to be assigned
    def satisfaction_rating=(satisfaction_rating)
      if satisfaction_rating.nil?
        fail ArgumentError, 'satisfaction_rating cannot be nil'
      end

      if satisfaction_rating > 1
        fail ArgumentError, 'invalid value for "satisfaction_rating", must be smaller than or equal to 1.'
      end

      if satisfaction_rating < 0
        fail ArgumentError, 'invalid value for "satisfaction_rating", must be greater than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          generation_count == o.generation_count &&
          generation_success_count == o.generation_success_count &&
          generation_error_count == o.generation_error_count &&
          thumbs_up == o.thumbs_up &&
          thumbs_down == o.thumbs_down &&
