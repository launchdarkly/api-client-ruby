...
module LaunchDarklyApi
  class ApprovalSettings
    ...
    def hash
      [required, bypass_approvals_for_pending_changes, min_num_approvals, can_review_own_request, can_apply_declined_changes, service_kind, service_config, required_approval_tags].hash
    end
