  ...
  class Rollout < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'experiment_allocation' => :'ExperimentAllocationRep',
        :'seed' => :'Integer',
        :'bucket_by' => :'String',
        :'context_kind' => :'String'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::Rollout` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::Rollout`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [variations, experiment_allocation, seed, bucket_by, context_kind].hash
    end
