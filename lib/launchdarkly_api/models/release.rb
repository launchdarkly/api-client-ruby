...
module LaunchDarklyApi
  class Release < ApiModelBase
    ...
    attr_accessor :release_pipeline_key

    # The release pipeline description
    attr_accessor :release_pipeline_description
    ...
    attr_accessor :_release_variation_id

    attr_accessor :_canceled_at
    ...
    def self.attribute_map
      {
        :'_links' => :'_links',
        :'name' => :'name',
        :'release_pipeline_key' => :'releasePipelineKey',
        :'release_pipeline_description' => :'releasePipelineDescription',
        :'phases' => :'phases',
        :'_version' => :'_version',
        :'_release_variation_id' => :'_releaseVariationId',
        :'_canceled_at' => :'_canceledAt'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'release_pipeline_key' => :'String',
        :'release_pipeline_description' => :'String',
        :'phases' => :'Array<ReleasePhase>',
        :'_version' => :'Integer',
        :'_release_variation_id' => :'String',
        :'_canceled_at' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::Release` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::Release`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'release_pipeline_key')
        self.release_pipeline_key = attributes[:'release_pipeline_key']
      else
        self.release_pipeline_key = nil
      end

      if attributes.key?(:'release_pipeline_description')
        self.release_pipeline_description = attributes[:'release_pipeline_description']
      else
        self.release_pipeline_description = nil
      end
      ...
      if attributes.key?(:'_release_variation_id')
        self._release_variation_id = attributes[:'_release_variation_id']
      end

      if attributes.key?(:'_canceled_at')
        self._canceled_at = attributes[:'_canceled_at']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @release_pipeline_key.nil?
        invalid_properties.push('invalid value for "release_pipeline_key", release_pipeline_key cannot be nil.')
      end

      if @release_pipeline_description.nil?
        invalid_properties.push('invalid value for "release_pipeline_description", release_pipeline_description cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @release_pipeline_key.nil?
      return false if @release_pipeline_description.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] release_pipeline_key Value to be assigned
    def release_pipeline_key=(release_pipeline_key)
      if release_pipeline_key.nil?
        fail ArgumentError, 'release_pipeline_key cannot be nil'
      end

      @release_pipeline_key = release_pipeline_key
    end

    # Custom attribute writer method with validation
    # @param [Object] release_pipeline_description Value to be assigned
    def release_pipeline_description=(release_pipeline_description)
      if release_pipeline_description.nil?
        fail ArgumentError, 'release_pipeline_description cannot be nil'
      end

      @release_pipeline_description = release_pipeline_description
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _version Value to be assigned
    def _version=(_version)
      if _version.nil?
        fail ArgumentError, '_version cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _links == o._links &&
          name == o.name &&
          release_pipeline_key == o.release_pipeline_key &&
          release_pipeline_description == o.release_pipeline_description &&
          phases == o.phases &&
          _version == o._version &&
          _release_variation_id == o._release_variation_id &&
          _canceled_at == o._canceled_at
    end
    ...
    def hash
      [_links, name, release_pipeline_key, release_pipeline_description, phases, _version, _release_variation_id, _canceled_at].hash
    end
