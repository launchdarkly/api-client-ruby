...
module LaunchDarklyApi
  class StageInputRep
    ...
    attr_accessor :execute_conditions_in_sequence
    ...
    def self.attribute_map
      {
        :'name' => :'name',
        :'execute_conditions_in_sequence' => :'executeConditionsInSequence',
    ...
    def self.openapi_types
      {
        :'name' => :'String',
        :'execute_conditions_in_sequence' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::StageInputRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::StageInputRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'execute_conditions_in_sequence')
        self.execute_conditions_in_sequence = attributes[:'execute_conditions_in_sequence']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          execute_conditions_in_sequence == o.execute_conditions_in_sequence &&
    ...
    def hash
      [name, execute_conditions_in_sequence, conditions, action].hash
    end
