...
module LaunchDarklyApi
  class ResolvedTitle
    ...
    attr_accessor :link_to_reference

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'elements' => :'elements',
        :'link_to_reference' => :'linkToReference'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ResolvedTitle` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ResolvedTitle`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'link_to_reference')
        self.link_to_reference = attributes[:'link_to_reference']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          elements == o.elements &&
          link_to_reference == o.link_to_reference
    end
    ...
    def hash
      [elements, link_to_reference].hash
    end
