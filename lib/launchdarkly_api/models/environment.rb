...
module LaunchDarklyApi
  class Environment
    ...
    attr_accessor :resource_approval_settings
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::Environment`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] mobile_key Value to be assigned
    def mobile_key=(mobile_key)
      if mobile_key.nil?
        fail ArgumentError, 'mobile_key cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] default_ttl Value to be assigned
    def default_ttl=(default_ttl)
      if default_ttl.nil?
        fail ArgumentError, 'default_ttl cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] secure_mode Value to be assigned
    def secure_mode=(secure_mode)
      if secure_mode.nil?
        fail ArgumentError, 'secure_mode cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] default_track_events Value to be assigned
    def default_track_events=(default_track_events)
      if default_track_events.nil?
        fail ArgumentError, 'default_track_events cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] require_comments Value to be assigned
    def require_comments=(require_comments)
      if require_comments.nil?
        fail ArgumentError, 'require_comments cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] confirm_changes Value to be assigned
    def confirm_changes=(confirm_changes)
      if confirm_changes.nil?
        fail ArgumentError, 'confirm_changes cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] critical Value to be assigned
    def critical=(critical)
      if critical.nil?
        fail ArgumentError, 'critical cannot be nil'
      end
