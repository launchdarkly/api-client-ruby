  ...
  class ViewLinkedResource < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'linked_at' => :'Integer',
        :'resource_details' => :'ViewLinkedResourceDetails'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ViewLinkedResource` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ViewLinkedResource`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'resource_details')
        self.resource_details = attributes[:'resource_details']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @resource_key.nil?
        invalid_properties.push('invalid value for "resource_key", resource_key cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ["flag", "segment", "aiConfig"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] resource_key Value to be assigned
    def resource_key=(resource_key)
      if resource_key.nil?
        fail ArgumentError, 'resource_key cannot be nil'
      end
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ["flag", "segment", "aiConfig"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          resource_details == o.resource_details
    end
    ...
    def hash
      [_links, resource_key, environment_id, environment_key, resource_type, linked_at, resource_details].hash
    end
