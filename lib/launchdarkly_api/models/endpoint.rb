  ...
  class Endpoint
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::Endpoint` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::Endpoint`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hmac_signature')
        self.hmac_signature = attributes[:'hmac_signature']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          headers == o.headers &&
          hmac_signature == o.hmac_signature &&
          method == o.method &&
          url == o.url
    end
    ...
    def hash
      [headers, hmac_signature, method, url].hash
    end
