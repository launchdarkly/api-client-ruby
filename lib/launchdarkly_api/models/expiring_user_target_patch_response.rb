...
module LaunchDarklyApi
  class ExpiringUserTargetPatchResponse < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'successful_instructions' => :'successfulInstructions',
    ...
    def self.openapi_types
      {
        ...
        :'successful_instructions' => :'Integer',
        :'failed_instructions' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ExpiringUserTargetPatchResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ExpiringUserTargetPatchResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_instructions')
        self.total_instructions = attributes[:'total_instructions']
      end

      if attributes.key?(:'successful_instructions')
        self.successful_instructions = attributes[:'successful_instructions']
      end

      if attributes.key?(:'failed_instructions')
        self.failed_instructions = attributes[:'failed_instructions']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          successful_instructions == o.successful_instructions &&
          failed_instructions == o.failed_instructions &&
          errors == o.errors
    end
    ...
    def hash
      [items, _links, total_instructions, successful_instructions, failed_instructions, errors].hash
    end
