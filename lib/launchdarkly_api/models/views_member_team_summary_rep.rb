...
module LaunchDarklyApi
  class ViewsMemberTeamSummaryRep < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ViewsMemberTeamSummaryRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ViewsMemberTeamSummaryRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @custom_role_keys.nil?
        invalid_properties.push('invalid value for "custom_role_keys", custom_role_keys cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @custom_role_keys.nil?
    ...
    # @param [Object] custom_role_keys Value to be assigned
    def custom_role_keys=(custom_role_keys)
      if custom_role_keys.nil?
        fail ArgumentError, 'custom_role_keys cannot be nil'
      end
    ...
    def hash
      [custom_role_keys, key, _links, name].hash
    end
