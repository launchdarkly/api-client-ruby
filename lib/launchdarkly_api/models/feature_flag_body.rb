...
module LaunchDarklyApi
  class FeatureFlagBody
    ...
    def hash
      [name, key, description, include_in_snippet, client_side_availability, variations, temporary, tags, custom_properties, defaults, purpose, migration_settings, maintainer_id, maintainer_team_key, initial_prerequisites].hash
    end
