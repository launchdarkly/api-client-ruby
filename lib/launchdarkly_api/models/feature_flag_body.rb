...
module LaunchDarklyApi
  class FeatureFlagBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clientSideAvailability')
        self.client_side_availability = attributes[:'clientSideAvailability']
      end
    ...
    def hash
      [name, key, description, variations, temporary, tags, include_in_snippet, client_side_availability, defaults].hash
    end
