...
module LaunchDarklyApi
  class MetricInGroupRep < ApiModelBase
    ...
    def valid?
      ...
      unit_aggregation_type_validator = EnumAttributeValidator.new('String', ["sum", "average"])
    ...
    def hash
      [key, _version_id, name, kind, is_numeric, unit_aggregation_type, event_key, _links, name_in_group, randomization_units].hash
    end
