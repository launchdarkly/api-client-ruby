...
module LaunchDarklyApi
  class ModelConfig < ApiModelBase
    ...
    def hash
      [_access, name, key, id, icon, provider, global, params, custom_params, tags, version, cost_per_input_token, cost_per_output_token, cost_per_cached_input_token, is_restricted].hash
    end
