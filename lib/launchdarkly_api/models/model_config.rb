...
module LaunchDarklyApi
  class ModelConfig < ApiModelBase
    ...
    # Custom attribute writer method with validation
    # @param [Object] global Value to be assigned
    def global=(global)
      if global.nil?
        fail ArgumentError, 'global cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] is_restricted Value to be assigned
    def is_restricted=(is_restricted)
      if is_restricted.nil?
        fail ArgumentError, 'is_restricted cannot be nil'
      end
    ...
    def hash
      [_access, _maintainer, name, key, id, icon, provider, global, params, custom_params, tags, version, cost_per_input_token, cost_per_output_token, cost_per_cached_input_token, is_restricted].hash
    end
