...
module LaunchDarklyApi
  class FlagEventImpactRep < ApiModelBase
    ...
    attr_accessor :evaluations_summary
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::FlagEventImpactRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::FlagEventImpactRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'evaluations_summary')
        self.evaluations_summary = attributes[:'evaluations_summary']
      end
    end
    ...
    def valid?
      ...
      size_validator = EnumAttributeValidator.new('String', ["none", "small", "medium", "large"])
    ...
    def size=(size)
      validator = EnumAttributeValidator.new('String', ["none", "small", "medium", "large"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reason == o.reason &&
          evaluations_summary == o.evaluations_summary
    end
    ...
    def hash
      [size, percentage, reason, evaluations_summary].hash
    end
