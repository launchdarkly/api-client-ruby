...
module LaunchDarklyApi
  class UserSegmentRule < ApiModelBase
    attr_accessor :_id
    ...
    attr_accessor :rollout_context_kind
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::UserSegmentRule` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::UserSegmentRule`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rollout_context_kind')
        self.rollout_context_kind = attributes[:'rollout_context_kind']
      end
    ...
    def list_invalid_properties
      ...
      if @clauses.nil?
        invalid_properties.push('invalid value for "clauses", clauses cannot be nil.')
      end
    ...
    # @param [Object] clauses Value to be assigned
    def clauses=(clauses)
      if clauses.nil?
        fail ArgumentError, 'clauses cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          clauses == o.clauses &&
          weight == o.weight &&
          rollout_context_kind == o.rollout_context_kind &&
    ...
    def hash
      [_id, clauses, weight, rollout_context_kind, bucket_by, description].hash
    end
