...
module LaunchDarklyApi
  class AiConfigsFilter < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AiConfigsFilter` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AiConfigsFilter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @negate.nil?
        invalid_properties.push('invalid value for "negate", negate cannot be nil.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["group", "contextAttribute", "eventProperty"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["group", "contextAttribute", "eventProperty"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] negate Value to be assigned
    def negate=(negate)
      if negate.nil?
        fail ArgumentError, 'negate cannot be nil'
      end
    ...
    def hash
      [type, attribute, op, values, context_kind, negate].hash
    end
