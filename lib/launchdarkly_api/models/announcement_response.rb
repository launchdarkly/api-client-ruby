...
module LaunchDarklyApi
  ...
  class AnnouncementResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AnnouncementResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AnnouncementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_dismissible')
        self.is_dismissible = attributes[:'is_dismissible']
      else
        self.is_dismissible = nil
      end
      ...
      if attributes.key?(:'_status')
        self._status = attributes[:'_status']
      else
        self._status = nil
      end
    ...
    def list_invalid_properties
      ...
      if @is_dismissible.nil?
        invalid_properties.push('invalid value for "is_dismissible", is_dismissible cannot be nil.')
      end
      ...
      if @_status.nil?
        invalid_properties.push('invalid value for "_status", _status cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_dismissible.nil?
      return false if @title.nil?
      return false if @message.nil?
      return false if @start_time.nil?
      return false if @severity.nil?
      severity_validator = EnumAttributeValidator.new('String', ["info", "warning", "critical"])
      return false unless severity_validator.valid?(@severity)
      return false if @_status.nil?
      _status_validator = EnumAttributeValidator.new('String', ["active", "inactive", "scheduled"])
      return false unless _status_validator.valid?(@_status)
    ...
    # Custom attribute writer method with validation
    # @param [Object] is_dismissible Value to be assigned
    def is_dismissible=(is_dismissible)
      if is_dismissible.nil?
        fail ArgumentError, 'is_dismissible cannot be nil'
      end
    ...
    def severity=(severity)
      validator = EnumAttributeValidator.new('String', ["info", "warning", "critical"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] _status Object to be assigned
    def _status=(_status)
      validator = EnumAttributeValidator.new('String', ["active", "inactive", "scheduled"])
      unless validator.valid?(_status)
        fail ArgumentError, "invalid value for \"_status\", must be one of #{validator.allowable_values}."
      end
      @_status = _status
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _id == o._id &&
          is_dismissible == o.is_dismissible &&
          title == o.title &&
          message == o.message &&
    ...
    def hash
      [_id, is_dismissible, title, message, start_time, end_time, severity, _status, _access, _links].hash
    end
