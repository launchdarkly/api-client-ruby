...
module LaunchDarklyApi
  class FlagLinkRep < ApiModelBase
    ...
    attr_accessor :_deep_link

    attr_accessor :_timestamp
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::FlagLinkRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::FlagLinkRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_deep_link')
        self._deep_link = attributes[:'_deep_link']
      else
        self._deep_link = nil
      end

      if attributes.key?(:'_timestamp')
        self._timestamp = attributes[:'_timestamp']
      else
        self._timestamp = nil
      end
      ...
      if attributes.key?(:'_metadata')
        if (value = attributes[:'_metadata']).is_a?(Hash)
    ...
    def list_invalid_properties
      ...
      if @_deep_link.nil?
        invalid_properties.push('invalid value for "_deep_link", _deep_link cannot be nil.')
      end

      if @_timestamp.nil?
        invalid_properties.push('invalid value for "_timestamp", _timestamp cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @_deep_link.nil?
      return false if @_timestamp.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] _deep_link Value to be assigned
    def _deep_link=(_deep_link)
      if _deep_link.nil?
        fail ArgumentError, '_deep_link cannot be nil'
      end

      @_deep_link = _deep_link
    end

    # Custom attribute writer method with validation
    # @param [Object] _timestamp Value to be assigned
    def _timestamp=(_timestamp)
      if _timestamp.nil?
        fail ArgumentError, '_timestamp cannot be nil'
      end
    ...
    def hash
      [_links, _key, _integration_key, _id, _deep_link, _timestamp, title, description, _metadata, _created_at, _member].hash
    end
