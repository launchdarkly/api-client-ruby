...
module LaunchDarklyApi
  class ReleaseGuardianConfiguration < ApiModelBase
    # The monitoring window in milliseconds
    attr_accessor :monitoring_window_milliseconds

    # The rollout weight percentage
    attr_accessor :rollout_weight
    ...
    def self.attribute_map
      {
        :'monitoring_window_milliseconds' => :'monitoringWindowMilliseconds',
        :'rollout_weight' => :'rolloutWeight',
    ...
    def self.openapi_types
      {
        :'monitoring_window_milliseconds' => :'Integer',
        :'rollout_weight' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ReleaseGuardianConfiguration` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ReleaseGuardianConfiguration`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'monitoring_window_milliseconds')
        self.monitoring_window_milliseconds = attributes[:'monitoring_window_milliseconds']
      else
        self.monitoring_window_milliseconds = nil
      end

      if attributes.key?(:'rollout_weight')
        self.rollout_weight = attributes[:'rollout_weight']
      else
        self.rollout_weight = nil
      end

      if attributes.key?(:'rollback_on_regression')
        self.rollback_on_regression = attributes[:'rollback_on_regression']
      else
        self.rollback_on_regression = nil
      end
    ...
    def list_invalid_properties
      ...
      if @monitoring_window_milliseconds.nil?
        invalid_properties.push('invalid value for "monitoring_window_milliseconds", monitoring_window_milliseconds cannot be nil.')
      end

      if @rollout_weight.nil?
        invalid_properties.push('invalid value for "rollout_weight", rollout_weight cannot be nil.')
      end

      if @rollback_on_regression.nil?
        invalid_properties.push('invalid value for "rollback_on_regression", rollback_on_regression cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @monitoring_window_milliseconds.nil?
      return false if @rollout_weight.nil?
      return false if @rollback_on_regression.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] monitoring_window_milliseconds Value to be assigned
    def monitoring_window_milliseconds=(monitoring_window_milliseconds)
      if monitoring_window_milliseconds.nil?
        fail ArgumentError, 'monitoring_window_milliseconds cannot be nil'
      end

      @monitoring_window_milliseconds = monitoring_window_milliseconds
    end

    # Custom attribute writer method with validation
    # @param [Object] rollout_weight Value to be assigned
    def rollout_weight=(rollout_weight)
      if rollout_weight.nil?
        fail ArgumentError, 'rollout_weight cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] rollback_on_regression Value to be assigned
    def rollback_on_regression=(rollback_on_regression)
      if rollback_on_regression.nil?
        fail ArgumentError, 'rollback_on_regression cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          monitoring_window_milliseconds == o.monitoring_window_milliseconds &&
          rollout_weight == o.rollout_weight &&
    ...
    def hash
      [monitoring_window_milliseconds, rollout_weight, rollback_on_regression, randomization_unit].hash
    end
