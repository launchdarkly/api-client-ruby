...
module LaunchDarklyApi
  class HunkRep < ApiModelBase
    ...
    def self.attribute_map
      {
        :'starting_line_number' => :'startingLineNumber',
        :'lines' => :'lines',
        :'proj_key' => :'projKey',
        :'flag_key' => :'flagKey',
        :'aliases' => :'aliases'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::HunkRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::HunkRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'starting_line_number')
        self.starting_line_number = attributes[:'starting_line_number']
      else
        self.starting_line_number = nil
      end
      ...
      if attributes.key?(:'proj_key')
        self.proj_key = attributes[:'proj_key']
      end
    ...
    # @param [Object] starting_line_number Value to be assigned
    def starting_line_number=(starting_line_number)
      if starting_line_number.nil?
        fail ArgumentError, 'starting_line_number cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          starting_line_number == o.starting_line_number &&
          lines == o.lines &&
          proj_key == o.proj_key &&
          flag_key == o.flag_key &&
          aliases == o.aliases
    ...
    def hash
      [starting_line_number, lines, proj_key, flag_key, aliases].hash
    end
