...
module LaunchDarklyApi
  ...
  class AgentSkillReference < ApiModelBase
    # The key of the config with a variation that references this skill.
    attr_accessor :ai_config_key

    # The name of the config with a variation that references this skill.
    attr_accessor :ai_config_name

    # The ID of the variation that references this skill.
    attr_accessor :variation_id

    # The key of the config variation that references this skill.
    attr_accessor :variation_key

    # The name of the variation that references this skill.
    attr_accessor :variation_name

    # The version of the skill being referenced.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AgentSkillReference` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AgentSkillReference`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @ai_config_name.nil?
        invalid_properties.push('invalid value for "ai_config_name", ai_config_name cannot be nil.')
      end
      ...
      if @variation_key.nil?
        invalid_properties.push('invalid value for "variation_key", variation_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ai_config_name.nil?
      return false if @variation_id.nil?
      return false if @variation_key.nil?
    ...
    # @param [Object] ai_config_key Value to be assigned
    def ai_config_key=(ai_config_key)
      if ai_config_key.nil?
        fail ArgumentError, 'ai_config_key cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ai_config_name Value to be assigned
    def ai_config_name=(ai_config_name)
      if ai_config_name.nil?
        fail ArgumentError, 'ai_config_name cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] variation_id Value to be assigned
    def variation_id=(variation_id)
      if variation_id.nil?
        fail ArgumentError, 'variation_id cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] variation_key Value to be assigned
    def variation_key=(variation_key)
      if variation_key.nil?
        fail ArgumentError, 'variation_key cannot be nil'
      end
    ...
    def variation_name=(variation_name)
      if variation_name.nil?
        fail ArgumentError, 'variation_name cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] resource_version Value to be assigned
    def resource_version=(resource_version)
      if resource_version.nil?
        fail ArgumentError, 'resource_version cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ai_config_name == o.ai_config_name &&
    ...
    def hash
      [ai_config_key, ai_config_name, variation_id, variation_key, variation_name, resource_version].hash
    end
