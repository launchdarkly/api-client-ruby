...
module LaunchDarklyApi
  class Destination < ApiModelBase
    ...
    # The ID of the member who maintains this Data Export destination
    attr_accessor :maintainer_id

    attr_accessor :_access

    attr_accessor :completed_artifacts
    ...
    def self.openapi_types
      {
        ...
        :'_access' => :'Access',
        :'completed_artifacts' => :'RedshiftDataExportCompletedArtifactsRep'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::Destination` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::Destination`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'completed_artifacts')
        self.completed_artifacts = attributes[:'completed_artifacts']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _access == o._access &&
          completed_artifacts == o.completed_artifacts
    end
    ...
    def hash
      [_id, _links, name, kind, version, config, on, created_at, maintainer_id, _access, completed_artifacts].hash
    end
