...
module LaunchDarklyApi
  class RandomizationSettingsPut
    ...
    def self.openapi_types
      {
        :'randomization_units' => :'Array<RandomizationUnitInput>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::RandomizationSettingsPut` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::RandomizationSettingsPut`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @randomization_units.nil?
        invalid_properties.push('invalid value for "randomization_units", randomization_units cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @randomization_units.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] randomization_units Value to be assigned
    def randomization_units=(randomization_units)
      if randomization_units.nil?
        fail ArgumentError, 'randomization_units cannot be nil'
      end
