  ...
  class IpList < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::IpList` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::IpList`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'outbound_addresses')
        if (value = attributes[:'outbound_addresses']).is_a?(Array)
          self.outbound_addresses = value
        end
      else
        self.outbound_addresses = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @outbound_addresses.nil?
        invalid_properties.push('invalid value for "outbound_addresses", outbound_addresses cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @outbound_addresses.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] outbound_addresses Value to be assigned
    def outbound_addresses=(outbound_addresses)
      if outbound_addresses.nil?
        fail ArgumentError, 'outbound_addresses cannot be nil'
      end

      @outbound_addresses = outbound_addresses
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          outbound_addresses == o.outbound_addresses
    end
    ...
    def hash
      [addresses, outbound_addresses].hash
    end
