...
module LaunchDarklyApi
  class ApprovalRequest
    ...
    def hash
      [_id, _version, creation_date, requestor_id, review_status, status, applied_by_member_id, applied_date, all_reviews, notify_member_ids, instructions, execution_date, operating_on_id].hash
    end
