...
module LaunchDarklyApi
  class InsightsMetricScore < ApiModelBase
    # The score for the metric
    attr_accessor :score

    # The keys of the metrics that were aggregated to calculate this score
    attr_accessor :aggregate_of

    attr_accessor :diff_vs_last_period

    attr_accessor :indicator

    attr_accessor :indicator_range
    ...
    def self.attribute_map
      {
        :'score' => :'score',
        :'aggregate_of' => :'aggregateOf',
        :'diff_vs_last_period' => :'diffVsLastPeriod',
        :'indicator' => :'indicator',
        :'indicator_range' => :'indicatorRange',
    ...
    def self.openapi_types
      {
        :'score' => :'Integer',
        :'aggregate_of' => :'Array<String>',
        :'diff_vs_last_period' => :'Integer',
        :'indicator' => :'String',
        :'indicator_range' => :'InsightsMetricIndicatorRange',
        :'last_period' => :'InsightsMetricScore'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::InsightsMetricScore` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::InsightsMetricScore`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'aggregate_of')
        if (value = attributes[:'aggregate_of']).is_a?(Array)
          self.aggregate_of = value
        end
      end

      if attributes.key?(:'diff_vs_last_period')
        self.diff_vs_last_period = attributes[:'diff_vs_last_period']
      end
      ...
      if attributes.key?(:'indicator_range')
        self.indicator_range = attributes[:'indicator_range']
      else
        self.indicator_range = nil
      end

      if attributes.key?(:'last_period')
        self.last_period = attributes[:'last_period']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @indicator_range.nil?
        invalid_properties.push('invalid value for "indicator_range", indicator_range cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @indicator_range.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] indicator Value to be assigned
    def indicator=(indicator)
      if indicator.nil?
        fail ArgumentError, 'indicator cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] indicator_range Value to be assigned
    def indicator_range=(indicator_range)
      if indicator_range.nil?
        fail ArgumentError, 'indicator_range cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          score == o.score &&
          aggregate_of == o.aggregate_of &&
          diff_vs_last_period == o.diff_vs_last_period &&
          indicator == o.indicator &&
          indicator_range == o.indicator_range &&
          last_period == o.last_period
    end
    ...
    def hash
      [score, aggregate_of, diff_vs_last_period, indicator, indicator_range, last_period].hash
    end
