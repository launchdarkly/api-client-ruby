...
module LaunchDarklyApi
  class MigrationSafetyIssueRep
    ...
    attr_accessor :affected_rule_ids
    ...
    attr_accessor :old_system_affected

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'causing_rule_id' => :'causingRuleId',
        :'affected_rule_ids' => :'affectedRuleIds',
        :'issue' => :'issue',
        :'old_system_affected' => :'oldSystemAffected'
      }
    end
    ...
    def self.openapi_types
      {
        :'causing_rule_id' => :'String',
        :'affected_rule_ids' => :'Array<String>',
        :'issue' => :'String',
        :'old_system_affected' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::MigrationSafetyIssueRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::MigrationSafetyIssueRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'causing_rule_id')
        self.causing_rule_id = attributes[:'causing_rule_id']
      end

      if attributes.key?(:'affected_rule_ids')
        if (value = attributes[:'affected_rule_ids']).is_a?(Array)
          self.affected_rule_ids = value
        end
      end
      ...
      if attributes.key?(:'old_system_affected')
        self.old_system_affected = attributes[:'old_system_affected']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          causing_rule_id == o.causing_rule_id &&
          affected_rule_ids == o.affected_rule_ids &&
          issue == o.issue &&
          old_system_affected == o.old_system_affected
    end
    ...
    def hash
      [causing_rule_id, affected_rule_ids, issue, old_system_affected].hash
    end
