...
module LaunchDarklyApi
  class FeatureFlagScheduledChange < ApiModelBase
    attr_accessor :_id
    ...
    attr_accessor :_maintainer_service_token_id
    ...
    def self.attribute_map
      {
        ...
        :'_maintainer_service_token_id' => :'_maintainerServiceTokenId',
        :'_version' => :'_version',
    ...
    def self.openapi_types
      {
        ...
        :'_maintainer_service_token_id' => :'String',
        :'_version' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::FeatureFlagScheduledChange` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::FeatureFlagScheduledChange`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_maintainer_service_token_id')
        self._maintainer_service_token_id = attributes[:'_maintainer_service_token_id']
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _maintainer_id Value to be assigned
    def _maintainer_id=(_maintainer_id)
      if _maintainer_id.nil?
        fail ArgumentError, '_maintainer_id cannot be nil'
      end

      @_maintainer_id = _maintainer_id
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] execution_date Value to be assigned
    def execution_date=(execution_date)
      if execution_date.nil?
        fail ArgumentError, 'execution_date cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _maintainer_service_token_id == o._maintainer_service_token_id &&
          _version == o._version &&
    ...
    def hash
      [_id, _creation_date, _maintainer_id, _maintainer_service_token_id, _version, execution_date, instructions, conflicts, _links].hash
    end
