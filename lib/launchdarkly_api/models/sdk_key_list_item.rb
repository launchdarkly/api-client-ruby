...
module LaunchDarklyApi
  class SdkKeyListItem < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'_updated_at' => :'Integer',
        :'_version' => :'Integer',
        :'environment_summary' => :'SdkKeysEnvironmentSummary'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::SdkKeyListItem` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::SdkKeyListItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'environment_summary')
        self.environment_summary = attributes[:'environment_summary']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _version == o._version &&
          environment_summary == o.environment_summary
    end
    ...
    def hash
      [_links, kind, key, name, description, expiry, value, is_default, _created_by_member_id, _created_at, _updated_at, _version, environment_summary].hash
    end
