...
module LaunchDarklyApi
  class InsightGroupsCountByIndicator < ApiModelBase
    # The number of insight groups with an excellent indicator
    attr_accessor :excellent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::InsightGroupsCountByIndicator` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::InsightGroupsCountByIndicator`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'excellent')
        self.excellent = attributes[:'excellent']
      else
        self.excellent = nil
      end

      if attributes.key?(:'good')
        self.good = attributes[:'good']
      else
        self.good = nil
      end

      if attributes.key?(:'fair')
        self.fair = attributes[:'fair']
      else
        self.fair = nil
      end

      if attributes.key?(:'needs_attention')
        self.needs_attention = attributes[:'needs_attention']
      else
        self.needs_attention = nil
      end

      if attributes.key?(:'not_calculated')
        self.not_calculated = attributes[:'not_calculated']
      else
        self.not_calculated = nil
      end
    ...
    def list_invalid_properties
      ...
      if @excellent.nil?
        invalid_properties.push('invalid value for "excellent", excellent cannot be nil.')
      end
      ...
      if @fair.nil?
        invalid_properties.push('invalid value for "fair", fair cannot be nil.')
      end

      if @needs_attention.nil?
        invalid_properties.push('invalid value for "needs_attention", needs_attention cannot be nil.')
      end

      if @not_calculated.nil?
        invalid_properties.push('invalid value for "not_calculated", not_calculated cannot be nil.')
      end

      if @unknown.nil?
        invalid_properties.push('invalid value for "unknown", unknown cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @excellent.nil?
      return false if @good.nil?
      return false if @fair.nil?
      return false if @needs_attention.nil?
      return false if @not_calculated.nil?
      return false if @unknown.nil?
      return false if @total.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] excellent Value to be assigned
    def excellent=(excellent)
      if excellent.nil?
        fail ArgumentError, 'excellent cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] fair Value to be assigned
    def fair=(fair)
      if fair.nil?
        fail ArgumentError, 'fair cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] needs_attention Value to be assigned
    def needs_attention=(needs_attention)
      if needs_attention.nil?
        fail ArgumentError, 'needs_attention cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] not_calculated Value to be assigned
    def not_calculated=(not_calculated)
      if not_calculated.nil?
        fail ArgumentError, 'not_calculated cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          not_calculated == o.not_calculated &&
          unknown == o.unknown &&
          total == o.total
    end
    ...
    def hash
      [excellent, good, fair, needs_attention, not_calculated, unknown, total].hash
    end
