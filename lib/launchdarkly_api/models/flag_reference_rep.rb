...
module LaunchDarklyApi
  class FlagReferenceRep < ApiModelBase
    # The project key
    ...
    attr_accessor :references_added

    # The number of references removed
    attr_accessor :references_removed
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::FlagReferenceRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::FlagReferenceRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'flag_key')
        self.flag_key = attributes[:'flag_key']
      else
        self.flag_key = nil
      end

      if attributes.key?(:'references_added')
        self.references_added = attributes[:'references_added']
      else
        self.references_added = nil
      end

      if attributes.key?(:'references_removed')
        self.references_removed = attributes[:'references_removed']
      else
        self.references_removed = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @references_added.nil?
        invalid_properties.push('invalid value for "references_added", references_added cannot be nil.')
      end

      if @references_removed.nil?
        invalid_properties.push('invalid value for "references_removed", references_removed cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @references_added.nil?
      return false if @references_removed.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] flag_key Value to be assigned
    def flag_key=(flag_key)
      if flag_key.nil?
        fail ArgumentError, 'flag_key cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] references_added Value to be assigned
    def references_added=(references_added)
      if references_added.nil?
        fail ArgumentError, 'references_added cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] references_removed Value to be assigned
    def references_removed=(references_removed)
      if references_removed.nil?
        fail ArgumentError, 'references_removed cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flag_key == o.flag_key &&
          references_added == o.references_added &&
          references_removed == o.references_removed
    end
    ...
    def hash
      [project_key, flag_key, references_added, references_removed].hash
    end
