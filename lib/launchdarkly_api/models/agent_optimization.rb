...
module LaunchDarklyApi
  class AgentOptimization < ApiModelBase
    ...
    attr_accessor :model_choices

    attr_accessor :judge_model

    attr_accessor :variable_choices

    attr_accessor :acceptance_statements

    attr_accessor :judges

    attr_accessor :user_input_options

    attr_accessor :ground_truth_responses

    attr_accessor :metric_key

    attr_accessor :token_limit

    attr_accessor :variation_key

    attr_accessor :label

    attr_accessor :latency_optimization

    attr_accessor :token_optimization
    ...
    # Custom attribute writer method with validation
    # @param [Object] model_choices Value to be assigned
    def model_choices=(model_choices)
      if model_choices.nil?
        fail ArgumentError, 'model_choices cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] judge_model Value to be assigned
    def judge_model=(judge_model)
      if judge_model.nil?
        fail ArgumentError, 'judge_model cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] variable_choices Value to be assigned
    def variable_choices=(variable_choices)
      if variable_choices.nil?
        fail ArgumentError, 'variable_choices cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] acceptance_statements Value to be assigned
    def acceptance_statements=(acceptance_statements)
      if acceptance_statements.nil?
        fail ArgumentError, 'acceptance_statements cannot be nil'
      end

      @acceptance_statements = acceptance_statements
    end

    # Custom attribute writer method with validation
    # @param [Object] judges Value to be assigned
    def judges=(judges)
      if judges.nil?
        fail ArgumentError, 'judges cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] user_input_options Value to be assigned
    def user_input_options=(user_input_options)
      if user_input_options.nil?
        fail ArgumentError, 'user_input_options cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ground_truth_responses Value to be assigned
    def ground_truth_responses=(ground_truth_responses)
      if ground_truth_responses.nil?
        fail ArgumentError, 'ground_truth_responses cannot be nil'
      end
