...
module LaunchDarklyApi
  class ConditionOutput < ApiModelBase
    attr_accessor :_id

    attr_accessor :kind

    attr_accessor :_execution
    ...
    attr_accessor :wait_duration_unit
    ...
    def self.attribute_map
      {
        ...
        :'wait_duration_unit' => :'waitDurationUnit',
    ...
    def self.openapi_types
      {
        ...
        :'wait_duration_unit' => :'String',
        :'description' => :'String',
        :'notify_member_ids' => :'Array<String>',
        :'all_reviews' => :'Array<ReviewOutput>',
        :'review_status' => :'String',
        :'applied_date' => :'Integer',
        :'creation_config' => :'Hash<String, Object>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ConditionOutput` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ConditionOutput`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'wait_duration')
        self.wait_duration = attributes[:'wait_duration']
      end

      if attributes.key?(:'wait_duration_unit')
        self.wait_duration_unit = attributes[:'wait_duration_unit']
      end
      ...
      if attributes.key?(:'creation_config')
        if (value = attributes[:'creation_config']).is_a?(Hash)
          self.creation_config = value
        end
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _execution Value to be assigned
    def _execution=(_execution)
      if _execution.nil?
        fail ArgumentError, '_execution cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          wait_duration == o.wait_duration &&
          wait_duration_unit == o.wait_duration_unit &&
          description == o.description &&
          notify_member_ids == o.notify_member_ids &&
          all_reviews == o.all_reviews &&
          review_status == o.review_status &&
          applied_date == o.applied_date &&
          creation_config == o.creation_config
    end
    ...
    def hash
      [_id, kind, _execution, schedule_kind, execution_date, wait_duration, wait_duration_unit, description, notify_member_ids, all_reviews, review_status, applied_date, creation_config].hash
    end
