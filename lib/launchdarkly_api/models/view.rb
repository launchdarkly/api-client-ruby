...
module LaunchDarklyApi
  class View < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if @generate_sdk_keys.nil?
        invalid_properties.push('invalid value for "generate_sdk_keys", generate_sdk_keys cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @generate_sdk_keys.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] generate_sdk_keys Value to be assigned
    def generate_sdk_keys=(generate_sdk_keys)
      if generate_sdk_keys.nil?
        fail ArgumentError, 'generate_sdk_keys cannot be nil'
      end
