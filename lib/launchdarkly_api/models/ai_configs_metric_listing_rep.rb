...
module LaunchDarklyApi
  class AiConfigsMetricListingRep < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'_links' => :'Hash<String, AiConfigsLink>',
        :'_site' => :'AiConfigsLink',
        :'_access' => :'AiConfigsAccess',
        :'tags' => :'Array<String>',
        :'_creation_date' => :'Integer',
        :'last_modified' => :'AiConfigsModification',
        ...
        :'denominator' => :'AiConfigsMetricDenominatorRep'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AiConfigsMetricListingRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AiConfigsMetricListingRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
