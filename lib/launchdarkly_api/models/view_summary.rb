...
module LaunchDarklyApi
  class ViewSummary < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ViewSummary` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ViewSummary`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @resource_summary.nil?
        invalid_properties.push('invalid value for "resource_summary", resource_summary cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @resource_summary.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] resource_summary Value to be assigned
    def resource_summary=(resource_summary)
      if resource_summary.nil?
        fail ArgumentError, 'resource_summary cannot be nil'
      end
    ...
    def hash
      [_links, key, name, resource_summary].hash
    end
