...
module LaunchDarklyApi
  class FeatureFlagConfig < ApiModelBase
    ...
    attr_accessor :_debug_events_until_date
    ...
    # Custom attribute writer method with validation
    # @param [Object] sel Value to be assigned
    def sel=(sel)
      if sel.nil?
        fail ArgumentError, 'sel cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _site Value to be assigned
    def _site=(_site)
      if _site.nil?
        fail ArgumentError, '_site cannot be nil'
      end
