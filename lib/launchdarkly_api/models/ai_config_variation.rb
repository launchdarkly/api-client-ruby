...
module LaunchDarklyApi
  class AIConfigVariation < ApiModelBase
    ...
    attr_accessor :model_config_key
    ...
    attr_accessor :_archived_at

    attr_accessor :_published_at

    attr_accessor :tools

    attr_accessor :skills

    attr_accessor :judge_configuration

    attr_accessor :judging_config_keys
    ...
    def self.attribute_map
      {
        ...
        :'version' => :'version',
        :'state' => :'state',
        :'_archived_at' => :'_archivedAt',
        :'_published_at' => :'_publishedAt',
        :'tools' => :'tools',
        :'skills' => :'skills',
        :'judge_configuration' => :'judgeConfiguration',
        :'judging_config_keys' => :'judgingConfigKeys'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'output_format' => :'Hash<String, Object>',
        :'created_at' => :'Integer',
        :'version' => :'Integer',
        :'state' => :'String',
        :'_archived_at' => :'Integer',
        :'_published_at' => :'Integer',
        :'tools' => :'Array<VariationTool>',
        :'skills' => :'Array<VariationSkill>',
        :'judge_configuration' => :'JudgeConfiguration',
        :'judging_config_keys' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AIConfigVariation` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AIConfigVariation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'model_config_key')
        self.model_config_key = attributes[:'model_config_key']
      end
      ...
      if attributes.key?(:'output_format')
        if (value = attributes[:'output_format']).is_a?(Hash)
      ...
      if attributes.key?(:'_archived_at')
        self._archived_at = attributes[:'_archived_at']
      end

      if attributes.key?(:'_published_at')
        self._published_at = attributes[:'_published_at']
      end
      ...
      if attributes.key?(:'judge_configuration')
        self.judge_configuration = attributes[:'judge_configuration']
      end

      if attributes.key?(:'judging_config_keys')
        if (value = attributes[:'judging_config_keys']).is_a?(Array)
          self.judging_config_keys = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          messages == o.messages &&
          model == o.model &&
          model_config_key == o.model_config_key &&
          name == o.name &&
          output_format == o.output_format &&
          created_at == o.created_at &&
          version == o.version &&
          state == o.state &&
          _archived_at == o._archived_at &&
          _published_at == o._published_at &&
          tools == o.tools &&
          skills == o.skills &&
          judge_configuration == o.judge_configuration &&
          judging_config_keys == o.judging_config_keys
    end
    ...
    def hash
      [_links, color, comment, description, instructions, key, _id, messages, model, model_config_key, name, output_format, created_at, version, state, _archived_at, _published_at, tools, skills, judge_configuration, judging_config_keys].hash
    end
