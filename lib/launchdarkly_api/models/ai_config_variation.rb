...
module LaunchDarklyApi
  class AIConfigVariation < ApiModelBase
    ...
    def hash
      [_links, color, comment, description, instructions, key, _id, messages, model, model_config_key, name, output_format, created_at, version, state, _archived_at, _published_at, tools, judge_configuration, judging_config_keys].hash
    end
