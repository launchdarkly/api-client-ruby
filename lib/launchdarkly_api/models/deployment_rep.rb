...
module LaunchDarklyApi
  class DeploymentRep < ApiModelBase
    # The deployment ID
    attr_accessor :id
    ...
    attr_accessor :number_of_contributors
    ...
    attr_accessor :flag_references

    attr_accessor :lead_time_stages
    ...
    def self.attribute_map
      {
        ...
        :'number_of_pull_requests' => :'numberOfPullRequests',
    ...
    def self.openapi_types
      {
        ...
        :'lead_time' => :'Integer',
        :'pull_requests' => :'PullRequestCollectionRep',
        :'flag_references' => :'FlagReferenceCollectionRep',
        :'lead_time_stages' => :'LeadTimeStagesRep'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::DeploymentRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::DeploymentRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'lead_time_stages')
        self.lead_time_stages = attributes[:'lead_time_stages']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @application_version.nil?
        invalid_properties.push('invalid value for "application_version", application_version cannot be nil.')
      end
      ...
      if @number_of_contributors.nil?
        invalid_properties.push('invalid value for "number_of_contributors", number_of_contributors cannot be nil.')
      end

      if @number_of_pull_requests.nil?
        invalid_properties.push('invalid value for "number_of_pull_requests", number_of_pull_requests cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @application_version.nil?
      ...
      return false if @number_of_contributors.nil?
      return false if @number_of_pull_requests.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] application_version Value to be assigned
    def application_version=(application_version)
      if application_version.nil?
        fail ArgumentError, 'application_version cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] number_of_contributors Value to be assigned
    def number_of_contributors=(number_of_contributors)
      if number_of_contributors.nil?
        fail ArgumentError, 'number_of_contributors cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] number_of_pull_requests Value to be assigned
    def number_of_pull_requests=(number_of_pull_requests)
      if number_of_pull_requests.nil?
        fail ArgumentError, 'number_of_pull_requests cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] lines_added Value to be assigned
    def lines_added=(lines_added)
      if lines_added.nil?
        fail ArgumentError, 'lines_added cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] lines_deleted Value to be assigned
    def lines_deleted=(lines_deleted)
      if lines_deleted.nil?
        fail ArgumentError, 'lines_deleted cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          number_of_contributors == o.number_of_contributors &&
          ...
          lead_time_stages == o.lead_time_stages
    end
    ...
    def hash
      [id, application_key, application_version, started_at, ended_at, duration_ms, status, kind, active, metadata, archived, environment_key, number_of_contributors, number_of_pull_requests, lines_added, lines_deleted, lead_time, pull_requests, flag_references, lead_time_stages].hash
    end
