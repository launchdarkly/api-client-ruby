...
module LaunchDarklyApi
  class ApprovalRequestSettingsPatch < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ApprovalRequestSettingsPatch` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ApprovalRequestSettingsPatch`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @resource_kind.nil?
        invalid_properties.push('invalid value for "resource_kind", resource_kind cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @resource_kind.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] resource_kind Value to be assigned
    def resource_kind=(resource_kind)
      if resource_kind.nil?
        fail ArgumentError, 'resource_kind cannot be nil'
      end
    ...
    def hash
      [auto_apply_approved_changes, bypass_approvals_for_pending_changes, can_apply_declined_changes, can_review_own_request, environment_key, min_num_approvals, required, required_approval_tags, resource_kind, service_config, service_kind, service_kind_configuration_id].hash
    end
