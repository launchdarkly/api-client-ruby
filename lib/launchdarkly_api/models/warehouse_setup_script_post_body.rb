...
module LaunchDarklyApi
  class WarehouseSetupScriptPostBody < ApiModelBase
    attr_accessor :name

    attr_accessor :snowflake_host_address
    ...
    attr_accessor :include_network_policy

    attr_accessor :cluster_identifier

    attr_accessor :cluster_region

    attr_accessor :cluster_aws_account_id

    attr_accessor :endpoint

    attr_accessor :click_house_database_name

    attr_accessor :click_house_user_name

    attr_accessor :click_house_s3_bucket_name

    attr_accessor :click_house_include_host_restriction

    attr_accessor :click_house_service_role_arn

    attr_accessor :click_house_password
    ...
    def self.attribute_map
      {
        :'name' => :'name',
        :'snowflake_host_address' => :'snowflakeHostAddress',
        :'database_name' => :'databaseName',
        :'warehouse_name' => :'warehouseName',
        :'role_name' => :'roleName',
        :'schema_name' => :'schemaName',
        :'user_name' => :'userName',
        :'include_network_policy' => :'includeNetworkPolicy',
        :'cluster_identifier' => :'clusterIdentifier',
        :'cluster_region' => :'clusterRegion',
        :'cluster_aws_account_id' => :'clusterAwsAccountId',
        :'endpoint' => :'endpoint',
        :'click_house_database_name' => :'clickHouseDatabaseName',
        :'click_house_user_name' => :'clickHouseUserName',
        :'click_house_s3_bucket_name' => :'clickHouseS3BucketName',
        :'click_house_include_host_restriction' => :'clickHouseIncludeHostRestriction',
        :'click_house_service_role_arn' => :'clickHouseServiceRoleArn',
        :'click_house_password' => :'clickHousePassword',
    ...
    def self.openapi_types
      {
        :'name' => :'String',
        :'snowflake_host_address' => :'String',
        :'database_name' => :'String',
        :'warehouse_name' => :'String',
        :'role_name' => :'String',
        :'schema_name' => :'String',
        :'user_name' => :'String',
        :'include_network_policy' => :'Boolean',
        :'cluster_identifier' => :'String',
        :'cluster_region' => :'String',
        :'cluster_aws_account_id' => :'String',
        :'endpoint' => :'String',
        :'click_house_database_name' => :'String',
        :'click_house_user_name' => :'String',
        :'click_house_s3_bucket_name' => :'String',
        :'click_house_include_host_restriction' => :'Boolean',
        :'click_house_service_role_arn' => :'String',
        :'click_house_password' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::WarehouseSetupScriptPostBody` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::WarehouseSetupScriptPostBody`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'snowflake_host_address')
        self.snowflake_host_address = attributes[:'snowflake_host_address']
      end
      ...
      if attributes.key?(:'include_network_policy')
        self.include_network_policy = attributes[:'include_network_policy']
      end
      ...
      if attributes.key?(:'cluster_region')
        self.cluster_region = attributes[:'cluster_region']
      end

      if attributes.key?(:'cluster_aws_account_id')
        self.cluster_aws_account_id = attributes[:'cluster_aws_account_id']
      end
      ...
      if attributes.key?(:'click_house_database_name')
        self.click_house_database_name = attributes[:'click_house_database_name']
      end

      if attributes.key?(:'click_house_user_name')
        self.click_house_user_name = attributes[:'click_house_user_name']
      end

      if attributes.key?(:'click_house_s3_bucket_name')
        self.click_house_s3_bucket_name = attributes[:'click_house_s3_bucket_name']
      end

      if attributes.key?(:'click_house_include_host_restriction')
        self.click_house_include_host_restriction = attributes[:'click_house_include_host_restriction']
      end

      if attributes.key?(:'click_house_service_role_arn')
        self.click_house_service_role_arn = attributes[:'click_house_service_role_arn']
      end

      if attributes.key?(:'click_house_password')
        self.click_house_password = attributes[:'click_house_password']
      end

      if attributes.key?(:'s3_bucket_name')
        self.s3_bucket_name = attributes[:'s3_bucket_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          snowflake_host_address == o.snowflake_host_address &&
          database_name == o.database_name &&
          warehouse_name == o.warehouse_name &&
          role_name == o.role_name &&
          schema_name == o.schema_name &&
          user_name == o.user_name &&
          include_network_policy == o.include_network_policy &&
          cluster_identifier == o.cluster_identifier &&
          cluster_region == o.cluster_region &&
          cluster_aws_account_id == o.cluster_aws_account_id &&
          endpoint == o.endpoint &&
          click_house_database_name == o.click_house_database_name &&
          click_house_user_name == o.click_house_user_name &&
          click_house_s3_bucket_name == o.click_house_s3_bucket_name &&
          click_house_include_host_restriction == o.click_house_include_host_restriction &&
          click_house_service_role_arn == o.click_house_service_role_arn &&
          click_house_password == o.click_house_password &&
    ...
    def hash
      [name, snowflake_host_address, database_name, warehouse_name, role_name, schema_name, user_name, include_network_policy, cluster_identifier, cluster_region, cluster_aws_account_id, endpoint, click_house_database_name, click_house_user_name, click_house_s3_bucket_name, click_house_include_host_restriction, click_house_service_role_arn, click_house_password, s3_bucket_name].hash
    end
