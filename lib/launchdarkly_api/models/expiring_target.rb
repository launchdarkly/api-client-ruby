...
module LaunchDarklyApi
  class ExpiringTarget < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ExpiringTarget` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ExpiringTarget`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_resource_id')
        self._resource_id = attributes[:'_resource_id']
      else
    ...
    def list_invalid_properties
      ...
      if @context_kind.nil?
        invalid_properties.push('invalid value for "context_kind", context_kind cannot be nil.')
      end

      if @context_key.nil?
        invalid_properties.push('invalid value for "context_key", context_key cannot be nil.')
      end

      if @_resource_id.nil?
        invalid_properties.push('invalid value for "_resource_id", _resource_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @context_kind.nil?
      return false if @context_key.nil?
      return false if @_resource_id.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] context_kind Value to be assigned
    def context_kind=(context_kind)
      if context_kind.nil?
        fail ArgumentError, 'context_kind cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] context_key Value to be assigned
    def context_key=(context_key)
      if context_key.nil?
        fail ArgumentError, 'context_key cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _resource_id Value to be assigned
    def _resource_id=(_resource_id)
      if _resource_id.nil?
        fail ArgumentError, '_resource_id cannot be nil'
      end
    ...
    def hash
      [_id, _version, expiration_date, context_kind, context_key, target_type, variation_id, _resource_id].hash
    end
