...
module LaunchDarklyApi
  class PostDeploymentEventInput < ApiModelBase
    # The project key
    ...
    attr_accessor :application_kind
    ...
    def self.openapi_types
      {
        ...
        :'event_type' => :'String',
        :'event_time' => :'Integer',
        :'event_metadata' => :'Hash<String, Object>',
        :'deployment_metadata' => :'Hash<String, Object>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::PostDeploymentEventInput` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::PostDeploymentEventInput`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'application_kind')
        self.application_kind = attributes[:'application_kind']
      end
      ...
      if attributes.key?(:'event_metadata')
        if (value = attributes[:'event_metadata']).is_a?(Hash)
          self.event_metadata = value
        end
      end

      if attributes.key?(:'deployment_metadata')
        if (value = attributes[:'deployment_metadata']).is_a?(Hash)
          self.deployment_metadata = value
        end
      end
    end
    ...
    def valid?
      ...
      application_kind_validator = EnumAttributeValidator.new('String', ["server", "browser", "mobile"])
      return false unless application_kind_validator.valid?(@application_kind)
      return false if @version.nil?
      return false if @event_type.nil?
      event_type_validator = EnumAttributeValidator.new('String', ["started", "failed", "finished", "custom"])
    ...
    # @param [Object] application_kind Object to be assigned
    def application_kind=(application_kind)
      validator = EnumAttributeValidator.new('String', ["server", "browser", "mobile"])
      unless validator.valid?(application_kind)
        fail ArgumentError, "invalid value for \"application_kind\", must be one of #{validator.allowable_values}."
      end
    ...
    def event_type=(event_type)
      validator = EnumAttributeValidator.new('String', ["started", "failed", "finished", "custom"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          application_kind == o.application_kind &&
          version == o.version &&
          version_name == o.version_name &&
          event_type == o.event_type &&
          event_time == o.event_time &&
          event_metadata == o.event_metadata &&
          deployment_metadata == o.deployment_metadata
    end
    ...
    def hash
      [project_key, environment_key, application_key, application_name, application_kind, version, version_name, event_type, event_time, event_metadata, deployment_metadata].hash
    end
