...
module LaunchDarklyApi
  class VariationSummary < ApiModelBase
    attr_accessor :rules

    attr_accessor :null_rules

    attr_accessor :targets

    attr_accessor :context_targets

    attr_accessor :is_fallthrough

    attr_accessor :is_off
    ...
    def self.attribute_map
      {
        :'rules' => :'rules',
        :'null_rules' => :'nullRules',
        :'targets' => :'targets',
        :'context_targets' => :'contextTargets',
        :'is_fallthrough' => :'isFallthrough',
        :'is_off' => :'isOff',
        :'rollout' => :'rollout',
        :'bucket_by' => :'bucketBy'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::VariationSummary` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::VariationSummary`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'null_rules')
        self.null_rules = attributes[:'null_rules']
      else
        self.null_rules = nil
      end
      ...
      if attributes.key?(:'context_targets')
        self.context_targets = attributes[:'context_targets']
      else
        self.context_targets = nil
      end

      if attributes.key?(:'is_fallthrough')
        self.is_fallthrough = attributes[:'is_fallthrough']
      end

      if attributes.key?(:'is_off')
        self.is_off = attributes[:'is_off']
      end
    ...
    def list_invalid_properties
      ...
      if @null_rules.nil?
        invalid_properties.push('invalid value for "null_rules", null_rules cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @null_rules.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] null_rules Value to be assigned
    def null_rules=(null_rules)
      if null_rules.nil?
        fail ArgumentError, 'null_rules cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] context_targets Value to be assigned
    def context_targets=(context_targets)
      if context_targets.nil?
        fail ArgumentError, 'context_targets cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          rules == o.rules &&
          null_rules == o.null_rules &&
          targets == o.targets &&
          context_targets == o.context_targets &&
          is_fallthrough == o.is_fallthrough &&
          is_off == o.is_off &&
          rollout == o.rollout &&
    ...
    def hash
      [rules, null_rules, targets, context_targets, is_fallthrough, is_off, rollout, bucket_by].hash
    end
