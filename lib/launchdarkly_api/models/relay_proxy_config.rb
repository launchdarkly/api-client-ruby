...
module LaunchDarklyApi
  class RelayProxyConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'_creator')
      ...
      if attributes.has_key?(:'fullKey')
        self.full_key = attributes[:'fullKey']
      end

      if attributes.has_key?(:'displayKey')
        self.display_key = attributes[:'displayKey']
      end
    ...
    def list_invalid_properties
      ...
      if @_creator.nil?
        invalid_properties.push('invalid value for "_creator", _creator cannot be nil.')
      end
    ...
    def hash
      [_id, _creator, name, policy, full_key, display_key, creation_date, last_modified].hash
    end
