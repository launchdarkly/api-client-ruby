...
module LaunchDarklyApi
  class IterationRep
    ...
    def hash
      [_id, hypothesis, status, created_at, started_at, ended_at, winning_treatment_id, winning_reason, can_reshuffle_traffic, flags, primary_metric, treatments, secondary_metrics].hash
    end
