...
module LaunchDarklyApi
  class InsightsRepositoryProject < ApiModelBase
    # The repository key
    attr_accessor :repository_key
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::InsightsRepositoryProject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::InsightsRepositoryProject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'repository_key')
        self.repository_key = attributes[:'repository_key']
      else
        self.repository_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @repository_key.nil?
        invalid_properties.push('invalid value for "repository_key", repository_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @repository_key.nil?
      return false if @project_key.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] repository_key Value to be assigned
    def repository_key=(repository_key)
      if repository_key.nil?
        fail ArgumentError, 'repository_key cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          repository_key == o.repository_key &&
    ...
    def hash
      [repository_key, project_key].hash
    end
