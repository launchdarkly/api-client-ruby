...
module LaunchDarklyApi
  class RandomizationUnitInput
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::RandomizationUnitInput`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] randomization_unit Value to be assigned
    def randomization_unit=(randomization_unit)
      if randomization_unit.nil?
        fail ArgumentError, 'randomization_unit cannot be nil'
      end
