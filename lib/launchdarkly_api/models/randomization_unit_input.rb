...
module LaunchDarklyApi
  class RandomizationUnitInput
    ...
    attr_accessor :standard_randomization_unit
    ...
    def self.attribute_map
      {
        ...
        :'default' => :'default',
        :'standard_randomization_unit' => :'standardRandomizationUnit'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'default' => :'Boolean',
        :'standard_randomization_unit' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::RandomizationUnitInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::RandomizationUnitInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'standard_randomization_unit')
        self.standard_randomization_unit = attributes[:'standard_randomization_unit']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @randomization_unit.nil?
        invalid_properties.push('invalid value for "randomization_unit", randomization_unit cannot be nil.')
      end
      ...
      if @standard_randomization_unit.nil?
        invalid_properties.push('invalid value for "standard_randomization_unit", standard_randomization_unit cannot be nil.')
      end
    ...
    def valid?
      return false if @randomization_unit.nil?
      return false if @default.nil?
      return false if @standard_randomization_unit.nil?
      standard_randomization_unit_validator = EnumAttributeValidator.new('String', ["guest", "guestTime", "organization", "request", "user", "userTime"])
      return false unless standard_randomization_unit_validator.valid?(@standard_randomization_unit)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] standard_randomization_unit Object to be assigned
    def standard_randomization_unit=(standard_randomization_unit)
      validator = EnumAttributeValidator.new('String', ["guest", "guestTime", "organization", "request", "user", "userTime"])
      unless validator.valid?(standard_randomization_unit)
        fail ArgumentError, "invalid value for \"standard_randomization_unit\", must be one of #{validator.allowable_values}."
      end
      @standard_randomization_unit = standard_randomization_unit
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          default == o.default &&
          standard_randomization_unit == o.standard_randomization_unit
    end
    ...
    def hash
      [randomization_unit, default, standard_randomization_unit].hash
    end
