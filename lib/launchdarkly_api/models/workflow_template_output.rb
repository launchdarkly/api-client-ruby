...
module LaunchDarklyApi
  class WorkflowTemplateOutput < ApiModelBase
    attr_accessor :_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::WorkflowTemplateOutput` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::WorkflowTemplateOutput`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_owner_id')
        self._owner_id = attributes[:'_owner_id']
      else
        self._owner_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @_key.nil?
        invalid_properties.push('invalid value for "_key", _key cannot be nil.')
      end
      ...
      if @_owner_id.nil?
        invalid_properties.push('invalid value for "_owner_id", _owner_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @_key.nil?
      return false if @_creation_date.nil?
      return false if @_owner_id.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] _key Value to be assigned
    def _key=(_key)
      if _key.nil?
        fail ArgumentError, '_key cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _owner_id Value to be assigned
    def _owner_id=(_owner_id)
      if _owner_id.nil?
        fail ArgumentError, '_owner_id cannot be nil'
      end
    ...
    def hash
      [_id, _key, name, _creation_date, _owner_id, _maintainer_id, _links, description, stages].hash
    end
