...
module LaunchDarklyApi
  class SdkVersionRep < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::SdkVersionRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::SdkVersionRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @sdk.nil?
        invalid_properties.push('invalid value for "sdk", sdk cannot be nil.')
      end
    ...
    # @param [Object] sdk Value to be assigned
    def sdk=(sdk)
      if sdk.nil?
        fail ArgumentError, 'sdk cannot be nil'
      end
