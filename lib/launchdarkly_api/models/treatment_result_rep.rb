...
module LaunchDarklyApi
  class TreatmentResultRep
    ...
    # The number of end users in this variation of the experiment
    attr_accessor :units
    ...
    def hash
      [treatment_id, treatment_name, mean, credible_interval, p_best, relative_differences, units, distribution].hash
    end
