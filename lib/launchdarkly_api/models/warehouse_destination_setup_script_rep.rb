...
module LaunchDarklyApi
  class WarehouseDestinationSetupScriptRep < ApiModelBase
    ...
    attr_accessor :public_key_pkcs8
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::WarehouseDestinationSetupScriptRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::WarehouseDestinationSetupScriptRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'public_key_pkcs8')
        self.public_key_pkcs8 = attributes[:'public_key_pkcs8']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          public_key_pkcs8 == o.public_key_pkcs8 &&
    ...
    def hash
      [script, public_key, public_key_pkcs8, redshift_iam_permissions_policy, redshift_iam_trust_policy, s3_bucket_name].hash
    end
