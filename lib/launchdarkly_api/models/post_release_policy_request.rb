...
module LaunchDarklyApi
  class PostReleasePolicyRequest < ApiModelBase
    attr_accessor :scope
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::PostReleasePolicyRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::PostReleasePolicyRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'release_method')
        self.release_method = attributes[:'release_method']
      else
        self.release_method = nil
      end

      if attributes.key?(:'guarded_release_config')
        self.guarded_release_config = attributes[:'guarded_release_config']
      end

      if attributes.key?(:'progressive_release_config')
        self.progressive_release_config = attributes[:'progressive_release_config']
      end
    ...
    def list_invalid_properties
      ...
      if @release_method.nil?
        invalid_properties.push('invalid value for "release_method", release_method cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @release_method.nil?
    ...
    # @param [Object] release_method Value to be assigned
    def release_method=(release_method)
      if release_method.nil?
        fail ArgumentError, 'release_method cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          guarded_release_config == o.guarded_release_config &&
          progressive_release_config == o.progressive_release_config &&
          name == o.name &&
          key == o.key
    end
    ...
    def hash
      [scope, release_method, guarded_release_config, progressive_release_config, name, key].hash
    end
