...
module LaunchDarklyApi
  class ExperimentBayesianResultsRep
    ...
    attr_accessor :treatment_results

    attr_accessor :metric_seen

    # The probability of a Sample Ratio Mismatch
    attr_accessor :probability_of_mismatch
    ...
    def self.attribute_map
      {
        ...
        :'metric_seen' => :'metricSeen',
        :'probability_of_mismatch' => :'probabilityOfMismatch',
        :'results' => :'results'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'treatment_results' => :'Array<TreatmentResultRep>',
        :'metric_seen' => :'MetricSeen',
        :'probability_of_mismatch' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ExperimentBayesianResultsRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ExperimentBayesianResultsRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'treatment_results')
        if (value = attributes[:'treatment_results']).is_a?(Array)
          self.treatment_results = value
        end
      end

      if attributes.key?(:'metric_seen')
        self.metric_seen = attributes[:'metric_seen']
      end

      if attributes.key?(:'probability_of_mismatch')
        self.probability_of_mismatch = attributes[:'probability_of_mismatch']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _links == o._links &&
          treatment_results == o.treatment_results &&
          metric_seen == o.metric_seen &&
          probability_of_mismatch == o.probability_of_mismatch &&
          results == o.results
    end
    ...
    def hash
      [_links, treatment_results, metric_seen, probability_of_mismatch, results].hash
    end
