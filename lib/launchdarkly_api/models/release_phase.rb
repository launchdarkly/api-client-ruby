...
module LaunchDarklyApi
  class ReleasePhase < ApiModelBase
    # The phase ID
    attr_accessor :_id
    ...
    def self.attribute_map
      {
        ...
        :'_completion_date' => :'_completionDate',
        :'_completed_by' => :'_completedBy',
        :'_audiences' => :'_audiences',
        :'status' => :'status',
        :'started' => :'started',
        :'_started_date' => :'_startedDate',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ReleasePhase` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ReleasePhase`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_completion_date')
        self._completion_date = attributes[:'_completion_date']
      end

      if attributes.key?(:'_completed_by')
        self._completed_by = attributes[:'_completed_by']
      end

      if attributes.key?(:'_audiences')
        if (value = attributes[:'_audiences']).is_a?(Array)
      ...
      if attributes.key?(:'_started_date')
        self._started_date = attributes[:'_started_date']
      end
    ...
    def list_invalid_properties
      ...
      if @_name.nil?
        invalid_properties.push('invalid value for "_name", _name cannot be nil.')
      end
      ...
      if @_audiences.nil?
        invalid_properties.push('invalid value for "_audiences", _audiences cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _name Value to be assigned
    def _name=(_name)
      if _name.nil?
        fail ArgumentError, '_name cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] complete Value to be assigned
    def complete=(complete)
      if complete.nil?
        fail ArgumentError, 'complete cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] _audiences Value to be assigned
    def _audiences=(_audiences)
      if _audiences.nil?
        fail ArgumentError, '_audiences cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _completion_date == o._completion_date &&
          _completed_by == o._completed_by &&
          _audiences == o._audiences &&
          status == o.status &&
          started == o.started &&
          _started_date == o._started_date &&
    ...
    def hash
      [_id, _name, complete, _creation_date, _completion_date, _completed_by, _audiences, status, started, _started_date, configuration].hash
    end
