...
module LaunchDarklyApi
  class InsightsChartMetadata < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'metrics' => :'Hash<String, InsightsChartMetric>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::InsightsChartMetadata` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::InsightsChartMetadata`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'y_axis')
        self.y_axis = attributes[:'y_axis']
      else
        self.y_axis = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @x_axis.nil?
        invalid_properties.push('invalid value for "x_axis", x_axis cannot be nil.')
      end

      if @y_axis.nil?
        invalid_properties.push('invalid value for "y_axis", y_axis cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @x_axis.nil?
      return false if @y_axis.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] x_axis Value to be assigned
    def x_axis=(x_axis)
      if x_axis.nil?
        fail ArgumentError, 'x_axis cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] y_axis Value to be assigned
    def y_axis=(y_axis)
      if y_axis.nil?
        fail ArgumentError, 'y_axis cannot be nil'
      end
    ...
    def hash
      [summary, name, metrics, x_axis, y_axis].hash
    end
