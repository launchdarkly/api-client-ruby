...
module LaunchDarklyApi
  class CapabilityConfigRep
    ...
    attr_accessor :audit_log_events_hook

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'approvals' => :'approvals',
        :'audit_log_events_hook' => :'auditLogEventsHook'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'audit_log_events_hook' => :'AuditLogEventsHookCapabilityConfigRep'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::CapabilityConfigRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::CapabilityConfigRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'audit_log_events_hook')
        self.audit_log_events_hook = attributes[:'audit_log_events_hook']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          audit_log_events_hook == o.audit_log_events_hook
    end
    ...
    def hash
      [approvals, audit_log_events_hook].hash
    end
