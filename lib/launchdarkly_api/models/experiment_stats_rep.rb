...
module LaunchDarklyApi
  class ExperimentStatsRep
    ...
    attr_accessor :winning_variation_idx

    attr_accessor :min_sample_size_met
    ...
    def self.attribute_map
      {
        :'p_value' => :'pValue',
        :'chi2' => :'chi2',
        :'winning_variation_idx' => :'winningVariationIdx',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ExperimentStatsRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ExperimentStatsRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'chi2')
        self.chi2 = attributes[:'chi2']
      end

      if attributes.key?(:'winning_variation_idx')
        self.winning_variation_idx = attributes[:'winning_variation_idx']
      end

      if attributes.key?(:'min_sample_size_met')
        self.min_sample_size_met = attributes[:'min_sample_size_met']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          p_value == o.p_value &&
          chi2 == o.chi2 &&
          winning_variation_idx == o.winning_variation_idx &&
          min_sample_size_met == o.min_sample_size_met
    end
    ...
    def hash
      [p_value, chi2, winning_variation_idx, min_sample_size_met].hash
    end
