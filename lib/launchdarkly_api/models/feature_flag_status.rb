...
module LaunchDarklyApi
  class FeatureFlagStatus < ApiModelBase
    # Status of the flag
    attr_accessor :name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::FeatureFlagStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::FeatureFlagStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_requested')
        self.last_requested = attributes[:'last_requested']
      end
    ...
    def valid?
      ...
      name_validator = EnumAttributeValidator.new('String', ["new", "inactive", "active", "launched"])
    ...
    def name=(name)
      validator = EnumAttributeValidator.new('String', ["new", "inactive", "active", "launched"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          last_requested == o.last_requested &&
          default == o.default
    end
    ...
    def hash
      [name, last_requested, default].hash
    end
