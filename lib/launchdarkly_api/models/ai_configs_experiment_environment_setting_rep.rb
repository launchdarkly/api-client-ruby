  ...
  class AiConfigsExperimentEnvironmentSettingRep
    ...
    def self.openapi_types
      {
        :'start_date' => :'Integer',
        :'stop_date' => :'Integer',
        :'enabled_periods' => :'Array<AiConfigsExperimentEnabledPeriodRep>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::AiConfigsExperimentEnvironmentSettingRep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::AiConfigsExperimentEnvironmentSettingRep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enabled_periods')
        if (value = attributes[:'enabled_periods']).is_a?(Array)
          self.enabled_periods = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled_periods == o.enabled_periods
    end
    ...
    def hash
      [start_date, stop_date, enabled_periods].hash
    end
