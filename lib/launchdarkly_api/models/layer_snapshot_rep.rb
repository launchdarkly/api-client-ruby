...
module LaunchDarklyApi
  class LayerSnapshotRep < ApiModelBase
    ...
    attr_accessor :reservation_percent
    ...
    attr_accessor :other_reservation_percent
    ...
    def self.attribute_map
      {
        ...
        :'other_reservation_percent' => :'otherReservationPercent'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'other_reservation_percent' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::LayerSnapshotRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::LayerSnapshotRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reservation_percent')
        self.reservation_percent = attributes[:'reservation_percent']
      else
        self.reservation_percent = nil
      end

      if attributes.key?(:'other_reservation_percent')
        self.other_reservation_percent = attributes[:'other_reservation_percent']
      else
        self.other_reservation_percent = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @reservation_percent.nil?
        invalid_properties.push('invalid value for "reservation_percent", reservation_percent cannot be nil.')
      end

      if @other_reservation_percent.nil?
        invalid_properties.push('invalid value for "other_reservation_percent", other_reservation_percent cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @reservation_percent.nil?
      return false if @other_reservation_percent.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] reservation_percent Value to be assigned
    def reservation_percent=(reservation_percent)
      if reservation_percent.nil?
        fail ArgumentError, 'reservation_percent cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] other_reservation_percent Value to be assigned
    def other_reservation_percent=(other_reservation_percent)
      if other_reservation_percent.nil?
        fail ArgumentError, 'other_reservation_percent cannot be nil'
      end

      @other_reservation_percent = other_reservation_percent
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          key == o.key &&
          name == o.name &&
          reservation_percent == o.reservation_percent &&
          other_reservation_percent == o.other_reservation_percent
    end
    ...
    def hash
      [key, name, reservation_percent, other_reservation_percent].hash
    end
