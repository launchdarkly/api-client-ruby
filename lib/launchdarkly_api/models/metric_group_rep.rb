...
module LaunchDarklyApi
  class MetricGroupRep < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::MetricGroupRep` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::MetricGroupRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_last_modified')
        self._last_modified = attributes[:'_last_modified']
      else
        self._last_modified = nil
      end
    ...
    def list_invalid_properties
      ...
      if @_last_modified.nil?
        invalid_properties.push('invalid value for "_last_modified", _last_modified cannot be nil.')
      end

      if @maintainer.nil?
        invalid_properties.push('invalid value for "maintainer", maintainer cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @_last_modified.nil?
      return false if @maintainer.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] _last_modified Value to be assigned
    def _last_modified=(_last_modified)
      if _last_modified.nil?
        fail ArgumentError, '_last_modified cannot be nil'
      end
    ...
    def maintainer=(maintainer)
      if maintainer.nil?
        fail ArgumentError, 'maintainer cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _last_modified == o._last_modified &&
