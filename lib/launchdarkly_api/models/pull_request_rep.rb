...
module LaunchDarklyApi
  class PullRequestRep < ApiModelBase
    ...
    attr_accessor :merge_commit_key

    # The pull request base commit key
    attr_accessor :base_commit_key

    # The pull request head commit key
    attr_accessor :head_commit_key
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::PullRequestRep`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def create_time=(create_time)
      if create_time.nil?
        fail ArgumentError, 'create_time cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] base_commit_key Value to be assigned
    def base_commit_key=(base_commit_key)
      if base_commit_key.nil?
        fail ArgumentError, 'base_commit_key cannot be nil'
      end

      @base_commit_key = base_commit_key
    end

    # Custom attribute writer method with validation
    # @param [Object] head_commit_key Value to be assigned
    def head_commit_key=(head_commit_key)
      if head_commit_key.nil?
        fail ArgumentError, 'head_commit_key cannot be nil'
      end

      @head_commit_key = head_commit_key
    end
