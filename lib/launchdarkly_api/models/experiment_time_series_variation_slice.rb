  ...
  class ExperimentTimeSeriesVariationSlice
    ...
    def self.openapi_types
      {
        ...
        :'confidence_interval' => :'ConfidenceIntervalRep',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LaunchDarklyApi::ExperimentTimeSeriesVariationSlice` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LaunchDarklyApi::ExperimentTimeSeriesVariationSlice`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'confidence_interval')
        self.confidence_interval = attributes[:'confidence_interval']
      end
    ...
    def hash
      [value, count, cumulative_value, cumulative_count, conversion_rate, cumulative_conversion_rate, confidence_interval, cumulative_confidence_interval].hash
    end
