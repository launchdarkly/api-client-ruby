...
module LaunchDarklyApi
  class IntegrationConfigurationsRep < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'snowflake_setup_script' => :'snowflakeSetupScript',
        :'redshift_setup_scripts' => :'redshiftSetupScripts',
        :'redshift_iam_permissions_policy' => :'redshiftIAMPermissionsPolicy',
        :'redshift_iam_trust_policy' => :'redshiftIAMTrustPolicy',
    ...
    def self.openapi_types
      {
        ...
        :'snowflake_setup_script' => :'String',
        :'redshift_setup_scripts' => :'Array<String>',
        :'redshift_iam_permissions_policy' => :'String',
        :'redshift_iam_trust_policy' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'snowflake_setup_script')
        self.snowflake_setup_script = attributes[:'snowflake_setup_script']
      end

      if attributes.key?(:'redshift_setup_scripts')
        if (value = attributes[:'redshift_setup_scripts']).is_a?(Array)
          self.redshift_setup_scripts = value
        end
      end

      if attributes.key?(:'redshift_iam_permissions_policy')
        self.redshift_iam_permissions_policy = attributes[:'redshift_iam_permissions_policy']
      end

      if attributes.key?(:'redshift_iam_trust_policy')
        self.redshift_iam_trust_policy = attributes[:'redshift_iam_trust_policy']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          snowflake_setup_script == o.snowflake_setup_script &&
          redshift_setup_scripts == o.redshift_setup_scripts &&
          redshift_iam_permissions_policy == o.redshift_iam_permissions_policy &&
          redshift_iam_trust_policy == o.redshift_iam_trust_policy &&
    ...
    def hash
      [_links, _id, name, _created_at, _integration_key, tags, enabled, _access, config_values, capability_config, snowflake_setup_script, redshift_setup_scripts, redshift_iam_permissions_policy, redshift_iam_trust_policy, _maintainer_id].hash
    end
