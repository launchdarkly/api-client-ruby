...
module SwaggerClient
  class WebhooksApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def patch_webhook(webhook_id, patch_delta, opts = {})
      patch_webhook_with_http_info(webhook_id, patch_delta, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def patch_webhook_with_http_info(webhook_id, patch_delta, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: WebhooksApi.patch_webhook ..."
      end
      # verify the required parameter 'webhook_id' is set
      if @api_client.config.client_side_validation && webhook_id.nil?
        fail ArgumentError, "Missing the required parameter 'webhook_id' when calling WebhooksApi.patch_webhook"
      end
    ...
    def post_webhook(webhook_post, opts = {})
      post_webhook_with_http_info(webhook_post, opts)
      return nil
    end
    ...
    def post_webhook_with_http_info(webhook_post, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(webhook_post)
      auth_names = ['Token']
