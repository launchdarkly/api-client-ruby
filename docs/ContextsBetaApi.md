...
| ------ | ------------ | ----------- |
| [**delete_context_instances**](ContextsBetaApi.md#delete_context_instances) | **DELETE** /api/v2/projects/{projectKey}/environments/{environmentKey}/context-instances/{id} | Delete context instances |
| [**evaluate_context_instance**](ContextsBetaApi.md#evaluate_context_instance) | **POST** /api/v2/projects/{projectKey}/environments/{environmentKey}/flags/evaluate | Evaluate flags for context instance |
| [**get_context_attribute_names**](ContextsBetaApi.md#get_context_attribute_names) | **GET** /api/v2/projects/{projectKey}/environments/{environmentKey}/context-attributes | Get context attribute names |
| [**get_context_attribute_values**](ContextsBetaApi.md#get_context_attribute_values) | **GET** /api/v2/projects/{projectKey}/environments/{environmentKey}/context-attributes/{attributeName} | Get context attribute values |
| [**get_context_instances**](ContextsBetaApi.md#get_context_instances) | **GET** /api/v2/projects/{projectKey}/environments/{environmentKey}/context-instances/{id} | Get context instances |
...
| [**get_contexts**](ContextsBetaApi.md#get_contexts) | **GET** /api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/{kind}/{key} | Get contexts |
...
| [**search_context_instances**](ContextsBetaApi.md#search_context_instances) | **POST** /api/v2/projects/{projectKey}/environments/{environmentKey}/context-instances/search | Search for context instances |
| [**search_contexts**](ContextsBetaApi.md#search_contexts) | **POST** /api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/search | Search for contexts |
...
begin
  ...
  puts "Error when calling ContextsBetaApi->delete_context_instances: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->delete_context_instances_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->evaluate_context_instance: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->evaluate_context_instance_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->get_context_attribute_names: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->get_context_attribute_names_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->get_context_attribute_values: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->get_context_attribute_values_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->get_context_instances: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->get_context_instances_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->get_contexts: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->get_contexts_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->search_context_instances: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->search_context_instances_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->search_contexts: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ContextsBetaApi->search_contexts_with_http_info: #{e}"
end
```
