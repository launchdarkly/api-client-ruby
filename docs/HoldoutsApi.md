# LaunchDarklyApi::HoldoutsApi

All URIs are relative to *https://app.launchdarkly.com*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**get_all_holdouts**](HoldoutsApi.md#get_all_holdouts) | **GET** /api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts | Get all holdouts |
| [**get_holdout**](HoldoutsApi.md#get_holdout) | **GET** /api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey} | Get holdout |
| [**get_holdout_by_id**](HoldoutsApi.md#get_holdout_by_id) | **GET** /api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/id/{holdoutId} | Get Holdout by Id |
| [**patch_holdout**](HoldoutsApi.md#patch_holdout) | **PATCH** /api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey} | Patch holdout |
| [**post_holdout**](HoldoutsApi.md#post_holdout) | **POST** /api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts | Create holdout |
...
api_instance = LaunchDarklyApi::HoldoutsApi.new
...
begin
  ...
  puts "Error when calling HoldoutsApi->get_all_holdouts: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HoldoutsApi->get_all_holdouts_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HoldoutsApi->get_holdout: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HoldoutsApi->get_holdout_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HoldoutsApi->get_holdout_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HoldoutsApi->get_holdout_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HoldoutsApi->patch_holdout: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HoldoutsApi->patch_holdout_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HoldoutsApi->post_holdout: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HoldoutsApi->post_holdout_with_http_info: #{e}"
end
```
